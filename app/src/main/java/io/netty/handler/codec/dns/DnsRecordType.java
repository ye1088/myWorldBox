...
public class DnsRecordType implements Comparable<DnsRecordType> {
    ...
    public static final DnsRecordType TSIG = new DnsRecordType(Config.DEFAULT_FADE_DURATION, "TSIG");
    ...
    public static DnsRecordType valueOf(int intValue) {
        DnsRecordType dnsRecordType = (DnsRecordType) BY_TYPE.get(intValue);
