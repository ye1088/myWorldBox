...
public final class HttpHeaderValues {
    ...
    public static final AsciiString BASE64 = new AsciiString(Values.BASE64);
    public static final AsciiString BINARY = new AsciiString("binary");
    public static final AsciiString BOUNDARY = new AsciiString(Values.BOUNDARY);
    ...
    public static final AsciiString MULTIPART_FORM_DATA = new AsciiString(Values.MULTIPART_FORM_DATA);
    ...
    public static final AsciiString NO_STORE = new AsciiString(Values.NO_STORE);
    ...
    public static final AsciiString QUOTED_PRINTABLE = new AsciiString(Values.QUOTED_PRINTABLE);
    public static final AsciiString S_MAXAGE = new AsciiString(Values.S_MAXAGE);
    public static final AsciiString TEXT_PLAIN = new AsciiString("text/plain");
    public static final AsciiString TRAILERS = new AsciiString(Values.TRAILERS);
