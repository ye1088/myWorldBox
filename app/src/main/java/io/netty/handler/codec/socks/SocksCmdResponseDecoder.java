...
public class SocksCmdResponseDecoder extends ReplayingDecoder<State> {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            $SwitchMap$io$netty$handler$codec$socks$SocksCmdResponseDecoder$State = new int[State.values().length];
            try {
    ...
    protected void decode(io.netty.channel.ChannelHandlerContext r7, io.netty.buffer.ByteBuf r8, java.util.List<java.lang.Object> r9) throws java.lang.Exception {
        /*
        r6 = this;
        r2 = io.netty.handler.codec.socks.SocksCmdResponseDecoder.AnonymousClass1.$SwitchMap$io$netty$handler$codec$socks$SocksCmdResponseDecoder$State;
        r1 = r6.state();
        r1 = (io.netty.handler.codec.socks.SocksCmdResponseDecoder.State) r1;
        r1 = r1.ordinal();
        r1 = r2[r1];
        switch(r1) {
    ...
    L_0x002e:
        r1 = io.netty.handler.codec.socks.SocksCmdResponseDecoder.State.READ_CMD_HEADER;
        r6.checkpoint(r1);
    L_0x0033:
        r1 = r8.readByte();
        r1 = io.netty.handler.codec.socks.SocksCmdStatus.valueOf(r1);
        r6.cmdStatus = r1;
        r1 = r8.readByte();
        r6.reserved = r1;
        r1 = r8.readByte();
        ...
        r6.addressType = r1;
        r1 = io.netty.handler.codec.socks.SocksCmdResponseDecoder.State.READ_CMD_ADDRESS;
        r6.checkpoint(r1);
    L_0x0052:
        r1 = io.netty.handler.codec.socks.SocksCmdResponseDecoder.AnonymousClass1.$SwitchMap$io$netty$handler$codec$socks$SocksAddressType;
        r2 = r6.addressType;
        r2 = r2.ordinal();
        r1 = r1[r2];
        switch(r1) {
    ...
    L_0x0060:
        ...
        r6.port = r1;
        r1 = new io.netty.handler.codec.socks.SocksCmdResponse;
        r2 = r6.cmdStatus;
        r3 = r6.addressType;
        r4 = r6.host;
        r5 = r6.port;
