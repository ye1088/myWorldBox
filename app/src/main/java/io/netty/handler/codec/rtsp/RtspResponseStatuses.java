...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus LOW_STORAGE_SPACE = new HttpResponseStatus(Config.DEFAULT_FADE_DURATION, "Low on Storage Space");
    ...
    public static final HttpResponseStatus OPTION_NOT_SUPPORTED = new HttpResponseStatus(h.arb, "Option not supported");
    ...
    public static HttpResponseStatus valueOf(int code) {
        switch (code) {
            case Config.DEFAULT_FADE_DURATION /*250*/:
