...
public final class Http2Flags {
    public static final short ACK = (short) 1;
    public static final short END_HEADERS = (short) 4;
    public static final short END_STREAM = (short) 1;
    public static final short PADDED = (short) 8;
    public static final short PRIORITY = (short) 32;
    private short value;
    ...
    public Http2Flags setFlag(boolean on, short mask) {
        if (on) {
            ...
            this.value = (short) (this.value & (mask ^ -1));
        }
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.value != ((Http2Flags) obj).value) {
            return false;
        }
        return true;
    }
