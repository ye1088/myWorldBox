...
public final class RtspHeaderNames {
    ...
    public static final AsciiString ALLOW = new AsciiString((CharSequence) "allow");
    public static final AsciiString AUTHORIZATION = HttpHeaderNames.AUTHORIZATION;
    public static final AsciiString BANDWIDTH = new AsciiString((CharSequence) "bandwidth");
    public static final AsciiString BLOCKSIZE = new AsciiString((CharSequence) "blocksize");
    public static final AsciiString CACHE_CONTROL = HttpHeaderNames.CACHE_CONTROL;
    public static final AsciiString CONFERENCE = new AsciiString((CharSequence) "conference");
    ...
    public static final AsciiString CSEQ = new AsciiString((CharSequence) "cseq");
    ...
    public static final AsciiString KEYMGMT = new AsciiString((CharSequence) "keymgmt");
    ...
    public static final AsciiString PROXY_REQUIRE = new AsciiString((CharSequence) "proxy-require");
    public static final AsciiString PUBLIC = new AsciiString((CharSequence) "public");
    ...
    public static final AsciiString REQUIRE = new AsciiString((CharSequence) "require");
    public static final AsciiString RETRT_AFTER = HttpHeaderNames.RETRY_AFTER;
    public static final AsciiString RTP_INFO = new AsciiString((CharSequence) "rtp-info");
    public static final AsciiString SCALE = new AsciiString((CharSequence) "scale");
    ...
    public static final AsciiString SPEED = new AsciiString((CharSequence) "speed");
    public static final AsciiString TIMESTAMP = new AsciiString((CharSequence) "timestamp");
    public static final AsciiString TRANSPORT = new AsciiString((CharSequence) "transport");
    public static final AsciiString UNSUPPORTED = new AsciiString((CharSequence) "unsupported");
