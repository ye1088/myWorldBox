...
public final class h {
    ...
    public String a(int i, Thread thread, long j, String str, String str2, Throwable th) {
        ...
        stringBuilder.append(j2).append(HttpConstants.SP_CHAR).append('[');
        if (thread == null) {
            stringBuilder.append("N/A");
        } else {
            stringBuilder.append(thread.getName());
        }
        stringBuilder.append(']').append('[').append(str).append(']').append(HttpConstants.SP_CHAR).append(str2).append('\n');
        if (th != null) {
