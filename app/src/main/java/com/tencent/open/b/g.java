...
public class g {
                ...
                this.g.execute(new Runnable(this) {
                    ...
                    public void run() {
                        try {
                            ...
                            bundle.putString(Os.FAMILY_MAC, c.a());
                            ...
                            if (this.c.a("report_via", size) || z) {
                                this.c.e();
                                this.c.f.removeMessages(ErrorCode.ERROR_HOSTAPP_UNAVAILABLE);
                            } else if (!this.c.f.hasMessages(ErrorCode.ERROR_HOSTAPP_UNAVAILABLE)) {
                                Message obtain = Message.obtain();
                                obtain.what = ErrorCode.ERROR_HOSTAPP_UNAVAILABLE;
    ...
    protected void b() {
        this.h.execute(new Runnable(this) {
            ...
            L_0x0009:
                return;
            L_0x000a:
                r0 = com.tencent.open.utils.Global.getContext();	 Catch:{ Exception -> 0x00bf }
                r2 = 0;
                r0 = com.tencent.open.utils.OpenConfig.getInstance(r0, r2);	 Catch:{ Exception -> 0x00bf }
                r2 = "Common_HttpRetryCount";
                r0 = r0.getInt(r2);	 Catch:{ Exception -> 0x00bf }
            ...
            L_0x0039:
                r0 = r0 + 1;
                r2 = com.tencent.open.utils.Global.getContext();	 Catch:{ ConnectTimeoutException -> 0x00ce, SocketTimeoutException -> 0x00db, Exception -> 0x00e6 }
                r5 = 0;
                ...
                r6 = com.tencent.open.utils.Util.getBytesUTF8(r6);	 Catch:{ ConnectTimeoutException -> 0x00ce, SocketTimeoutException -> 0x00db, Exception -> 0x00e6 }
    ...
    protected Bundle c() {
        ...
        try {
            ...
            for (int i = 0; i < this.c.size(); i++) {
                ...
                bundle.putString(i + "_8", (String) bVar.a.get(r.gQ));
    ...
    protected void e() {
        this.g.execute(new Runnable(this) {
            ...
            L_0x0038:
                r10 = r10 + 1;
                r12 = com.tencent.open.utils.Global.getContext();	 Catch:{ ConnectTimeoutException -> 0x00bb, SocketTimeoutException -> 0x00cb, JSONException -> 0x00d6, NetworkUnavailableException -> 0x00dd, HttpStatusException -> 0x00f2, IOException -> 0x0113, Exception -> 0x011e }
                ...
                r12 = r15.response;	 Catch:{ ConnectTimeoutException -> 0x00bb, SocketTimeoutException -> 0x00cb, JSONException -> 0x00d6, NetworkUnavailableException -> 0x00dd, HttpStatusException -> 0x00f2, IOException -> 0x0113, Exception -> 0x011e }
                r12 = com.tencent.open.utils.Util.parseJson(r12);	 Catch:{ ConnectTimeoutException -> 0x00bb, SocketTimeoutException -> 0x00cb, JSONException -> 0x00d6, NetworkUnavailableException -> 0x00dd, HttpStatusException -> 0x00f2, IOException -> 0x0113, Exception -> 0x011e }
                r13 = "ret";
            ...
            L_0x005f:
                ...
                r10 = r11;
            L_0x0061:
                r12 = r15.reqSize;	 Catch:{ ConnectTimeoutException -> 0x00bb, SocketTimeoutException -> 0x00cb, JSONException -> 0x00d6, NetworkUnavailableException -> 0x00dd, HttpStatusException -> 0x00f2, IOException -> 0x0113, Exception -> 0x011e }
                r4 = r15.rspSize;	 Catch:{ ConnectTimeoutException -> 0x00bb, SocketTimeoutException -> 0x00cb, JSONException -> 0x00d6, NetworkUnavailableException -> 0x00dd, HttpStatusException -> 0x013b, IOException -> 0x0113, Exception -> 0x011e }
                r6 = r12;
            L_0x0066:
    ...
    public void a(String str, String str2, Bundle bundle, boolean z) {
        ...
        ThreadManager.executeOnSubThread(new Runnable(this) {
            ...
            L_0x00e2:
                ...
                r3 = com.tencent.open.utils.Util.getBytesUTF8(r3);	 Catch:{ Exception -> 0x00c4 }
