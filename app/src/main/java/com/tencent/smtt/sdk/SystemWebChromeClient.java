...
class SystemWebChromeClient extends WebChromeClient {
    ...
    public void getVisitedHistory(ValueCallback<String[]> valueCallback) {
        this.b.getVisitedHistory(new q(this, valueCallback));
    }
    ...
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, FileChooserParams fileChooserParams) {
        ValueCallback tVar = new t(this, valueCallback);
        WebChromeClient.FileChooserParams uVar = new u(this, fileChooserParams);
        this.a.a(webView);
