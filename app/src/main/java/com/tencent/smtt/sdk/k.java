...
class k extends X5ProxyWebChromeClient {
    private WebView a;
    ...
    class a implements QuotaUpdater {
        ...
        a(k kVar, com.tencent.smtt.export.external.interfaces.QuotaUpdater quotaUpdater) {
            this.b = kVar;
            this.a = quotaUpdater;
        }
    ...
    public k(IX5WebChromeClient iX5WebChromeClient, WebView webView, WebChromeClient webChromeClient) {
    ...
    public boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z, boolean z2, Message message) {
        ...
        webView.getClass();
        WebView$WebViewTransport webView$WebViewTransport = new WebView$WebViewTransport(webView);
        Message obtain = Message.obtain(message.getTarget(), new l(this, webView$WebViewTransport, message));
    ...
    public void onShowCustomView(View view, int i, IX5WebChromeClient$CustomViewCallback iX5WebChromeClient$CustomViewCallback) {
        this.b.onShowCustomView(view, i, iX5WebChromeClient$CustomViewCallback);
    }

    public void onShowCustomView(View view, IX5WebChromeClient$CustomViewCallback iX5WebChromeClient$CustomViewCallback) {
        this.b.onShowCustomView(view, iX5WebChromeClient$CustomViewCallback);
    }

    public boolean onShowFileChooser(IX5WebViewBase iX5WebViewBase, ValueCallback<Uri[]> valueCallback, IX5WebChromeClient$FileChooserParams iX5WebChromeClient$FileChooserParams) {
        ValueCallback nVar = new n(this, valueCallback);
        WebChromeClient$FileChooserParams oVar = new o(this, iX5WebChromeClient$FileChooserParams);
        this.a.a(iX5WebViewBase);
        return this.b.onShowFileChooser(this.a, nVar, oVar);
    }

    public void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2, boolean z) {
        this.b.openFileChooser(new m(this, valueCallback), str, str2);
    }
}
