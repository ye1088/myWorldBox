...
public class d {
    ...
    public static int a(Context context, String str, HashMap<String, String> hashMap, String str2) {
        Object obj;
        String encode;
        Object obj2 = null;
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                if (packageInfo != null && packageInfo.versionCode > 601000) {
                    ...
                    return b(context, stringBuilder.toString(), hashMap);
                }
            }
            obj3 = null;
            obj = obj3;
    ...
    public static int b(Context context, String str, HashMap<String, String> hashMap) {
        if (context == null) {
            return 3;
        }
        if (!a(str)) {
