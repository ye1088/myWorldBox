...
public abstract class f {
    ...
    protected static String[] a(Context context, String str, UMPlatformData... uMPlatformDataArr) throws a {
        ...
        if (!TextUtils.isEmpty(str)) {
            arrayList.add(new BasicNameValuePair(r.gO, str));
        }
        ...
        b.c(a.e, "URL:" + new StringBuilder(String.valueOf(str2)).append("?").append(a(arrayList)).toString());
        b.c(a.e, "BODY:" + b);
    ...
    private static List<NameValuePair> a(UMPlatformData... uMPlatformDataArr) {
        ...
        for (UMPlatformData uMPlatformData : uMPlatformDataArr) {
            ...
            stringBuilder2.append(StringUtil.COMMA);
            stringBuilder3.append(uMPlatformData.getWeiboId());
            stringBuilder3.append(StringUtil.COMMA);
        }
    ...
    private static Map<String, String> c(Context context) throws a {
        ...
        for (Entry entry : b.entrySet()) {
            if (!TextUtils.isEmpty((CharSequence) entry.getValue())) {
                stringBuilder2.append((String) entry.getKey()).append(MiPushClient.ACCEPT_TIME_SEPARATOR);
                stringBuilder.append((String) entry.getValue()).append(MiPushClient.ACCEPT_TIME_SEPARATOR);
            }
        }
