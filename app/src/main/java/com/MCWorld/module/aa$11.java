...
class aa$11 implements Listener<String> {
    ...
    public void onResponse(String response) {
        ...
        try {
            ...
            if (info.isSucc()) {
                EventNotifyCenter.notifyEvent(n.class, n.awI, new Object[]{Boolean.valueOf(true), info.msg});
            } else {
                EventNotifyCenter.notifyEvent(n.class, n.awI, new Object[]{Boolean.valueOf(false), info.msg});
            }
        } catch (Exception e) {
            HLog.error(this, "requestJsInputCount e = " + e + ", response = " + response, new Object[0]);
            EventNotifyCenter.notifyEvent(n.class, n.awI, new Object[]{Boolean.valueOf(false), "解析数据错误"});
        }
    }
}
