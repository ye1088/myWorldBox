...
public class d implements com.MCWorld.mcfloat.p.a {
    private static List<com.MCWorld.mcfloat.map.a> PG = null;
    ...
    private class b extends AsyncTask<String, Integer, String> {
        ...
        protected String c(String... params) {
            ...
            try {
                ...
                com.MCWorld.mcinterface.h.z(mapDstPath + mapScreenshotName, 0);
    ...
    public void qT() {
        this.PF = j.cV(true) + com.MCWorld.mcinterface.h.zs() + File.separator + Constants.bsk + File.separator;
    ...
    private void qU() {
        if (PG != null) {
            for (int i = 0; i < PG.size() - 1; i++) {
                com.MCWorld.mcfloat.map.a tmpBackupViewItem = (com.MCWorld.mcfloat.map.a) PG.get(i);
    ...
    public void qV() {
        ...
        PG = new ArrayList();
        PG.add(new com.MCWorld.mcfloat.map.a(1, Constants.bsa, Constants.bsb, PP, null, null, this.Qa, this.Qe, this.Qi));
        PG.add(new com.MCWorld.mcfloat.map.a(2, Constants.bsc, Constants.bsd, PQ, null, null, this.Qb, this.Qf, this.Qj));
        PG.add(new com.MCWorld.mcfloat.map.a(3, Constants.bse, Constants.bsf, PR, null, null, this.Qc, this.Qg, this.Qk));
        PG.add(new com.MCWorld.mcfloat.map.a(4, Constants.bsg, Constants.bsh, PS, null, null, this.Qd, this.Qh, this.Ql));
        PG.add(new com.MCWorld.mcfloat.map.a(5, Constants.bsi, Constants.bsj, null, null, null, this.PW, this.PY, null));
    }
    ...
    public boolean dc(int inputIndex) {
        com.MCWorld.mcfloat.map.a tmpBackupViewItem = null;
        if (PG == null) {
            return false;
        }
        for (int i = 0; i < PG.size(); i++) {
            tmpBackupViewItem = (com.MCWorld.mcfloat.map.a) PG.get(i);
            if (tmpBackupViewItem.uA() == inputIndex) {
                break;
            }
        ...
        if (!(tmpBackupViewItem == null || tmpBackupViewItem.uH() == null)) {
            if (tmpBackupViewItem.uH().getText() == com.MCWorld.mcfloat.map.a.acp) {
                new b().execute(new String[]{j.Kq() + com.MCWorld.mcinterface.h.zs(), this.PF, tmpBackupViewItem.uB(), tmpBackupViewItem.uC(), Integer.toString(inputIndex)});
    ...
    private void qW() {
        int inputIndex = ((com.MCWorld.mcfloat.map.a) PG.get(PG.size() - 1)).uA();
        new b().execute(new String[]{j.Kq() + com.MCWorld.mcinterface.h.zs(), this.PF, tmpBackupViewItem.uB(), tmpBackupViewItem.uC(), Integer.toString(inputIndex)});
    }
}
