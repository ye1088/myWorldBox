...
public class f implements com.MCWorld.mcfloat.p.a {
    private static f QG;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.floatBtnCapshotStart:
                    com.MCWorld.mcfloat.capshot.a.un().aP(this.QI.Pu.getContext());
                    return;
                default:
                    return;
            }
            ...
            this.QP = new OnTouchListener(this) {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getAction()) {
                        case 1:
                            com.MCWorld.mcfloat.capshot.a.un().aQ(this.QQ.QI.Pu.getContext());
                            r.ck().K_umengEvent(com.MCWorld.r.a.lt);
                            break;
                    }
                    return true;
                }
