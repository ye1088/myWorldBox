...
public class a {
    ...
    private com.MCWorld.mcfloat.InstanceZones.f.a Wf = new com.MCWorld.mcfloat.InstanceZones.f.a(this) {
        final /* synthetic */ a Wj;
    ...
    private void dK(int missionTimer) {
        if (this.Wd != null && this.Wa.sn() != 5 && this.Wa.sn() != 6 && this.Wd.ty() != null && this.Wa.sp() < this.Wd.ty().size() && missionTimer == ((com.MCWorld.mcfloat.InstanceZones.structrue.a) this.Wd.ty().get(this.Wa.sp())).YP) {
            h.cW(((com.MCWorld.mcfloat.InstanceZones.structrue.a) this.Wd.ty().get(this.Wa.sp())).YQ);
            this.Wa.so();
        }
    }
    ...
    private void sj() {
        ...
        switch (this.Wa.sn()) {
            case 1:
                _tmpTongjiStr = com.MCWorld.r.a.kC;
                break;
            case 2:
                _tmpTongjiStr = com.MCWorld.r.a.kE;
                break;
            case 3:
                _tmpTongjiStr = com.MCWorld.r.a.kG;
                break;
            case 4:
                _tmpTongjiStr = com.MCWorld.r.a.kI;
                break;
            case 5:
                _tmpTongjiStr = com.MCWorld.r.a.kK;
                break;
            case 6:
                _tmpTongjiStr = com.MCWorld.r.a.kM;
                break;
            case 7:
                _tmpTongjiStr = com.MCWorld.r.a.kO;
                break;
        }
    ...
    private void sk() {
        ...
        switch (this.Wa.sn()) {
            case 1:
                _tmpTongjiStr = com.MCWorld.r.a.kD;
                break;
            case 2:
                _tmpTongjiStr = com.MCWorld.r.a.kF;
                break;
            case 3:
                _tmpTongjiStr = com.MCWorld.r.a.kH;
                break;
            case 4:
                _tmpTongjiStr = com.MCWorld.r.a.kJ;
                break;
            case 5:
                _tmpTongjiStr = com.MCWorld.r.a.kL;
                break;
            case 6:
                _tmpTongjiStr = com.MCWorld.r.a.kN;
                break;
            case 7:
                _tmpTongjiStr = com.MCWorld.r.a.kP;
                break;
        }
        if (_tmpTongjiStr != null) {
            r.ck().K_umengEvent(_tmpTongjiStr);
