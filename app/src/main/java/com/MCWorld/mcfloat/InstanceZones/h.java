...
public class h {
    ...
    private void a(int inputCorner01PosX, int inputCorner01PosY, int inputCorner01PosZ, int inputCorner02PosX, int inputCorner02PosY, int inputCorner02PosZ, int inputCorner03PosX, int inputCorner03PosY, int inputCorner03PosZ, int inputCorner04PosX, int inputCorner04PosY, int inputCorner04PosZ) {
        com.MCWorld.mcinterface.h.b(this.Nz, this.NA, this.NB, inputCorner01PosX, inputCorner01PosY, inputCorner01PosZ, inputCorner02PosX, inputCorner02PosY, inputCorner02PosZ, inputCorner03PosX, inputCorner03PosY, inputCorner03PosZ, inputCorner04PosX, inputCorner04PosY, inputCorner04PosZ, 3);
    }
    ...
    public boolean sQ() {
        int _tmpRoleX = (int) com.MCWorld.mcinterface.h.zF();
        int _tmpRoleY = (int) com.MCWorld.mcinterface.h.zG();
        int _tmpRoleZ = (int) com.MCWorld.mcinterface.h.zH();
    ...
    public void C(int inputWide, int inputHigh) {
        ...
        com.MCWorld.mcinterface.h.D(sO());
    }
    ...
    public void sS() {
        ...
        com.MCWorld.mcinterface.h.D(inList);
    }

    public void sT() {
        com.MCWorld.mcinterface.h.D(sR());
    }
    ...
    public void sV() {
        com.MCWorld.mcinterface.h.D(sU());
        com.MCWorld.mcinterface.h.qi();
    }
}
