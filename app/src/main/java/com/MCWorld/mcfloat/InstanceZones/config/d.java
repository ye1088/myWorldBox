...
public class d {
                ...
                try {
                    ...
                    if (sourceStrArray[0].equals(insZonesType)) {
                        ...
                        if (sourceStrArray[2].equals("Tips")) {
                            ...
                            com.MCWorld.mcfloat.InstanceZones.structrue.d _routeBlock = new com.MCWorld.mcfloat.InstanceZones.structrue.d();
    ...
    private void a(com.MCWorld.mcfloat.InstanceZones.structrue.d routeBlock, String objectStr) {
        int abscissa = 0;
        int ordinate = 0;
        try {
    ...
    private void a(com.MCWorld.mcfloat.InstanceZones.structrue.d routeBlock, String blockId, String blockDmg) {
        int id = 0;
        int dmg = 0;
        try {
