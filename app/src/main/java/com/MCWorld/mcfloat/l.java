...
import com.MCWorld.mcgame.netuser.b;
...
public class l implements a {
    ...
    private void dC(int index) {
        rH();
        b _tmpMCNetUser = com.MCWorld.mcgame.netuser.a.yQ().hf(index);
    ...
    private void rG() {
        this.Tv.setText("房间成员(" + String.valueOf(com.MCWorld.mcgame.netuser.a.yQ().yU() + 1) + "/5)");
        this.Tw.setText(com.MCWorld.mcgame.netuser.a.yQ().yW() + "(自己)");
        b _tmpMCNetUser = com.MCWorld.mcgame.netuser.a.yQ().hf(0);
        if (_tmpMCNetUser.isValid()) {
        ...
        _tmpMCNetUser = com.MCWorld.mcgame.netuser.a.yQ().hf(1);
        if (_tmpMCNetUser.isValid()) {
        ...
        _tmpMCNetUser = com.MCWorld.mcgame.netuser.a.yQ().hf(2);
        if (_tmpMCNetUser.isValid()) {
        ...
        _tmpMCNetUser = com.MCWorld.mcgame.netuser.a.yQ().hf(3);
        if (_tmpMCNetUser.isValid()) {
