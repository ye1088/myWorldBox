...
public class g implements com.MCWorld.mcfloat.p.a {
            ...
            switch (v.getId()) {
                case R.id.floatBtnSetSpawn:
                    if (this.Rj.a(this.Rj.rm())) {
                        r.ck().K_umengEvent(com.MCWorld.r.a.lj);
                        return;
                    } else {
                ...
                case R.id.floatBtnKillSelf:
                    h.e(-26, false);
                    r.ck().K_umengEvent(com.MCWorld.r.a.lk);
                    return;
    ...
    /* compiled from: FloatLayoutDeliverView */
    private class a implements com.MCWorld.widget.dialog.e.a {
        final /* synthetic */ g Rj;
    ...
    private void rl() {
        h.b(h.zI(), h.zJ(), h.zK());
        r.ck().K_umengEvent(com.MCWorld.r.a.ll);
    }
