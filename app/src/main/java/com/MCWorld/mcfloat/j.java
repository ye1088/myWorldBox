...
public class j implements a {
            ...
            switch (v.getId()) {
                case R.id.tvFloatInstanceZonesExperienceEnter:
                    if (((int) h.zG()) > 90) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(1);
                        return;
                    } else {
                ...
                case R.id.tvFloatInstanceZonesTrainingEnter:
                    if (((int) h.zG()) > 90) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(2);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
                ...
                case R.id.tvFloatInstanceZonesBreakthroughEnter:
                    if (((int) h.zG()) > 90) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(3);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
                ...
                case R.id.tvFloatInstanceZonesUnExhaustibleEnter:
                    if (((int) h.zG()) > 90) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(4);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
                ...
                case R.id.tvFloatInsZonesMazeEnter:
                    if (((int) h.zG()) > 90) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(5);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
                ...
                case R.id.tvFloatInsZonesTrapEnter:
                    if (h.vN()) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(6);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
                ...
                case R.id.tvFloatInsZonesParkourEnter:
                    if (h.vN()) {
                        ...
                        q.aJ(false);
                        com.MCWorld.mcfloat.InstanceZones.a.sl().dJ(7);
                        return;
                    } else {
                        hlx.ui.a.n(this.SN.SE, "抱歉！请复活后再进入副本！");
                        return;
    ...
    public void qN() {
        com.MCWorld.mcfloat.InstanceZones.a.sl().aL(false);
    }
