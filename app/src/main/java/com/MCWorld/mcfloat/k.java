...
public class k implements com.MCWorld.mcfloat.p.a {
    ...
    private com.MCWorld.widget.a SZ;
    ...
    private com.MCWorld.widget.a.a To = new com.MCWorld.widget.a.a(this) {
        final /* synthetic */ k Tt;
            ...
            if (chedked) {
                switch (button.getId()) {
                    ...
                    case R.id.floatBtnItemTypeMedicine:
                        r.ck().K_umengEvent(com.MCWorld.r.a.kS);
                        this.Tt.v(aj.Mn());
                        return;
                    ...
                    case R.id.floatBtnItemTypeSave:
                        r.ck().K_umengEvent(com.MCWorld.r.a.kQ);
                        this.Tt.v(b.qy().qz());
                        return;
    ...
    public k(View view) {
        ...
        this.SZ = new com.MCWorld.widget.a(this.To);
        this.SZ.a(this.Ta);
    ...
    private void rz() {
        if (h.getGameType() == 1) {
            com.MCWorld.k.p(this.Pu.getContext(), "创造模式无法添加物品");
        } else if (rx() != 0) {
            ...
            com.MCWorld.k.p(this.Pu.getContext(), "添加物品完成");
            this.Py = -1;
            rw();
    ...
    private void aH(boolean bDelete) {
        ...
        if (!bDelete && (h.zx() == 2 || h.zx() == 3 || h.zx() == 5 || h.zx() == 7)) {
            ...
            this.RH.notifyDataSetChanged();
            dy(this.Py);
            com.MCWorld.k.p(this.Pu.getContext(), _newCount == 0 ? "删除物品完成" : "修改数量完成");
            rB();
        }
    }
