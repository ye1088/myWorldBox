...
import com.MCWorld.image.pipeline.producers.c;
...
public class p extends c<s> {
    ...
    @com.MCWorld.framework.base.utils.VisibleForTesting
    void b(com.MCWorld.image.pipeline.producers.s r5, com.MCWorld.image.pipeline.producers.ah.a r6) {
