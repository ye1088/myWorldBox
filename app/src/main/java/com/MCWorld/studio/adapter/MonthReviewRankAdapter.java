...
public class MonthReviewRankAdapter extends BaseAdapter implements b {
    private List<com.MCWorld.data.studio.f.a> aab = new ArrayList();
    ...
    public Object getItem(int position) {
        return UtilsFunction.empty(this.aab) ? null : (com.MCWorld.data.studio.f.a) this.aab.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.MCWorld.data.studio.f.a item = (com.MCWorld.data.studio.f.a) getItem(position);
        a(holder, item);
    ...
    private void a(a holder, com.MCWorld.data.studio.f.a item) {
        switch (item.rank) {
            case 1:
    ...
    public void c(List<com.MCWorld.data.studio.f.a> data, boolean clear) {
        if (clear) {
            this.aab.clear();
        }
