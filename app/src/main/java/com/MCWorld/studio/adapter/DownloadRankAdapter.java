...
public class DownloadRankAdapter extends BaseAdapter implements b {
    private List<com.MCWorld.data.studio.e.a> aab = new ArrayList();
    ...
    public Object getItem(int position) {
        return UtilsFunction.empty(this.aab) ? null : (com.MCWorld.data.studio.e.a) this.aab.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.MCWorld.data.studio.e.a item = (com.MCWorld.data.studio.e.a) getItem(position);
        a(holder, item);
    ...
    private void a(a holder, com.MCWorld.data.studio.e.a item) {
        if (item != null) {
    ...
    public void c(List<com.MCWorld.data.studio.e.a> data, boolean clear) {
        if (clear) {
            this.aab.clear();
        }
