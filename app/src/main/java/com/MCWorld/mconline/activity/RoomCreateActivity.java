package com.MCWorld.mconline.activity;
...
public class RoomCreateActivity extends HTBaseActivity {
    ...
    com.MCWorld.mconline.activity.widget.a.a akv = new com.MCWorld.mconline.activity.widget.a.a(this) {
        final /* synthetic */ RoomCreateActivity akB;
    ...
    com.MCWorld.mconline.activity.widget.a.a akw = new com.MCWorld.mconline.activity.widget.a.a(this) {
        final /* synthetic */ RoomCreateActivity akB;
    ...
    com.MCWorld.mconline.activity.widget.a.a akx = new com.MCWorld.mconline.activity.widget.a.a(this) {
        final /* synthetic */ RoomCreateActivity akB;
    ...
    private CallbackHandler aky = new CallbackHandler(this) {
        ...
        public void onRecvStudioId(boolean succ, y info, long userId, Object ctx) {
            ...
            if (!succ || info == null) {
                ...
                com.MCWorld.mconline.module.a.Bl().ap(ctx);
            }
        }
        ...
        public void acceptStudioInfo(boolean isSucc, c info, int studioId, Object ctx) {
            if (j.ep().ey() && ctx != null && (ctx instanceof f)) {
                ...
                if (!isSucc || createItem == null) {
                    ...
                    com.MCWorld.mconline.module.a.Bl().ap(createItem);
                } else {
    ...
    private CallbackHandler akz = new CallbackHandler(this) {
        ...
        public void onRecvLevelData(boolean succ, Object object) {
            if (succ && object != null && (object instanceof f)) {
                ...
                com.MCWorld.mconline.utils.a.dr(createItem.client_ip);
                h.zM().b(com.MCWorld.mconline.gamerole.b.Bh());
                ...
                com.MCWorld.mconline.gamerole.b.Bh().a(this.akB.akb, createItem.online_ip, createItem.online_port, createItem);
            }
        }
    };
    ...
    private CallbackHandler mCallback = new CallbackHandler(this) {
        ...
        public void onRecvResCate(boolean succ, com.MCWorld.mconline.gameloc.http.h infos, Object ctx) {
            if (succ) {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.room_map_text:
                    new com.MCWorld.mconline.activity.dialog.a(this.akB.akb, this.akB.ako, RoomCreateActivity.akm).show();
                    return;
                case R.id.map_type_text:
                    if (this.akB.akp.size() == 0) {
                        this.akB.AH();
                    }
                    new com.MCWorld.mconline.activity.widget.a(this.akB.akb, Integer.valueOf(this.akB.map_type), this.akB.akp, this.akB.akq, this.akB.akv).show();
                    return;
                case R.id.max_player_text:
                    new com.MCWorld.mconline.activity.widget.a(this.akB.akb, Integer.valueOf(this.akB.max_player), this.akB.akr, this.akB.aks, this.akB.akw).show();
                    return;
                case R.id.game_mode_text:
                    new com.MCWorld.mconline.activity.widget.a(this.akB.akb, Integer.valueOf(this.akB.game_mode), this.akB.akt, this.akB.aku, this.akB.akx).show();
                    return;
                default:
                    return;
            }
    ...
    public static void f(com.MCWorld.data.map.b inputStartMapItem) {
    ...
    private void AM() {
        if (this.ako != null && this.ako.size() > 1) {
            com.MCWorld.data.map.b _tmpFileItem = (com.MCWorld.data.map.b) this.ako.get(0);
