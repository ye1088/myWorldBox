...
public class b {
        ...
        if (datagramPacket != null) {
            ...
            if (packetBuffer.length > 0) {
                ...
                if (_tmpSenderIP.equals(a.getHostAddress())) {
                    ...
                    if (com.MCWorld.mconline.gameloc.config.b.alt != _tmpSenderPort) {
                        if (gameProxyId == 1) {
                            if (com.MCWorld.mconline.gamerole.a.Bf().alY != _tmpSenderPort) {
                                ...
                                com.MCWorld.mconline.gamerole.a.Bf().alY = _tmpSenderPort;
                            }
                        } else if (com.MCWorld.mconline.gamerole.a.Bf().alW != _tmpSenderPort) {
                            HLog.verbose(TAG, "[GameProcess]: DTPrint 玩家->发出数据 更新端口号 CMD[%d] [%s:%d => %s:%d]", new Object[]{Integer.valueOf(gameProxyId), _tmpSenderIP, Integer.valueOf(_tmpSenderPort), _tmpRecipientIP, Integer.valueOf(_tmpRecipientPort)});
                            com.MCWorld.mconline.gamerole.a.Bf().alX = _tmpSenderIP;
                            com.MCWorld.mconline.gamerole.a.Bf().alW = _tmpSenderPort;
                            com.MCWorld.mconline.gamerole.a.Bf().ama = _tmpRecipientIP;
                            com.MCWorld.mconline.gamerole.a.Bf().serverPort = _tmpRecipientPort;
                        }
                    }
                    ...
                    com.MCWorld.mconline.gameloc.tcp.player.a.AU().a(new c(com.MCWorld.mconline.proto.a.amx, a.alQ, a.alO, a.alP, a.alM, a.alN).c(packetBuffer.length, packetBuffer));
    ...
    private void tick() {
        if (!alS) {
            ...
            com.MCWorld.mconline.gameloc.tcp.player.a.AU().a(new c(1283, com.MCWorld.mconline.gamerole.a.Bf().Bg(), Constants.VIA_REPORT_TYPE_SET_AVATAR, 34, a.alM, a.alN).c(0, null));
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
                e.printStackTrace();
