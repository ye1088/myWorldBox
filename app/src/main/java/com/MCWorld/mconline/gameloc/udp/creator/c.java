...
import com.MCWorld.mconline.gamerole.b;
            ...
            if (datagramPacket != null) {
                ...
                if (packetBuffer.length > 0) {
                    ...
                    if (_tmpSenderIP.equals(a.getHostAddress())) {
                        com.MCWorld.mconline.gameloc.tcp.creator.a.AT().a(new com.MCWorld.mconline.proto.c(com.MCWorld.mconline.proto.a.amy, b.Bh().Bk(), b.Bh().Bi(), b.Bh().Bj(), _curProxyGamePlayer.alD, _curProxyGamePlayer.alC).c(packetBuffer.length, packetBuffer));
                    }
                }
