...
public class c {
    ...
    public static void a(Object paramObject, double paramDouble1, double paramDouble2, double paramDouble3) {
        try {
            ...
            com.MCWorld.mcsdk.log.a.verbose("TAG", "DTPrint setPositionEx Error！---", new Object[0]);
        }
    }
    ...
    public static void b(Object paramObject, double paramDouble) {
        try {
            ...
            com.MCWorld.mcsdk.log.a.verbose("TAG", "DTPrint setVelY dtNativeSetVel_V0110 Error ...", new Object[0]);
        }
    }
