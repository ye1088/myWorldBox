...
import com.MCWorld.mcsdk.DTSDKManager.b;
...
public class m {
    ...
    public static void a(int paramInt1, int paramInt2, String paramString1, String paramString2) {
        try {
            com.MCWorld.mcjsmanager.b.a(paramInt1, paramInt2, paramString1, paramString2, 0);
        } catch (Exception e) {
        }
    }
    ...
    public static void b(int paramInt1, int paramInt2, String paramString1, String paramString2) {
        try {
            com.MCWorld.mcjsmanager.b.a(paramInt1, paramInt2, paramString1, paramString2, 1);
        } catch (Exception e) {
        }
    }
}
