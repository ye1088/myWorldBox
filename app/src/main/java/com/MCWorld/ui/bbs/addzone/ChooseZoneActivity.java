...
import com.MCWorld.framework.base.widget.status.StatusBasePage;
import com.MCWorld.framework.base.widget.title.TitleBar;
import com.MCWorld.module.h;
import com.MCWorld.module.topic.c;
import com.MCWorld.module.topic.d;
import com.MCWorld.module.topic.k;
import com.MCWorld.module.topic.m;
import com.MCWorld.module.topic.n;
...
public class ChooseZoneActivity extends HTBaseThemeActivity {
    ...
    private CallbackHandler mCallback = new CallbackHandler(this) {
        ...
        public void onRecvLogin(com.MCWorld.data.k info, String msg) {
    ...
    private class a extends BaseAdapter implements b {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (com.simple.colorful.d.isDayMode()) {
                holder.aQZ.setBackgroundResource(com.MCWorld.bbs.b.d.SplitLine);
                if (item.equals(this.aQV.aQT)) {
                    holder.aQW.setBackgroundResource(com.MCWorld.bbs.b.d.green_download1);
                    holder.aQX.setTextColor(this.aQV.getResources().getColor(com.MCWorld.bbs.b.d.green_download1));
                    holder.aPx.setBackgroundResource(com.MCWorld.bbs.b.d.background_normal);
                    holder.aQY.setVisibility(4);
                } else {
                    holder.aQW.setBackgroundResource(com.MCWorld.bbs.b.d.transparent);
                    holder.aQX.setTextColor(this.aQV.getResources().getColor(com.MCWorld.bbs.b.d.download_game_desc));
                    holder.aPx.setBackgroundResource(com.MCWorld.bbs.b.d.transparent);
                    holder.aQY.setVisibility(0);
                }
            } else {
                holder.aQZ.setBackgroundResource(com.MCWorld.bbs.b.d.color_split_night);
                if (item.equals(this.aQV.aQT)) {
                    holder.aQW.setBackgroundResource(com.MCWorld.bbs.b.d.color_primary_green_night2);
                    holder.aQX.setTextColor(this.aQV.getResources().getColor(com.MCWorld.bbs.b.d.color_primary_green_night2));
                    holder.aPx.setBackgroundResource(com.MCWorld.bbs.b.d.text_color_topic_score);
                    holder.aQY.setVisibility(4);
                } else {
                    holder.aQW.setBackgroundResource(com.MCWorld.bbs.b.d.transparent);
                    holder.aQX.setTextColor(this.aQV.getResources().getColor(com.MCWorld.bbs.b.d.text_color_tertiary_night));
                    holder.aPx.setBackgroundResource(com.MCWorld.bbs.b.d.transparent);
                    holder.aQY.setVisibility(0);
                }
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mPage = ((StatusPageActivityBuilder) ((StatusPageActivityBuilder) com.MCWorld.ui.status.c.a((FragmentActivity) this).setBoundedView(g.zone_choose_container)).setClickListener(new Supplier<OnClickListener>(this) {
            final /* synthetic */ ChooseZoneActivity aQV;
    ...
    private void EP() {
        ...
        ((ImageView) this.aIw.findViewById(g.sys_header_back)).setImageDrawable(com.simple.colorful.d.o(this, com.MCWorld.bbs.b.c.drawableTitleBack));
    ...
    protected void a(com.simple.colorful.a.a builder) {
        ...
        builder.aY(g.title_bar, com.MCWorld.bbs.b.c.backgroundTitleBar).aY(g.split_top, com.MCWorld.bbs.b.c.splitColorDim).j(this.aQP, com.MCWorld.bbs.b.c.backgroundTitleBarButton).aY(g.split, com.MCWorld.bbs.b.c.splitZoneCategory).aY(g.cate_container, com.MCWorld.bbs.b.c.zoneCategoryBg).aY(g.zone_choose_container, com.MCWorld.bbs.b.c.contentCategoryBg).aZ(g.rl_right_container, com.MCWorld.bbs.b.c.backgroundTitleBarButton);
    }
}
