...
import com.MCWorld.http.bbs.topic.d;
import com.MCWorld.http.bbs.topic.i;
import com.MCWorld.http.bbs.topic.q;
import com.MCWorld.http.bbs.topic.r;
import com.MCWorld.http.bbs.topic.s;
...
import com.MCWorld.ui.bbs.TopicDetailPageTurnLayout.a;
import com.MCWorld.ui.itemadapter.topic.TopicDetailItemAdapter;
import com.MCWorld.ui.itemadapter.topic.TopicDetailItemAdapter.c;
...
public class TopicDetailActivity extends HTBaseLoadingActivity implements OnClickListener, OnItemClickListener, c {
    ...
    private r aOV = new r();
    private d aOW = new d();
    private com.MCWorld.http.bbs.topic.a aOX = new com.MCWorld.http.bbs.topic.a();
    private i aOY = new i();
    private s aOZ = new s();
    private com.MCWorld.http.other.g aPa = new com.MCWorld.http.other.g();
    ...
    private CallbackHandler aPj = new CallbackHandler(this) {
        ...
        public void onRecConf(com.MCWorld.module.topic.g info, String tag, boolean next, Object clickitem) {
            boolean z = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.sK = (TopicItem) getIntent().getSerializableExtra(com.MCWorld.r.gO);
        if (this.sK == null) {
        ...
        if (model != 0) {
            com.MCWorld.service.h.EC().bh(this.postID);
            com.MCWorld.r.ck().i(model, PushMsgType.TOPIC.Value());
        }
        ...
        ((ListView) this.aHX.getRefreshableView()).setOnTouchListener(new com.MCWorld.widget.horizontalscroller.a(this, this.aMn) {
            final /* synthetic */ TopicDetailActivity aPk;
            ...
            public void Ha() {
                ...
                if (videoHeight < (-at.dipToPx(this.aPk.aMn, com.MCWorld.video.recorder.b.bpd))) {
                    this.aPk.GY();
                }
            }
        });
        ...
        if (HTApplication.bV() == null) {
            this.aPa = new com.MCWorld.http.other.g();
            this.aPa.bb(11);
            this.aPa.a(this);
            this.aPa.eX();
        }
    ...
    private void GT() {
        ...
        layout.findViewById(g.tv_confirm).setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View arg0) {
                ...
                com.MCWorld.module.account.a.DU().a(this.aPk.aPf, this.aPk.aPe, this.aPk.aNJ, score_txt);
                dialog.dismiss();
            }
        });
    }
    ...
    private void ky(final int opt) {
        if (opt == MENU_VALUE.REMOVE_TOPIC.ordinal() || opt == MENU_VALUE.REMOVE_COMMENT.ordinal() || opt == MENU_VALUE.AUTHENTICATE_TOPIC.ordinal()) {
            boolean isModerator = as.a(com.MCWorld.data.j.ep().getUserid(), this.sK.getCategory().getModerator());
            if ((com.MCWorld.data.j.ep().getRole() == 1 || isModerator) && opt == MENU_VALUE.REMOVE_TOPIC.ordinal()) {
                GU();
                return;
            }
            final Dialog dialog = new Dialog(this, com.simple.colorful.d.RD());
        ...
        if (this.sK != null) {
            if (com.MCWorld.data.j.ep().ey()) {
                ...
                if (mCat == 0) {
                    ...
                    com.MCWorld.module.topic.g info = ah.KZ().bu(com.MCWorld.data.j.ep().getUserid());
    ...
    private void T(String title, String msg) {
        com.MCWorld.widget.dialog.i dia = new com.MCWorld.widget.dialog.i(this.aMn, null);
        dia.az(title, msg);
        dia.gK("朕知道了");
        dia.showDialog();
    }
