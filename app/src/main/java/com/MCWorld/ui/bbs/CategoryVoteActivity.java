...
import com.MCWorld.http.bbs.category.d;
import com.MCWorld.ui.base.HTBaseTableActivity;
import com.MCWorld.ui.itemadapter.category.CategoryVoteItemAdapter;
...
public class CategoryVoteActivity extends HTBaseTableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.MCWorld.service.i.c(this.aKb);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (this.aKb != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aKb);
            this.aKb = null;
        }
    }
}
