...
import com.MCWorld.http.bbs.category.f;
import com.MCWorld.http.bbs.category.i;
import com.MCWorld.module.h;
import com.MCWorld.module.n;
import com.MCWorld.module.topic.TopicModule;
import com.MCWorld.module.topic.b;
import com.MCWorld.module.topic.g;
...
public class TopicListFragment extends BaseLoadingFragment implements OnClickListener {
    ...
    private f aPX = new f();
    private i aPY = new i();
    private com.MCWorld.http.bbs.category.c aPZ = new com.MCWorld.http.bbs.category.c();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.MCWorld.service.i.e(this.aIn);
        com.MCWorld.service.i.f(this.aIo);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.MCWorld.bbs.b.i.fragment_topic_list, container, false);
        if (this.aPE != null) {
            Hc();
        }
        e(view);
        r.ck().J(String.valueOf(this.aPE.getCategoryID()));
        this.aQk = (ImageView) view.findViewById(com.MCWorld.bbs.b.g.btn_top);
        this.aQk.setOnClickListener(this);
        this.aQj = (ImageView) view.findViewById(com.MCWorld.bbs.b.g.btn_sidebar);
    ...
    private void Hc() {
        ...
        this.aQg = (RelativeLayout) this.aPF.findViewById(com.MCWorld.bbs.b.g.rly_header);
        this.aQg.setOnClickListener(this);
        this.aQf = (TextView) this.aPF.findViewById(com.MCWorld.bbs.b.g.topic_title);
        this.aQf.setText(this.aPE.getTitle());
        if (this.aPJ != 0) {
            this.aQh = (TextView) this.aPF.findViewById(com.MCWorld.bbs.b.g.ic_add_class);
            this.aQh.setOnClickListener(this);
            this.aQb = (LinearLayout) this.aPF.findViewById(com.MCWorld.bbs.b.g.btn_daren);
            this.aQb.setOnClickListener(this);
            this.aQc = (LinearLayout) this.aPF.findViewById(com.MCWorld.bbs.b.g.btn_signin);
            this.aQe = (TextView) this.aPF.findViewById(com.MCWorld.bbs.b.g.tv_signin);
            this.aQc.setOnClickListener(this);
            this.aQd = (LinearLayout) this.aPF.findViewById(com.MCWorld.bbs.b.g.btn_search);
    ...
    protected void a(TitleBar titleBar) {
        super.a(titleBar);
        cr(false);
        titleBar.setLeftLayout(com.MCWorld.bbs.b.i.include_topiclist_titlebar_left);
        titleBar.setRightLayout(com.MCWorld.bbs.b.i.include_topiclist_titlebar_right);
        this.aPL = (RelativeLayout) titleBar.findViewById(com.MCWorld.bbs.b.g.rl_header_back);
        this.aPM = (Button) titleBar.findViewById(com.MCWorld.bbs.b.g.sys_header_back);
        this.aPM.setBackgroundResource(com.MCWorld.bbs.b.f.sl_title_bar_button);
        this.aPM.setOnClickListener(new 1(this));
        this.aPN = (LinearLayout) titleBar.findViewById(com.MCWorld.bbs.b.g.ll_topic_left);
        this.aPO = (Button) titleBar.findViewById(com.MCWorld.bbs.b.g.topic_back);
        this.aPP = (LinearLayout) titleBar.findViewById(com.MCWorld.bbs.b.g.filter_ll);
        this.aPQ = (CheckedTextView) titleBar.findViewById(com.MCWorld.bbs.b.g.filter_tv);
        ...
        this.aIg = (TextView) titleBar.findViewById(com.MCWorld.bbs.b.g.tv_msg);
        ImageButton imgMsg = (ImageButton) titleBar.findViewById(com.MCWorld.bbs.b.g.img_msg);
        imgMsg.setBackgroundResource(com.MCWorld.bbs.b.f.sl_title_bar_button);
        imgMsg.setVisibility(0);
        imgMsg.setOnClickListener(new 10(this));
        this.aPW = (ImageButton) titleBar.findViewById(com.MCWorld.bbs.b.g.sys_header_flright_img);
        this.aPW.setBackgroundResource(com.MCWorld.bbs.b.f.sl_title_bar_button);
        this.aPW.setImageDrawable(d.o(this.mContext, com.MCWorld.bbs.b.c.drawableTitlePost));
    ...
    private void e(View view) {
        this.aHX = (PullToRefreshListView) view.findViewById(com.MCWorld.bbs.b.g.list);
        if (this.aPJ != 0) {
    ...
    private void He() {
        View view = LayoutInflater.from(this.mContext).inflate(com.MCWorld.bbs.b.i.include_topic_filter, null);
        this.aPT = (TextView) view.findViewById(com.MCWorld.bbs.b.g.tv_filter_active_time);
        this.aPS = (TextView) view.findViewById(com.MCWorld.bbs.b.g.tv_filter_marrow);
        this.aPU = (TextView) view.findViewById(com.MCWorld.bbs.b.g.tv_filter_create_time);
        Hf();
        ...
        this.aPR.setBackgroundDrawable(getResources().getDrawable(com.MCWorld.bbs.b.f.bg_topic_filter));
    ...
    private void a(View v, MENU_TOPIC_LIST filterType) {
        ...
        int id = v.getId();
        String filterName = "";
        if (id == com.MCWorld.bbs.b.g.tv_filter_active_time) {
            this.aPT.setTextColor(getResources().getColor(com.MCWorld.bbs.b.d.green_font));
            filterName = this.aPT.getText().toString();
        } else if (id == com.MCWorld.bbs.b.g.tv_filter_marrow) {
            this.aPS.setTextColor(getResources().getColor(com.MCWorld.bbs.b.d.green_font));
            filterName = this.aPS.getText().toString();
        } else if (id == com.MCWorld.bbs.b.g.tv_filter_create_time) {
            this.aPU.setTextColor(getResources().getColor(com.MCWorld.bbs.b.d.green_font));
    ...
    private void Hf() {
        int color = d.getColor(this.mContext, com.MCWorld.bbs.b.c.textColorGreen);
    ...
    public void onDestroy() {
        ...
        if (this.aIn != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aIn);
            this.aIn = null;
        }
        if (this.aIo != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aIo);
            this.aIo = null;
        }
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.MCWorld.bbs.b.g.ic_add_class) {
            Hi();
        } else if (id == com.MCWorld.bbs.b.g.rly_header) {
            t.c(this.mContext, this.aPE.getCategoryID());
        } else if (id == com.MCWorld.bbs.b.g.btn_daren) {
            t.d(this.mContext, this.aPE.getCategoryID());
        } else if (id == com.MCWorld.bbs.b.g.btn_signin) {
            if (!j.ep().ey()) {
        ...
        } else if (id == com.MCWorld.bbs.b.g.btn_top) {
            this.aHX.setRefreshing(true);
            this.aQl.b(this.aQk, 500, 0);
        } else if (id == com.MCWorld.bbs.b.g.btn_sidebar) {
            this.aQn.Hb();
        } else if (id != com.MCWorld.bbs.b.g.btn_search) {
        } else {
            if (!j.ep().ey()) {
                t.an(this.mContext);
    ...
    private void Hj() {
        ...
        new CaseView(this.mContext).a(new RectF(0.0f, (float) top, (float) UtilsScreen.getScreenWidth(this.mContext), (float) (UtilsScreen.dipToPx(this.mContext, 91) + top)), com.MCWorld.bbs.b.f.img_guide_forum, UtilsScreen.dipToPx(this.mContext, 24), UtilsScreen.dipToPx(this.mContext, 45)).show();
    }
    ...
    protected void a(com.simple.colorful.a.a builder) {
        ...
        builder.aY(16908290, com.MCWorld.bbs.b.c.backgroundDefault).i(this.aIw, com.MCWorld.bbs.b.c.backgroundTitleBar).a((TextView) this.aPN.findViewById(com.MCWorld.bbs.b.g.topic_back), com.MCWorld.bbs.b.c.drawableTitleBack, 1).a(this.aPQ, 16842809).a(this.aPQ, com.MCWorld.bbs.b.c.drawableTopicSpinner, 2).c(this.aPW, com.MCWorld.bbs.b.c.drawableTitlePost).bc(com.MCWorld.bbs.b.g.img_msg, com.MCWorld.bbs.b.c.drawableTitleMsg).a(this.aPF).j(this.aQg, com.MCWorld.bbs.b.c.listSelector).c(this.aQk, com.MCWorld.bbs.b.c.drawableReturnTop).c(this.aQj, com.MCWorld.bbs.b.c.drawableRightSidebar);
    }
    ...
    private void T(String title, String msg) {
        com.MCWorld.widget.dialog.i dia = new com.MCWorld.widget.dialog.i(this.mContext, null);
        dia.az(title, msg);
        dia.gK("朕知道了");
        dia.showDialog();
    }
