...
import com.MCWorld.http.bbs.topic.l;
import com.MCWorld.http.other.h;
import com.MCWorld.http.other.i;
...
import com.MCWorld.video.camera.VideoLibLoader;
import com.MCWorld.widget.emoInput.FaceItem;
import com.MCWorld.widget.emoInput.FaceItem.FACE_TYPE;
import com.MCWorld.widget.emoInput.ThemedFacePanelView;
...
public abstract class PublishTopicBaseActivity extends HTBaseActivity implements OnClickListener, OnTouchListener, com.MCWorld.ui.itemadapter.TagAdapter.a, com.MCWorld.widget.emoInput.FacePanelView.a, com.MCWorld.widget.photowall.PhotoWall.a {
    ...
    private class a extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (UtilsFunction.empty(this.aMg.aMf) || !this.aMg.aMf.contains(Long.valueOf(info.userID))) {
                imageView.setUri(null).setImageLoader(com.MCWorld.l.cb().getImageLoader());
                imageView.setUri(Uri.parse(info.avatar), NetFormat.FORMAT_160).setImageLoader(com.MCWorld.l.cb().getImageLoader());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.aLt == 1) {
            ...
            this.aLY.setPhotoCountChangedListener(new com.MCWorld.widget.photowall.PhotoWall2.a(this) {
                final /* synthetic */ PublishTopicBaseActivity aMg;
            ...
            this.aLS.a((com.MCWorld.ui.itemadapter.TagAdapter.a) this);
        } else {
            this.aLC.setOnClickListener(this);
            this.aLG.setOnClickListener(this);
            this.aLL.setOnClickListener(this);
    ...
    protected void Gk() {
        ...
        this.aLW.a(new com.MCWorld.http.base.f(this) {
            final /* synthetic */ PublishTopicBaseActivity aMg;
    ...
    private void en(String url) {
        if (url.length() > 0) {
            ...
            this.aLA.setUri(Uri.parse(url)).placeHolder(d.isDayMode() ? f.place_holder_normal : f.place_holder_night_normal).setImageLoader(com.MCWorld.l.cb().getImageLoader());
        }
    }
    ...
    protected void a(int index, HTUploadInfo info) {
        List<com.MCWorld.module.picture.b> photos = this.aLY.getExistPhotos();
    ...
    private void a(final Runnable runnable, final boolean statis) {
        com.MCWorld.data.g userInfo = j.ep().ew();
        if (userInfo != null) {
            final com.MCWorld.module.topic.g info = ah.KZ().bu(userInfo.userID);
            ...
            if (info != null && !UtilsFunction.empty(info.videosourl)) {
                ...
                VideoLibLoader.MZ().a(info.videosourl, info.videosomd5, new com.MCWorld.video.camera.VideoLibLoader.a(this) {
                    final /* synthetic */ PublishTopicBaseActivity aMg;
    ...
    public void a(FaceItem faceItem) {
        ...
        if (com.MCWorld.widget.emoInput.c.byf.equals(faceItem.text)) {
            this.aLw.onKeyDown(67, new KeyEvent(0, 67));
            return;
        }
        String text = this.aLw.getText().toString() + faceItem.text;
        int expressCount = com.MCWorld.widget.emoInput.d.Ou().gN(text);
        Log.d("[Emoji Click]", text);
        if (expressCount <= 15) {
            int selStart = this.aLw.getSelectionStart();
            this.aLw.getText().insert(selStart, faceItem.text);
            this.aLw.setText(com.MCWorld.widget.emoInput.d.Ou().c(this.aLw.getContext(), this.aLw.getText().toString(), at.dipToPx(this, 22), 0));
    ...
    protected void a(com.MCWorld.data.topic.c draft) {
    }

    protected void b(com.MCWorld.data.topic.c draft) {
    }
    ...
    private void ES() {
        if (!TextUtils.isEmpty(FS())) {
            ...
            com.MCWorld.data.topic.c draft = new com.MCWorld.data.topic.c();
            a(draft);
    ...
    private void ER() {
        ...
        try {
            if (prefs.contains(draftKey)) {
                com.MCWorld.data.topic.c draft = (com.MCWorld.data.topic.c) Json.parseJsonObject(prefs.getString(draftKey, ""), com.MCWorld.data.topic.c.class);
                if (draft != null) {
                    b(draft);
                }
            }
