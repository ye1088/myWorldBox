...
import com.MCWorld.widget.photowall.PhotoWall.a;
...
public class PublishTopicWishActivity extends HTBaseThemeActivity implements f, a {
    ...
    private void en(String url) {
        if (url.length() > 0) {
            ...
            this.aLA.setUri(Uri.parse(url)).placeHolder(com.simple.colorful.d.isDayMode() ? b.f.place_holder_normal : b.f.place_holder_night_normal).setImageLoader(com.MCWorld.l.cb().getImageLoader());
        }
    }
