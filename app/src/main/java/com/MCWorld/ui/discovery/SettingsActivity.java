package com.MCWorld.ui.discovery;
...
import com.MCWorld.widget.dialog.p;
...
public class SettingsActivity extends HTBaseActivity implements OnCheckedChangeListener {
    ...
    OnClickListener aRN = new OnClickListener(this) {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (g.rlv_netmod == id) {
                new p(this.aRP.aRL, ah.KZ().Lm(), com.MCWorld.utils.ah.b.bme, this.aRP.aRO).show();
                ...
                com.MCWorld.module.account.a.DU().DW();
                com.MCWorld.data.j.ep().clear();
                i.EG();
                t.an(this.aRP.aRL);
                ...
                ah.KZ().LE();
                com.MCWorld.widget.dialog.a aVar = new com.MCWorld.widget.dialog.a(this.aRP.aRL, new a(), null);
            } else if (id == g.tv_present_calabash) {
                t.f(this.aRP.aRL, Constants.brR, "致葫芦丝");
            }
        }
    };
    com.MCWorld.widget.dialog.p.a aRO = new com.MCWorld.widget.dialog.p.a(this) {
        final /* synthetic */ SettingsActivity aRP;
    ...
    public static class a implements com.MCWorld.widget.dialog.a.a {
        ...
        public void a(com.MCWorld.widget.dialog.a.b info) {
    ...
    private class c implements com.MCWorld.widget.dialog.g.a {
        final /* synthetic */ SettingsActivity aRP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.MCWorld.bbs.b.i.activity_settings);
        this.aRL = this;
    ...
    private void a(e msgRemind, boolean isChecked) {
        if (isChecked) {
            com.MCWorld.widget.dialog.g dia = new com.MCWorld.widget.dialog.g(this, new c());
    ...
    private void U(String szMessage, final String szUrl) {
        if (!isFinishing()) {
            ...
            View layout = LayoutInflater.from(this).inflate(com.MCWorld.bbs.b.i.include_dialog_three, null);
