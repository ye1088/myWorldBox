...
public class MsgSettingsActivity extends HTBaseActivity implements OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (j.ep().ey()) {
            com.MCWorld.module.account.a.DU().DX();
        }
    }
    ...
    private void cE(boolean isChecked) {
        boolean z = false;
        if (j.ep().ey()) {
            com.MCWorld.module.account.a.DU().a(isChecked, 0);
            return;
        }
        if (this.aRC != null) {
    ...
    private void cF(boolean isChecked) {
        boolean z = true;
        if (j.ep().ey()) {
            com.MCWorld.module.account.a.DU().a(isChecked, 1);
            return;
        }
        if (this.aRD != null) {
    ...
    private void cG(boolean isChecked) {
        if (j.ep().ey()) {
            com.MCWorld.module.account.a.DU().a(isChecked, 2);
            return;
        }
        if (this.aRE != null) {
    ...
    private void cH(boolean isChecked) {
        if (j.ep().ey()) {
            com.MCWorld.module.account.a.DU().a(isChecked, 3);
            return;
        }
        if (this.aRF != null) {
