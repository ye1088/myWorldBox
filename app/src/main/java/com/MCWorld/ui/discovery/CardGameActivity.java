...
public class CardGameActivity extends HTBaseLoadingActivity {
    ...
    private CallbackHandler eY = new CallbackHandler(this) {
        ...
        public void onLogin() {
            ...
            this.aRv.aJr.loadUrl(String.format("%s/view/game/3card_index?_key=%s&firstload=1", new Object[]{com.MCWorld.http.base.a.rN, key}));
        }
    };
    ...
    private void Fm() {
        ...
        String key = j.ep().getToken();
        this.aJr.loadUrl(String.format("%s/view/game/3card_index?_key=%s&firstload=1", new Object[]{com.MCWorld.http.base.a.rN, key}));
    }
