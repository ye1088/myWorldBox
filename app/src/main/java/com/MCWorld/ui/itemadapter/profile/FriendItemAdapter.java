...
import com.MCWorld.module.profile.c;
...
public class FriendItemAdapter extends BaseAdapter implements OnClickListener, OnCheckedChangeListener, b {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (user != null) {
            ...
            if (this.aVA && this.aMf != null && this.aMf.contains(Long.valueOf(user.userID))) {
                holder.aVK.setButtonDrawable(d.o(this.mContext, com.MCWorld.bbs.b.c.drawableHookDisable));
            } else {
                holder.aVK.setButtonDrawable(d.o(this.mContext, com.MCWorld.bbs.b.c.drawableHook));
            }
            if (!this.aVA) {
    ...
    public void a(j setter) {
        setter.bg(g.item_container, com.MCWorld.bbs.b.c.listSelector).bf(g.split_item, com.MCWorld.bbs.b.c.splitColor).bh(g.nick, 16843282).bh(g.publish_time, 16843282).bh(g.hit_num, 16843282).bf(g.avatar, com.MCWorld.bbs.b.c.valBrightness).bg(g.avatar_corner, com.MCWorld.bbs.b.c.drawableHuluCorner);
    }
