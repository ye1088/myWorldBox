...
import com.MCWorld.video.views.VideoView;
...
public class TopicDetailItemAdapter extends BaseAdapter implements b {
    ...
    private com.MCWorld.video.views.scalable.b aXv;
    private long aXw;
    private Bitmap aXx;
    ...
    private void c(View v, TopicItem data) {
        ...
        this.aXr.setDefaultImageResId(com.MCWorld.bbs.b.d.black);
        try {
    ...
    public void HK() {
        try {
            ...
            t.show_toast(this.aTg, "暂时不支持播放该格式的视频");
        }
    }
    ...
    private void d(TopicItem data) {
        if (!ak.isNetworkConnected(this.aTg)) {
            ...
            t.show_toast(this.aTg, "视频地址解析出错");
            this.aXq.setVisibility(8);
            this.aXp.setVisibility(0);
        } else {
            this.aXz = HttpMgr.getInstance().getDownloadReqBuilder(this.aXy.videourl, Environment.getExternalStorageDirectory() + com.MCWorld.utils.d.bjY + File.separator + "downloads", UtilsMD5.getMD5String(String.valueOf(SystemClock.elapsedRealtime())) + a.boV);
    ...
    public void HO() {
        ...
        t.show_toast(this.aTg, "视频加载失败,请稍后重试");
    }
    ...
    private void a(ScoreItem scoreItem, TextView tv) {
        ...
        if (scoreItem.isIsadmin()) {
            tv.setTextColor(d.getColor(this.aTg, com.MCWorld.bbs.b.c.textColorTopicHuluRed));
        } else {
            tv.setTextColor(d.getColor(this.aTg, com.MCWorld.bbs.b.c.textColorGreenTopic));
        }
    }
    ...
    public void a(j setter) {
        setter.bg(g.topic_other, com.MCWorld.bbs.b.c.listSelector).bg(g.topic_one, com.MCWorld.bbs.b.c.listSelector).bh(g.content, 16842808).bh(g.floor, 16842808).bh(g.publish_time, 16842808).bh(g.content_short, 16842808).bh(g.content_long, 16842808).bg(g.delcontent, com.MCWorld.bbs.b.c.backgroundTopicReply).bg(g.retcontent, com.MCWorld.bbs.b.c.backgroundTopicReply).bh(g.delcontent, 16843282).bh(g.retcontent, 16843282).bh(g.more, com.MCWorld.bbs.b.c.textColorGreen).bf(g.split_item_alt, com.MCWorld.bbs.b.c.splitColor).bf(g.split_item, com.MCWorld.bbs.b.c.splitColor).bi(g.avatar, com.MCWorld.bbs.b.c.valBrightness).bj(g.iv_moderator_symbol, com.MCWorld.bbs.b.c.drawableModeratorAuth);
    }
}
