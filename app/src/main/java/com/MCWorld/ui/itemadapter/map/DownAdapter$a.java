...
class DownAdapter$a implements OnClickListener {
    ...
    private com.MCWorld.data.map.f.a info;
    ...
    public DownAdapter$a(DownAdapter downAdapter, DownAdapter$b paraholder, com.MCWorld.data.map.f.a parainfo) {
    ...
    public void k(View arg0) {
        ...
        if (j.KH() == 740110001) {
            ...
            MapItem item = com.MCWorld.data.map.f.a.convertMapItem(this.info);
