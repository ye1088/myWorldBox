...
public class ProfileSpaceAdapter extends BaseAdapter implements com.simple.colorful.b {
    ...
    private int[] aVR;
    private int[] aVS;
    private List<com.MCWorld.data.profile.b> aVT;
    private a aVU;
    ...
    private void HD() {
        ...
        for (int i = 0; i < count; i++) {
            this.aVT.add(new com.MCWorld.data.profile.b(this.mContext.getResources().getString(this.aVR[i]), i));
        }
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        a(holder);
        a(holder.aVW, (com.MCWorld.data.profile.b) getItem(position));
        a(holder.aVX, (position * 3) + 1 < this.aVT.size() ? (com.MCWorld.data.profile.b) this.aVT.get((position * 3) + 1) : null);
        a(holder.aVY, (position * 3) + 2 < this.aVT.size() ? (com.MCWorld.data.profile.b) this.aVT.get((position * 3) + 2) : null);
        return convertView;
    }
    ...
    private void a(a item, com.MCWorld.data.profile.b itemInfo) {
        if (itemInfo == null) {
