...
import com.MCWorld.framework.base.widget.cropimage.CropImageView;
...
public class PictureCropActivity extends HTBaseActivity {
    ...
    private c<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> mDataSource;
    private com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b> mImage;
    ...
    private void a(String url, final int position, final CropImageView imageView) {
        ...
        e imagePipeline = com.MCWorld.image.pipeline.core.h.mz().lj();
        ...
        this.mDataSource.a(new com.MCWorld.image.core.datasource.b<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>>(this) {
            final /* synthetic */ PictureCropActivity beD;

            protected void onNewResultImpl(c<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> dataSource) {
                this.beD.mImage = (com.MCWorld.image.core.common.references.a) dataSource.getResult();
                if (!(this.beD.mImage == null || this.beD.mImage.get() == null)) {
                    imageView.setImageBitmap(((com.MCWorld.image.base.imagepipeline.image.a) this.beD.mImage.get()).hM(), null, !contain);
            ...
            protected void onFailureImpl(c<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> cVar) {
                this.beD.aRr.cancel();
            }

            public void onProgressUpdate(c<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> cVar) {
            }
