...
import com.MCWorld.module.picture.a;
import com.MCWorld.ui.base.BaseThemeFragment;
import com.MCWorld.ui.itemadapter.picture.PictureAdapter;
...
public class PictureChooserFragment extends BaseThemeFragment {
    ...
    public interface b {
        ...
        void b(com.MCWorld.module.picture.b bVar);

        void c(com.MCWorld.module.picture.b bVar);

        void d(com.MCWorld.module.picture.b bVar);

        void kX(int i);
    }

    public static PictureChooserFragment a(int choiceMode, int maxSelectedCount, boolean showCamera, ArrayList<com.MCWorld.module.picture.b> currentSelection) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (!ad.empty(mShotPath) && UtilsFile.isExist(mShotPath)) {
            com.MCWorld.module.picture.b unit = new com.MCWorld.module.picture.b();
    ...
    private void IX() {
        ...
        this.ZY = new PopupWindow(list, -1, at.dipToPx(getActivity(), com.MCWorld.video.recorder.b.bpd));
    ...
    public ArrayList<com.MCWorld.module.picture.b> Jd() {
        return this.aVc;
    }
