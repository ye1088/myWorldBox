...
public class ForgetPasswordActivity extends HTBaseActivity {
    ...
    private void HV() {
        ...
        if (TextUtils.isEmpty(this.aXL)) {
            ...
            cs(true);
            com.MCWorld.module.account.a.DU().j(this.aXL, this.aXN, this.aXO);
        } else {
    ...
    private void HW() {
        ...
        if (!UtilsString.validEmail(this.aXL) && !UtilsString.validPhone(this.aXL)) {
            ...
            cs(true);
            com.MCWorld.module.account.a.DU().d(this.aXL, this.aXM, this.aXN, this.aXO);
        } else {
    ...
    public void a(com.MCWorld.data.i qqinfo) {
        ...
        com.MCWorld.widget.dialog.c dialogManager = new com.MCWorld.widget.dialog.c(this.aXF);
        if (qqinfo != null) {
