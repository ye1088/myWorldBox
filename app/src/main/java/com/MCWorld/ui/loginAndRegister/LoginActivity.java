...
import com.MCWorld.widget.dialog.c;
...
public class LoginActivity extends HTBaseActivity {
        ...
        protected void d(JSONObject values) {
            ...
            if (this.aYl.aXS.getText().toString() != null) {
                ...
                if (this.aYl.aYg) {
                    ...
                    com.MCWorld.module.account.a.DU().Q(openId, token);
                    return;
                }
                this.aYl.cs(true);
    ...
    private com.MCWorld.http.loginAndRegister.a aXZ = new com.MCWorld.http.loginAndRegister.a();
    ...
    private boolean l(String qqInfo, String openid, String qtoken) {
        ...
        if (!UtilsString.validEmail(email.trim()) && !UtilsString.validPhone(email.trim())) {
            ...
            com.MCWorld.module.account.a.DU().a(email, UtilsMD5.getMD5String(password), openid, qtoken, qqInfo);
            return true;
        }
    }
    ...
    public void c(d response) {
        ...
        if (response.getStatus() != 1) {
            ...
            com.MCWorld.data.h info = (com.MCWorld.data.h) response.getData();
    ...
    public void a(com.MCWorld.data.i qqinfo) {
