...
public class ResourceNewsFragment extends BaseLoadingFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Fy();
            com.MCWorld.module.news.i.Ea().ar(0, 20);
        } else {
    ...
    private void Fp() {
        if (this.aIe != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aIe);
        }
        if (this.aIf != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aIf);
        }
    }

    private void Fq() {
        com.MCWorld.service.i.e(this.aIe);
        com.MCWorld.service.i.f(this.aIf);
    }
