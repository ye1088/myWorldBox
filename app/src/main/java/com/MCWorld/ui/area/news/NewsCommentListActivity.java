...
import com.MCWorld.framework.base.widget.KeyboardResizeLayout;
import com.MCWorld.framework.base.widget.KeyboardResizeLayout.OnKeyboardShowListener;
import com.MCWorld.module.h;
import com.MCWorld.module.news.c;
import com.MCWorld.module.news.d;
import com.MCWorld.module.news.e;
import com.MCWorld.t;
import com.MCWorld.ui.base.HTBaseLoadingActivity;
import com.MCWorld.ui.itemadapter.news.NewsCommentItemAdapter;
...
public class NewsCommentListActivity extends HTBaseLoadingActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            com.MCWorld.module.news.i.Ea().d(0, this.aHe.infoId);
            Fy();
        }
    }
    ...
    private void Fh() {
        ...
        ek("正在提交");
        cs(true);
        com.MCWorld.module.news.i.Ea().a(this.aHe.infoId, this.aHi ? this.aHj.commentID : 0, content, "NewsCommentListActivity");
        this.aHd.setText("");
    ...
    private void initView() {
        ...
        this.aEq.setOnRefreshListener(new OnRefreshListener<ListView>(this) {
            ...
            public void onRefresh(PullToRefreshBase<ListView> pullToRefreshBase) {
                com.MCWorld.module.news.i.Ea().d(0, this.aHm.aHe.infoId);
            }
        });
        ...
        this.aHb.a(new a(this) {
            ...
            public void onLoadData() {
                com.MCWorld.module.news.i.Ea().d(this.aHm.aHf == null ? 0 : this.aHm.aHf.start, this.aHm.aHe.infoId);
            }
