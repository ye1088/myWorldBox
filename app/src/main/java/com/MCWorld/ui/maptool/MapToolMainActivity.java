...
import com.MCWorld.mojang.WorldItem;
...
import com.MCWorld.widget.ImageSwitch;
import com.MCWorld.widget.TextImageButton;
...
public class MapToolMainActivity extends Activity {
        ...
        public void onCheckedChanged(CompoundButton checkbox, boolean checked) {
            switch (checkbox.getId()) {
                ...
                case R.id.mapConfigChkFlyMode:
                    try {
                        com.MCWorld.mcmap.a.cb(checked);
                        return;
                    } catch (Exception e) {
                ...
                case R.id.mapConfigChkViewMode:
                    try {
                        com.MCWorld.mcmap.a.cc(checked);
                        return;
                    } catch (Exception e2) {
                ...
                case R.id.mapConfigChkInvincibleMode:
                    try {
                        com.MCWorld.mcmap.a.cd(checked);
                        return;
                    } catch (Exception e3) {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.mapConfigTexGameMode:
                    ...
                    try {
                        com.MCWorld.mcmap.a.setGameMode(this.baF.bav);
                    } catch (Exception e) {
                        Toast.makeText(this.baF.mContext, "游戏模式异常", 1).show();
                    }
                    int _tmpGameMode = com.MCWorld.mcmap.a.getGameMode();
                    boolean _tmpTimeMode = com.MCWorld.mcmap.a.AD();
                    return;
                case R.id.mapConfigTexTimeMode:
                    this.baF.baw = this.baF.bag.isFirst();
                    try {
                        com.MCWorld.mcmap.a.ca(this.baF.baw);
                        return;
                    } catch (Exception e2) {
    ...
    private void Im() {
        try {
            ...
            boolean bReadMapOK = com.MCWorld.mcmap.a.di(this.bat);
    ...
    private void In() {
        this.bav = com.MCWorld.mcmap.a.getGameMode();
        this.baw = com.MCWorld.mcmap.a.AD();
        this.bax = com.MCWorld.mcmap.a.AE();
        this.bay = com.MCWorld.mcmap.a.AF();
        this.baz = com.MCWorld.mcmap.a.AG();
    }
