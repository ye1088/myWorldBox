...
import com.MCWorld.ui.itemadapter.profile.SpaceRecommendStyleAdapter;
...
public class SpaceRecommendStyleFragment extends BaseThemeFragment {
    ...
    private void reload() {
        com.MCWorld.module.profile.g.Eb().at(0, 20);
    }

    private void Fc() {
        com.MCWorld.module.profile.g.Eb().at(this.bhx == null ? 0 : this.bhx.start, 20);
    }
