...
import com.MCWorld.module.account.e;
import com.MCWorld.module.h;
import com.MCWorld.module.w;
import com.MCWorld.t;
import com.MCWorld.ui.base.BaseLoadingFragment;
import com.MCWorld.ui.itemadapter.message.MessageItemAdapter;
...
public class UserMsgFragment extends BaseLoadingFragment {
    ...
    private CallbackHandler mCallback = new CallbackHandler(this) {
        ...
        public void onRecConf(com.MCWorld.module.topic.g info, String tag, boolean next, Object context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.aHb.a(new a(this) {
            ...
            public void onLoadData() {
                com.MCWorld.module.account.a.DU().M(this.bjp.bjl == null ? "0" : this.bjp.bjl.start, 20);
            }
    ...
    public void reload() {
        com.MCWorld.module.account.a.DU().M("0", 20);
        HTApplication.a(null);
        com.MCWorld.service.h.EC().ED();
        com.MCWorld.service.i.EI();
    }
    ...
    private void GT() {
        ...
        layout.findViewById(g.tv_confirm).setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View arg0) {
                ...
                com.MCWorld.module.account.a.DU().a(post_id, isTopic, this.bjp.aNJ, score_txt);
                dialog.dismiss();
            }
        });
    }
    ...
    private void T(String title, String msg) {
        com.MCWorld.widget.dialog.i dia = new com.MCWorld.widget.dialog.i(this.bjk.getActivity(), null);
        dia.az(title, msg);
        dia.gK("朕知道了");
        dia.showDialog();
    }
    ...
    private void b(Activity activity, long cat_id, boolean isnext) {
        if (!this.aPg) {
            this.aPg = true;
            com.MCWorld.module.topic.k.Ej().b(activity, cat_id, TAG, isnext, null);
        }
    }
