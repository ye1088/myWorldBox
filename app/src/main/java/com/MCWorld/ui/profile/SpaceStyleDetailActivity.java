...
public class SpaceStyleDetailActivity extends HTBaseThemeActivity {
    ...
    private void EP() {
        this.bhJ = new b();
        this.bhK = new a();
        com.MCWorld.service.i.e(this.bhJ);
        com.MCWorld.service.i.f(this.bhK);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (this.bhJ != null) {
            com.MCWorld.service.i.unregisterReceiver(this.bhJ);
            this.bhJ = null;
        }
        if (this.bhK != null) {
            com.MCWorld.service.i.unregisterReceiver(this.bhK);
            this.bhK = null;
        }
    }
