...
public class ProfileExchangeSubmitActivity extends HTBaseActivity implements OnClickListener {
    ...
    private void Ju() {
        ...
        if (TextUtils.isEmpty(alipayAccount)) {
            ...
            try {
                com.MCWorld.module.profile.g.Eb().h(this.bgr.getGUID(), com.MCWorld.data.profile.a.a(this.bgr, alipayAccount, alipayNick));
                cs(true);
    ...
    private void Jv() {
        ...
        try {
            com.MCWorld.module.profile.g.Eb().h(this.bgr.getGUID(), com.MCWorld.data.profile.a.a(this.bgr, qq));
            cs(true);
        } catch (JSONException e) {
        }
    }
    ...
    private void Jw() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            try {
                com.MCWorld.module.profile.g.Eb().h(this.bgr.getGUID(), com.MCWorld.data.profile.a.a(this.bgr, name, tel, addr));
                cs(true);
            } catch (JSONException e) {
            }
        }
    ...
    private void Jx() {
        ...
        try {
            com.MCWorld.module.profile.g.Eb().h(this.bgr.getGUID(), com.MCWorld.data.profile.a.b(this.bgr, tel));
            cs(true);
        } catch (JSONException e) {
        }
    }
