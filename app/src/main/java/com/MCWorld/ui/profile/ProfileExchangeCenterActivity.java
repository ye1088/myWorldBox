...
public class ProfileExchangeCenterActivity extends HTBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.aRV = new a();
        com.MCWorld.service.i.c(this.aRV);
    ...
    protected void onDestroy() {
        ...
        if (this.aRV != null) {
            com.MCWorld.service.i.unregisterReceiver(this.aRV);
        }
    }
    ...
    private void Gy() {
        Jm();
        if (this.bgd == null) {
            com.MCWorld.module.profile.g.Eb().jT(0);
            this.bfX.Fy();
        } else {
            a(this.bgd);
            this.bfX.FC();
        ...
        if (this.bge == null) {
            com.MCWorld.module.profile.g.Eb().jT(1);
            this.bfY.Fy();
            return;
        }
        b(this.bge);
