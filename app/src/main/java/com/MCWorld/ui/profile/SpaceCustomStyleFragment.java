...
import com.MCWorld.widget.photowall.PhotoWall2.a;
...
public class SpaceCustomStyleFragment extends BaseThemeFragment implements f {
    ...
    public View onCreateView(LayoutInflater inflater, @z ViewGroup container, @z Bundle savedInstanceState) {
        ...
        this.bhn.setText(getResources().getString(com.MCWorld.bbs.b.m.format_photo_count, new Object[]{Integer.valueOf(0)}));
        n(this.mView);
    ...
    private void reload() {
        if (j.ep().ey()) {
            com.MCWorld.module.profile.g.Eb().aR(j.ep().getUserid());
        }
    }
    ...
    private void n(View view) {
        ...
        this.bhm.setItemClickListener(new PhotoWall2.b(this) {
            ...
            public void Gq() {
                if (this.bhs.bhm.getPhotoCount() >= 8) {
                    t.show_toast(this.bhs.getActivity(), this.bhs.getResources().getString(com.MCWorld.bbs.b.m.album_photo_count_max, new Object[]{Integer.valueOf(8)}));
        ...
        this.bhm.setPhotoCountChangedListener(new a(this) {
            ...
            public void kx(int count) {
                this.bhs.bhn.setText(this.bhs.getResources().getString(com.MCWorld.bbs.b.m.format_photo_count, new Object[]{Integer.valueOf(count)}));
                if (count < 3) {
    ...
    private void JC() {
        if (this.aKG != null) {
            ...
            t.show_toast(getActivity(), getResources().getString(com.MCWorld.bbs.b.m.album_no_modified));
        }
    }
    ...
    private boolean JE() {
        ...
        cs(true);
        this.bho.setEnabled(false);
        String path = UtilsImage.ScaleBitmapFile(this.bhq.localPath, com.MCWorld.module.h.arA, com.MCWorld.module.h.arA);
        this.aLT.bb(1);
    ...
    private boolean JF() {
        ...
        cs(true);
        this.bho.setEnabled(false);
        com.MCWorld.module.profile.g.Eb().ed(this.bhq.fid);
        return true;
    }
    ...
    private boolean JG() {
        ...
        com.MCWorld.module.profile.g.Eb().a(newModel, getActivity());
        return true;
    }
    ...
    public void c(d response) {
        ...
        if (response.fe() == 1) {
            ...
            if (response.getStatus() == 1) {
                t.o(getActivity(), getResources().getString(com.MCWorld.bbs.b.m.delete_album_photo_succ));
                this.bhm.gR(this.bhr.fid);
                this.bhr = null;
                EventNotifyCenter.notifyEvent(com.MCWorld.module.profile.f.class, 3, new Object[]{this.bhm.getPhotos()});
                return;
            }
    ...
    private void c(final b unit, final int position) {
        ...
        list.add(new ResMenuItem("查看原图", 0, com.MCWorld.bbs.b.d.locmgr_focus_btn_color));
        list.add(new ResMenuItem("删除", 1, com.MCWorld.bbs.b.d.locmgr_focus_btn_color));
        this.aHI = new CommonMenuDialog(getActivity(), list, new CommonMenuDialogListener(this) {
            ...
            public void pressMenuById(int inIndex, Object object) {
                if (inIndex == 0) {
                    ...
                    for (com.MCWorld.widget.banner.a info : this.bhs.aKG.getPhotos()) {
                        urls.add(info.url);
                    }
