    ...
    private void Kf() {
        ...
        this.beo.setItemClickListener(new b(this) {
            ...
            public void a(com.MCWorld.module.picture.b unit, int position) {
                ...
                while (it.hasNext()) {
                    urls.add(((com.MCWorld.module.picture.b) it.next()).url);
                }
    ...
    private void a(PhotoWall2 photoWall, List<PhotoInfo> photos) {
        if (photos != null && photos.size() > 0) {
            ...
            for (PhotoInfo photo : photos) {
                com.MCWorld.module.picture.b un = new com.MCWorld.module.picture.b();
                un.url = photo.getUrl();
    ...
    private void Kg() {
        ...
        layout.findViewById(g.tv_confirm).setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View arg0) {
                ...
                com.MCWorld.module.profile.g.Eb().aT(this.bjf.pW);
            }
        });
    }
