...
import com.MCWorld.image.base.cache.common.f;
import com.MCWorld.image.base.cache.common.g;
import com.MCWorld.image.core.common.disk.c;
import java.io.File;
...
public class b {
    ...
    private final com.MCWorld.image.core.common.disk.b ug;
    private final boolean uh;

    private b(a builder) {
        CacheErrorLogger gm;
        CacheEventListener gn;
        com.MCWorld.image.core.common.disk.b ij;
        this.tY = a.a(builder);
    ...
    public com.MCWorld.image.core.common.disk.b gI() {
        return this.ug;
    }
