...
import com.MCWorld.framework.base.utils.CountingOutputStream;
...
import com.MCWorld.image.base.cache.common.CacheErrorLogger.CacheErrorCategory;
import com.MCWorld.image.base.cache.common.i;
import com.MCWorld.image.base.cache.disk.c.c;
import com.MCWorld.image.core.common.file.FileUtils;
import com.MCWorld.image.core.common.file.FileUtils.CreateDirectoryException;
import com.MCWorld.image.core.common.file.FileUtils.ParentDirNotFoundException;
import com.MCWorld.image.core.common.file.FileUtils.RenameException;
import java.io.File;
...
public class DefaultDiskStorage implements c {
    ...
    private final com.MCWorld.image.core.common.time.a tO = com.MCWorld.image.core.common.time.d.iK();
    ...
    private class a implements com.MCWorld.image.core.common.file.b {
    ...
    static class b implements c {
        ...
        private long size;
        private final com.MCWorld.image.base.binaryresource.c tR;
        private long timestamp;

        public /* synthetic */ com.MCWorld.image.base.binaryresource.a gx() {
            return gw();
        }
        ...
        private b(String id, File cachedFile) {
            ...
            this.tR = com.MCWorld.image.base.binaryresource.c.h(cachedFile);
            this.size = -1;
            this.timestamp = -1;
        }
        ...
        public com.MCWorld.image.base.binaryresource.c gw() {
            return this.tR;
        }
    ...
    @VisibleForTesting
    class d implements com.MCWorld.image.base.cache.disk.c.d {
        final /* synthetic */ DefaultDiskStorage tQ;
        ...
        public com.MCWorld.image.base.binaryresource.a h(Object debugInfo) throws IOException {
            ...
            try {
                ...
                return com.MCWorld.image.base.binaryresource.c.h(targetFile);
    ...
    private class e implements com.MCWorld.image.core.common.file.b {
        final /* synthetic */ DefaultDiskStorage tQ;
        private boolean tW;
    ...
    private void gq() {
        ...
        if (!this.mRootDirectory.exists()) {
            ...
            recreateBase = true;
            com.MCWorld.image.core.common.file.a.t(this.mRootDirectory);
        }
        if (recreateBase) {
            try {
                FileUtils.u(this.tM);
    ...
    public void gr() {
        com.MCWorld.image.core.common.file.a.a(this.mRootDirectory, new e());
    }
    ...
    public com.MCWorld.image.base.cache.disk.c.d c(String resourceId, Object debugInfo) throws IOException {
    ...
    public com.MCWorld.image.base.binaryresource.a d(String resourceId, Object debugInfo) {
        File file = bb(resourceId);
        if (!file.exists()) {
            return null;
        }
        file.setLastModified(this.tO.now());
        return com.MCWorld.image.base.binaryresource.c.h(file);
    }
    ...
    public void clearAll() {
        com.MCWorld.image.core.common.file.a.deleteContents(this.mRootDirectory);
    }

    public com.MCWorld.image.base.cache.disk.c.a gs() throws IOException {
        List<c> entries = gt();
        com.MCWorld.image.base.cache.disk.c.a dumpInfo = new com.MCWorld.image.base.cache.disk.c.a();
        for (c entry : entries) {
            com.MCWorld.image.base.cache.disk.c.b infoEntry = b(entry);
    ...
    private com.MCWorld.image.base.cache.disk.c.b b(c entry) throws IOException {
        b entryImpl = (b) entry;
        String firstBits = "";
        ...
        return new com.MCWorld.image.base.cache.disk.c.b(entryImpl.gw().getFile().getPath(), type, (float) entryImpl.getSize(), firstBits);
    }
    ...
    public List<c> gt() throws IOException {
        a collector = new a();
        com.MCWorld.image.core.common.file.a.a(this.tM, collector);
        return collector.gt();
    }
