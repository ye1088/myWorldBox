...
import com.MCWorld.image.drawee.drawable.RoundedCornersDrawable;
import com.MCWorld.image.drawee.drawable.g;
import com.MCWorld.image.drawee.drawable.h;
import com.MCWorld.image.drawee.drawable.k;
import com.MCWorld.image.drawee.drawable.l;
import com.MCWorld.image.drawee.drawable.m;
import com.MCWorld.image.drawee.drawable.n;
...
public class e {
    ...
    static n a(com.MCWorld.image.drawee.drawable.c parent, c scaleType) {
    ...
    static void a(com.MCWorld.image.drawee.drawable.c parent, @Nullable RoundingParams roundingParams) {
    ...
    static void a(com.MCWorld.image.drawee.drawable.c parent, @Nullable RoundingParams roundingParams, Resources resources) {
        parent = a(parent);
        Drawable child = parent.getDrawable();
    ...
    static Drawable a(@Nullable Drawable drawable, @Nullable RoundingParams roundingParams, Resources resources) {
        ...
        com.MCWorld.image.drawee.drawable.c parent = a((g) drawable);
    ...
    static com.MCWorld.image.drawee.drawable.c a(com.MCWorld.image.drawee.drawable.c parent) {
        while (true) {
            Drawable child = parent.getDrawable();
            if (child == parent || !(child instanceof com.MCWorld.image.drawee.drawable.c)) {
                return parent;
            }
            parent = (com.MCWorld.image.drawee.drawable.c) child;
        }
        return parent;
    }
}
