...
public class e {
    ...
    private final com.MCWorld.image.base.imagepipeline.cache.e<b, com.MCWorld.image.base.imagepipeline.image.b> Fj;
    private final com.MCWorld.image.base.imagepipeline.cache.e<b, PooledByteBuffer> Fk;
    private final c Fl;
    private final aw Fm;
    private final Supplier<Boolean> Fn;
    private AtomicLong Fo = new AtomicLong();

    public e(j producerSequenceFactory, Set<com.MCWorld.image.pipeline.listener.c> requestListeners, Supplier<Boolean> isPrefetchEnabledSupplier, com.MCWorld.image.base.imagepipeline.cache.e<b, com.MCWorld.image.base.imagepipeline.image.b> bitmapMemoryCache, com.MCWorld.image.base.imagepipeline.cache.e<b, PooledByteBuffer> encodedMemoryCache, c mainBufferedDiskCache, c smallImageBufferedDiskCache, d cacheKeyFactory, aw threadHandoffProducerQueue, Supplier<Boolean> suppressBitmapPrefetchingSupplier) {
        this.Fg = producerSequenceFactory;
        this.Fh = new com.MCWorld.image.pipeline.listener.b(requestListeners);
    ...
    @Deprecated
    public Supplier<com.MCWorld.image.core.datasource.c<a<com.MCWorld.image.base.imagepipeline.image.b>>> a(ImageRequest imageRequest, Object callerContext, boolean bitmapCacheOnly) {
        return a(imageRequest, callerContext, bitmapCacheOnly ? RequestLevel.BITMAP_MEMORY_CACHE : RequestLevel.FULL_FETCH);
    }

    public Supplier<com.MCWorld.image.core.datasource.c<a<com.MCWorld.image.base.imagepipeline.image.b>>> a(ImageRequest imageRequest, Object callerContext, RequestLevel requestLevel) {
        return new 1(this, imageRequest, callerContext, requestLevel);
    }

    public Supplier<com.MCWorld.image.core.datasource.c<a<PooledByteBuffer>>> d(ImageRequest imageRequest, Object callerContext) {
        return new 2(this, imageRequest, callerContext);
    }

    public com.MCWorld.image.core.datasource.c<a<com.MCWorld.image.base.imagepipeline.image.b>> e(ImageRequest imageRequest, Object callerContext) {
        return b(imageRequest, callerContext, RequestLevel.BITMAP_MEMORY_CACHE);
    }

    public com.MCWorld.image.core.datasource.c<a<com.MCWorld.image.base.imagepipeline.image.b>> f(ImageRequest imageRequest, Object callerContext) {
        return b(imageRequest, callerContext, RequestLevel.FULL_FETCH);
    }

    public com.MCWorld.image.core.datasource.c<a<com.MCWorld.image.base.imagepipeline.image.b>> b(ImageRequest imageRequest, Object callerContext, RequestLevel lowestPermittedRequestLevelOnSubmit) {
        try {
            return a(this.Fg.i(imageRequest), imageRequest, lowestPermittedRequestLevelOnSubmit, callerContext);
        } catch (Exception exception) {
            return com.MCWorld.image.core.datasource.d.d(exception);
        }
    }

    public com.MCWorld.image.core.datasource.c<a<PooledByteBuffer>> g(ImageRequest imageRequest, Object callerContext) {
    ...
    public com.MCWorld.image.core.datasource.c<Void> h(ImageRequest imageRequest, Object callerContext) {
        if (!((Boolean) this.Fi.get()).booleanValue()) {
            return com.MCWorld.image.core.datasource.d.d(Ff);
        }
        try {
    ...
    public com.MCWorld.image.core.datasource.c<Void> i(ImageRequest imageRequest, Object callerContext) {
        return a(imageRequest, callerContext, Priority.MEDIUM);
    }

    public com.MCWorld.image.core.datasource.c<Void> a(ImageRequest imageRequest, Object callerContext, Priority priority) {
        if (!((Boolean) this.Fi.get()).booleanValue()) {
            return com.MCWorld.image.core.datasource.d.d(Ff);
        }
        try {
    ...
    public com.MCWorld.image.base.imagepipeline.cache.e<b, com.MCWorld.image.base.imagepipeline.image.b> lM() {
        return this.Fj;
    }
    ...
    public com.MCWorld.image.core.datasource.c<Boolean> q(Uri uri) {
        return d(ImageRequest.v(uri));
    }

    public com.MCWorld.image.core.datasource.c<Boolean> d(ImageRequest imageRequest) {
        b cacheKey = this.EY.c(imageRequest, null);
    ...
    private <T> com.MCWorld.image.core.datasource.c<a<T>> a(am<a<T>> producerSequence, ImageRequest imageRequest, RequestLevel lowestPermittedRequestLevelOnSubmit, Object callerContext) {
        boolean z = false;
        com.MCWorld.image.pipeline.listener.c requestListener = e(imageRequest);
        try {
            ...
            return com.MCWorld.image.pipeline.datasource.d.a(producerSequence, new at(imageRequest, lJ, requestListener, callerContext, lowestPermittedRequestLevel, false, z, imageRequest.oE()), requestListener);
        } catch (Exception exception) {
            return com.MCWorld.image.core.datasource.d.d(exception);
        }
    }

    private com.MCWorld.image.core.datasource.c<Void> a(am<Void> producerSequence, ImageRequest imageRequest, RequestLevel lowestPermittedRequestLevelOnSubmit, Object callerContext, Priority priority) {
        com.MCWorld.image.pipeline.listener.c requestListener = e(imageRequest);
        try {
            return com.MCWorld.image.pipeline.datasource.f.a(producerSequence, new at(imageRequest, lJ(), requestListener, callerContext, RequestLevel.getMax(imageRequest.oC(), lowestPermittedRequestLevelOnSubmit), true, false, priority), requestListener);
        } catch (Exception exception) {
            return com.MCWorld.image.core.datasource.d.d(exception);
        }
    }

    private com.MCWorld.image.pipeline.listener.c e(ImageRequest imageRequest) {
        if (imageRequest.pI() == null) {
            return this.Fh;
        }
        return new com.MCWorld.image.pipeline.listener.b(new com.MCWorld.image.pipeline.listener.c[]{this.Fh, imageRequest.pI()});
    }
