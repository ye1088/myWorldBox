...
import com.MCWorld.image.core.common.time.RealtimeSinceBootClock;
...
public class b implements com.MCWorld.image.base.cache.common.b {
    ...
    private final a Ex;
    @Nullable
    private final com.MCWorld.image.base.cache.common.b Ey;
    @Nullable
    private final String Ez;
    private final Object ty;

    public b(String sourceString, @Nullable c resizeOptions, d rotationOptions, a imageDecodeOptions, @Nullable com.MCWorld.image.base.cache.common.b postprocessorCacheKey, @Nullable String postprocessorName, Object callerContext) {
        ...
        this.EA = com.MCWorld.image.core.common.util.a.a(Integer.valueOf(sourceString.hashCode()), Integer.valueOf(resizeOptions != null ? resizeOptions.hashCode() : 0), Integer.valueOf(rotationOptions.hashCode()), this.Ex, this.Ey, (Object) postprocessorName);
