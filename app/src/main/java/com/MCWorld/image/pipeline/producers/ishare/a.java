...
public class a implements am<com.MCWorld.image.core.common.references.a<b>> {
    ...
    public void b(j<com.MCWorld.image.core.common.references.a<b>> consumer, ao producerContext) {
        ...
        final StatefulProducerRunnable cancellableProducerRunnable = new StatefulProducerRunnable<com.MCWorld.image.core.common.references.a<b>>(this, consumer, listener, Ji, requestId) {
            final /* synthetic */ a Mi;

            protected /* synthetic */ Map M(Object obj) {
                return j((com.MCWorld.image.core.common.references.a) obj);
            }
            ...
            protected /* synthetic */ void p(Object obj) {
                k((com.MCWorld.image.core.common.references.a) obj);
            }

            protected com.MCWorld.image.core.common.references.a<b> nt() throws Exception {
                ...
                return com.MCWorld.image.core.common.references.a.b(new c(thumbnailBitmap, com.MCWorld.image.base.imagepipeline.bitmaps.b.hf(), f.wZ, 0));
            }

            protected Map<String, String> j(com.MCWorld.image.core.common.references.a<b> result) {
                return ImmutableMap.of(a.Kl, String.valueOf(result != null));
            }

            protected void k(com.MCWorld.image.core.common.references.a<b> result) {
