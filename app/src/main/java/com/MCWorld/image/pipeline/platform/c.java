...
public class c extends b {
    ...
    public c(com.MCWorld.image.pipeline.memory.c tracker) {
        super(tracker);
    }
    ...
    private static MemoryFile a(a<PooledByteBuffer> bytesRef, int inputLength, @Nullable byte[] suffix) throws IOException {
        ...
        try {
            ...
            try {
                InputStream is2 = new com.MCWorld.image.core.common.streams.a(pbbIs2, inputLength);
                try {
    ...
    protected Bitmap a(a<PooledByteBuffer> bytesRef, int inputLength, byte[] suffix, Options options) {
        ...
        try {
            ...
            Bitmap bitmap = (Bitmap) Preconditions.checkNotNull(com.MCWorld.image.core.common.webp.c.zd.decodeFileDescriptor(a(memoryFile), null, options), "BitmapFactory returned null");
            if (memoryFile != null) {
                memoryFile.close();
            }
            return bitmap;
