...
import com.MCWorld.image.pipeline.request.c$b;
...
public class ac implements am<d> {
    ...
    class a extends m<d, d> {
        ...
        private void j(d newResult) {
            ...
            com.MCWorld.image.pipeline.request.c mediaVariations = imageRequest.pw();
    ...
    public ac(c defaultBufferedDiskCache, c smallImageBufferedDiskCache, com.MCWorld.image.pipeline.cache.d cacheKeyFactory, ad mediaVariationsIndex, am<d> inputProducer) {
    ...
    public void b(j<d> consumer, ao producerContext) {
        ...
        com.MCWorld.image.base.imagepipeline.common.c resizeOptions = imageRequest.pz();
        com.MCWorld.image.pipeline.request.c mediaVariations = imageRequest.pw();
        ...
        if (mediaVariations.pN() != null) {
            ...
            final com.MCWorld.image.pipeline.request.c cVar = mediaVariations;
            final ImageRequest imageRequest2 = imageRequest;
            final com.MCWorld.image.base.imagepipeline.common.c cVar2 = resizeOptions;
    ...
    private h a(j<d> consumer, ao producerContext, com.MCWorld.image.pipeline.request.c mediaVariations, List<c$b> variants, ImageRequest imageRequest, com.MCWorld.image.base.imagepipeline.common.c resizeOptions, AtomicBoolean isCancelled) {
        h<d> diskLookupTask;
    ...
    private static boolean a(c$b variant, com.MCWorld.image.base.imagepipeline.common.c resizeOptions) {
        return variant.getWidth() >= resizeOptions.width && variant.getHeight() >= resizeOptions.height;
    }

    private static boolean a(c$b variant, c$b comparison, com.MCWorld.image.base.imagepipeline.common.c resizeOptions) {
        if (comparison == null) {
            return true;
        }
