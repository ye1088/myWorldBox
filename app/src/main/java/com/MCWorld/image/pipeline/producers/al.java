...
import com.MCWorld.image.pipeline.request.e;
...
public class al implements am<a<b>> {
    ...
    private final com.MCWorld.image.base.imagepipeline.bitmaps.a Ld;
    ...
    public al(am<a<b>> inputProducer, com.MCWorld.image.base.imagepipeline.bitmaps.a platformBitmapFactory, Executor executor) {
