...
public abstract class c extends b<List<a<com.MCWorld.image.base.imagepipeline.image.b>>> {
    protected abstract void o(List<Bitmap> list);

    public void onNewResultImpl(com.MCWorld.image.core.datasource.c<java.util.List<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>>> r7) {
