...
public class ImageRequestBuilder {
    ...
    @Nullable
    private com.MCWorld.image.pipeline.listener.c Fh;
    ...
    public static ImageRequestBuilder cO(int resId) {
        return w(com.MCWorld.image.core.common.util.f.by(resId));
    }
    ...
    public boolean pF() {
        return this.Mt && com.MCWorld.image.core.common.util.f.isNetworkUri(this.Mn);
    }
    ...
    public ImageRequestBuilder a(com.MCWorld.image.pipeline.listener.c requestListener) {
    ...
    protected void validate() {
        ...
        if (com.MCWorld.image.core.common.util.f.isLocalResourceUri(this.Mn)) {
        ...
        if (com.MCWorld.image.core.common.util.f.isLocalAssetUri(this.Mn) && !this.Mn.isAbsolute()) {
