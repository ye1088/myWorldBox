...
import com.MCWorld.image.pipeline.nativecode.JpegTranscoder;
...
public class as implements am<d> {
    ...
    private class a extends m<d, d> {
        ...
        public a(final as asVar, final j<d> consumer, ao producerContext) {
            ...
            this.JB = new JobScheduler(asVar.mExecutor, new com.MCWorld.image.pipeline.producers.JobScheduler.a(this) {
        ...
        private void g(d encodedImage, boolean isLast) {
            ...
            try {
                ...
                com.MCWorld.image.core.common.references.a<PooledByteBuffer> ref = com.MCWorld.image.core.common.references.a.b(outputStream.ih());
                try {
                    d ret = new d(ref);
                    d dVar;
                    try {
    ...
    public as(Executor executor, com.MCWorld.image.base.imagepipeline.memory.d pooledByteBufferFactory, boolean resizingEnabled, am<d> inputProducer) {
    ...
    private static TriState a(ImageRequest request, d encodedImage, boolean resizingEnabled) {
        if (encodedImage == null || encodedImage.hT() == com.MCWorld.image.base.imageformat.d.vz) {
    ...
    private static int a(com.MCWorld.image.base.imagepipeline.common.d rotationOptions, d encodedImage) {
    ...
    private static boolean b(com.MCWorld.image.base.imagepipeline.common.d rotationOptions, d encodedImage) {
