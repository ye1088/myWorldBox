...
import com.MCWorld.image.pipeline.decoder.d;
import com.MCWorld.image.pipeline.decoder.e;
...
public class l implements am<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> {
    ...
    private final com.MCWorld.image.pipeline.decoder.b FA;
    private final d FG;
    private final boolean FY;
    private final boolean Fw;
    private final am<com.MCWorld.image.base.imagepipeline.image.d> IY;
    private final boolean Jx;
    private final Executor mExecutor;
    private final com.MCWorld.image.base.imagepipeline.memory.a xl;

    /* compiled from: DecodeProducer */
    private abstract class c extends m<com.MCWorld.image.base.imagepipeline.image.d, com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> {
        private final com.MCWorld.image.base.imagepipeline.common.a Ex;
        @GuardedBy("this")
        ...
        protected abstract int g(com.MCWorld.image.base.imagepipeline.image.d dVar);

        protected abstract g hN();

        public /* synthetic */ void d(Object obj, boolean z) {
            a((com.MCWorld.image.base.imagepipeline.image.d) obj, z);
        }

        public c(final l lVar, j<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> consumer, final ao producerContext, final boolean decodeCancellationEnabled) {
            this.Jy = lVar;
            super(consumer);
            this.Jn = producerContext;
            this.Jb = producerContext.oB();
            this.Ex = producerContext.oA().pC();
            this.JB = new JobScheduler(lVar.mExecutor, new com.MCWorld.image.pipeline.producers.JobScheduler.a(this) {
                final /* synthetic */ c JE;

                public void d(com.MCWorld.image.base.imagepipeline.image.d encodedImage, boolean isLast) {
        ...
        public void a(com.MCWorld.image.base.imagepipeline.image.d newResult, boolean isLast) {
            if (isLast && !com.MCWorld.image.base.imagepipeline.image.d.e(newResult)) {
        ...
        protected boolean b(com.MCWorld.image.base.imagepipeline.image.d ref, boolean isLast) {
            return this.JB.e(ref, isLast);
        }

        private void c(com.MCWorld.image.base.imagepipeline.image.d encodedImage, boolean isLast) {
            if (!isFinished() && com.MCWorld.image.base.imagepipeline.image.d.e(encodedImage)) {
                ...
                com.MCWorld.image.base.imagepipeline.common.c resizeOptions = this.Jn.oA().pz();
                ...
                long queueTime;
                g quality;
                com.MCWorld.image.base.imagepipeline.image.b image;
                try {
                    queueTime = this.JB.oU();
                    int length = isLast ? encodedImage.getSize() : g(encodedImage);
                    quality = isLast ? com.MCWorld.image.base.imagepipeline.image.f.wZ : hN();
        ...
        private Map<String, String> a(@Nullable com.MCWorld.image.base.imagepipeline.image.b image, long queueTime, g quality, boolean isFinal, String imageFormatName, String encodedImageSize, String requestImageSize, String sampleSize) {
            ...
            if (image instanceof com.MCWorld.image.base.imagepipeline.image.c) {
                Bitmap bitmap = ((com.MCWorld.image.base.imagepipeline.image.c) image).hM();
        ...
        private void a(com.MCWorld.image.base.imagepipeline.image.b decodedImage, boolean isFinal) {
            com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b> decodedImageRef = com.MCWorld.image.core.common.references.a.b(decodedImage);
            try {
                aq(isFinal);
                oM().e(decodedImageRef, isFinal);
            } finally {
                com.MCWorld.image.core.common.references.a.c(decodedImageRef);
            }
        }
    ...
    private class a extends c {
        ...
        public a(l lVar, j<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> consumer, ao producerContext, boolean decodeCancellationEnabled) {
            this.Jy = lVar;
            super(lVar, consumer, producerContext, decodeCancellationEnabled);
        }

        protected synchronized boolean b(com.MCWorld.image.base.imagepipeline.image.d encodedImage, boolean isLast) {
            boolean b;
            if (isLast) {
        ...
        protected int g(com.MCWorld.image.base.imagepipeline.image.d encodedImage) {
            return encodedImage.getSize();
        }

        protected g hN() {
            return com.MCWorld.image.base.imagepipeline.image.f.a(0, false, false);
        }
    }
    ...
    private class b extends c {
        ...
        public b(l lVar, j<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> consumer, ao producerContext, e progressiveJpegParser, d progressiveJpegConfig, boolean decodeCancellationEnabled) {
            this.Jy = lVar;
            super(lVar, consumer, producerContext, decodeCancellationEnabled);
        ...
        protected synchronized boolean b(com.MCWorld.image.base.imagepipeline.image.d encodedImage, boolean isLast) {
            ...
            if (!isLast && com.MCWorld.image.base.imagepipeline.image.d.e(encodedImage)) {
    ...
    public l(com.MCWorld.image.base.imagepipeline.memory.a byteArrayPool, Executor executor, com.MCWorld.image.pipeline.decoder.b imageDecoder, d progressiveJpegConfig, boolean downsampleEnabled, boolean downsampleEnabledForNetwork, boolean decodeCancellationEnabled, am<com.MCWorld.image.base.imagepipeline.image.d> inputProducer) {
        this.xl = (com.MCWorld.image.base.imagepipeline.memory.a) Preconditions.checkNotNull(byteArrayPool);
        this.mExecutor = (Executor) Preconditions.checkNotNull(executor);
        this.FA = (com.MCWorld.image.pipeline.decoder.b) Preconditions.checkNotNull(imageDecoder);
        this.FG = (d) Preconditions.checkNotNull(progressiveJpegConfig);
    ...
    public void b(j<com.MCWorld.image.core.common.references.a<com.MCWorld.image.base.imagepipeline.image.b>> consumer, ao producerContext) {
