...
public class a {
    ...
    public synchronized boolean f(Bitmap bitmap) {
        boolean z;
        int bitmapSize = com.MCWorld.image.base.imageutils.a.d(bitmap);
    ...
    public List<com.MCWorld.image.core.common.references.a<Bitmap>> p(List<Bitmap> bitmaps) {
        Bitmap bitmap;
        ...
        List<com.MCWorld.image.core.common.references.a<Bitmap>> ret = new ArrayList(bitmaps.size());
        for (Bitmap bitmap22 : bitmaps) {
            ret.add(com.MCWorld.image.core.common.references.a.a(bitmap22, this.Hx));
        }
        return ret;
    }
}
