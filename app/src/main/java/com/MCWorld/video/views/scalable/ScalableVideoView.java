package com.MCWorld.video.views.scalable;
...
import com.MCWorld.video.views.StateMediaPlayer;
import com.MCWorld.video.views.StateMediaPlayer.State;
import java.io.FileDescriptor;
import java.io.IOException;
import java.util.Map;

@TargetApi(14)
public class ScalableVideoView extends TextureView implements OnCompletionListener, OnSeekCompleteListener, OnVideoSizeChangedListener, SurfaceTextureListener, com.MCWorld.video.views.a {
    private static final String TAG = "ScalableVideoView";
    protected StateMediaPlayer bqE;
    protected ScalableType bqF;
    private com.MCWorld.video.views.a.a bqG;
    ...
    public void setSurfaceTextureUpdatedListener(com.MCWorld.video.views.a.a surfaceTextureUpdatedListener) {
