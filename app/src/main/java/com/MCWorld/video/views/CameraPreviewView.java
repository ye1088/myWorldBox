...
public class CameraPreviewView extends FrameLayout {
    ...
    private class RealCameraPreviewView extends SurfaceView implements AutoFocusCallback, Callback {
        ...
        public void onAutoFocus(boolean success, Camera camera) {
            ...
            com.MCWorld.video.camera.a.a("continuous-video", this.bpT);
        }
        ...
        private void c(float x, float y) {
            ...
            com.MCWorld.video.camera.a.a(EmailTask.AUTO, this.bpT);
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
            ...
            if (holder.getSurface() != null) {
                ...
                Parameters parameters = CameraPreviewView.b(this.bpT);
                if (parameters != null) {
                    Size size = com.MCWorld.video.camera.a.a(parameters.getSupportedPreviewSizes(), Math.min(w, h));
    ...
    public CameraPreviewView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.bpZ = AnimationUtils.loadAnimation(context, com.MCWorld.video.b.a.indicator_animation);
        ...
        this.bpX = AnimationUtils.loadAnimation(context, com.MCWorld.video.b.a.focus_animation);
    ...
    public void a(Camera camera, int cameraId) {
        this.bpT = camera;
        this.bpU = cameraId;
        com.MCWorld.video.camera.a.a((Activity) getContext(), this.bpU, this.bpT);
        if (this.bqa != null) {
            removeView(this.bqa);
        }
