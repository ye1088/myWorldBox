...
import com.MCWorld.utils.d;
import com.MCWorld.video.views.CameraPreviewView;
...
public class b implements PreviewCallback, com.MCWorld.video.views.CameraPreviewView.a {
    ...
    private void Ne() {
        if (TextUtils.isEmpty(this.bpJ)) {
            ...
            int cropX;
            int cropY;
            if (com.MCWorld.video.camera.a.lB(this.bpH.getCameraId())) {
