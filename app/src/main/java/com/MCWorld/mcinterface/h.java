...
import com.MCWorld.mcfb.a;
import com.MCWorld.mcfb.b;
import com.MCWorld.mcfb.c;
import com.MCWorld.mcfb.d;
import com.MCWorld.mcgame.ab;
import com.MCWorld.mcgame.ad;
import com.MCWorld.mcgame.ae;
import com.MCWorld.mcgame.g;
import com.MCWorld.mcgame.k;
import com.MCWorld.mcgame.l;
import com.MCWorld.mcgame.m;
import com.MCWorld.mcgame.n;
import com.MCWorld.mcgame.options.DTGameOptions;
import com.MCWorld.mcgame.p;
import com.MCWorld.mcgame.r;
import com.MCWorld.mcgame.t;
import com.MCWorld.mcgame.u;
import com.MCWorld.mcgame.v;
import com.MCWorld.mcgame.w;
import com.MCWorld.mcgame.x;
import com.MCWorld.mcgame.y;
...
public class h {
    ...
    public static void t(Context in_context, String in_soPath) {
        ...
        com.MCWorld.mcso.a.init(in_context);
        com.MCWorld.mcso.a.load(in_soPath);
    }

    public static void m(byte[] inputByteArray, int inputDecodeLen) {
        com.MCWorld.mcso.a.n(inputByteArray, inputDecodeLen);
    }
    ...
    public static int zr() {
        if (com.MCWorld.mcsdk.dtlib.h.CW().CX() == 0 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 1) {
            return 16;
        }
        if (com.MCWorld.mcsdk.dtlib.h.CW().CX() == 2 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 3) {
            return 26;
        }
        if (com.MCWorld.mcsdk.dtlib.h.CW().CX() == 5) {
            return 27;
        }
    ...
    public static void ho(int val) {
        com.MCWorld.mcgame.options.a.hh(val);
    }
    ...
    public static int zw() {
        return com.MCWorld.mcsdk.dtlib.h.CW().CZ();
    }

    public static void hp(int inputVal) {
        com.MCWorld.mcsdk.dtlib.h.CW().iH(inputVal);
    }

    public static int zx() {
        return com.MCWorld.mcsdk.dtlib.h.CW().CX();
    }

    public static void hq(int mode) {
        com.MCWorld.mcsdk.dtlib.h.CW().iF(mode);
    }
    ...
    public static void hr(int speed) {
        ...
        } else if (com.MCWorld.mcsdk.dtlib.h.CW().CX() == 2 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 3 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 5 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 7) {
            if (speed == 0) {
                ae.gX(0);
            } else {
                ae.gX(1);
    ...
    public static void e(int mode, int x, int y, int z) {
        if (com.MCWorld.mcsdk.dtlib.h.CW().CX() != 1 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 2 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 3 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 5 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 7) {
            return;
        }
        if (x != 0 || y != 0 || z != 0) {
    ...
    public static ArrayList<c> zA() {
        return com.MCWorld.mcjsmanager.b.zA();
    }

    public static int zB() {
        return com.MCWorld.mcjsmanager.b.AB();
    }
    ...
    public static void A(String filePath, String so_path) {
        com.MCWorld.mcgame.h.wo().s(filePath, so_path);
    }

    public static boolean cY(String path) {
        return com.MCWorld.mcgame.h.wo().cH(path);
    }

    public static boolean cZ(String fileName) {
        return com.MCWorld.mcgame.h.cI(fileName);
    }
    ...
    public static void dc(String pJsFullPathName) {
        g.aX(true);
        com.MCWorld.mcjavascript.d.a(pJsFullPathName, 0, 0, 0);
    }

    public static void zE() {
        com.MCWorld.mcjsmanager.c.init();
    }
    ...
    public static void vj() {
        com.MCWorld.mcgame.d.vj();
    }

    public static int[] va() {
        return com.MCWorld.mcgame.b.va();
    }

    public static boolean c(int[] array) {
        return com.MCWorld.mcgame.b.c(array);
    }

    public static boolean z(List<c> list) {
        return com.MCWorld.mcgame.d.z(list);
    }

    public static boolean A(List<c> list) {
        return com.MCWorld.mcgame.d.A(list);
    }

    public static boolean R(int bagIndex, int itemCnt) {
        com.MCWorld.mcsdk.c.Ce();
        return com.MCWorld.mcgame.d.H(bagIndex, itemCnt);
    }

    public static boolean d(int in_ItemId, int in_ItemDmg, int in_ItemCnt, int[] enchantAttr, int[] enchantLevel) {
        return com.MCWorld.mcgame.d.b(in_ItemId, in_ItemDmg, in_ItemCnt, enchantAttr, enchantLevel);
    }

    public static boolean w(int id, int count, int gameBagIndex) {
        return com.MCWorld.mcgame.d.r(id, count, gameBagIndex);
    }

    public static boolean f(Set<Integer> bagIndexSet) {
        return com.MCWorld.mcgame.d.d(bagIndexSet);
    }

    public static boolean F(List<c> list) {
        return com.MCWorld.mcgame.d.x(list);
    }

    public static boolean x(int id, int count, int dmg) {
        com.MCWorld.mcsdk.c.Cf();
        return com.MCWorld.mcgame.d.p(id, count, dmg);
    }
    ...
    public static void e(boolean bEnable, boolean bUpdate) {
        com.MCWorld.mcgame.perspective.a.e(bEnable, bUpdate);
    }

    public static void c(String path, boolean bEnable) {
        com.MCWorld.mcjavascript.d.b(path, 0, bEnable);
        com.MCWorld.mcsdk.c.Ch();
    }

    public static void bS(boolean bEnable) {
        com.MCWorld.mcjavascript.d.c(3, 1, bEnable);
    }

    public static void bT(boolean bEnable) {
        com.MCWorld.mcjavascript.d.c(1, 1, bEnable);
    }

    public static void bU(boolean bEnable) {
        if (com.MCWorld.mcsdk.dtlib.h.CW().CX() == 2 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 3 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 5 || com.MCWorld.mcsdk.dtlib.h.CW().CX() == 7) {
            mcspirit.xx(bEnable);
        }
    }
