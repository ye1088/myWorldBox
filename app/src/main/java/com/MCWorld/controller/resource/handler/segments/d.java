...
import com.MCWorld.controller.resource.action.b;
...
import com.MCWorld.framework.base.http.io.impl.request.Range;
...
import com.MCWorld.framework.base.http.toolbox.error.SegmentError;
...
public class d implements b {
    ...
    private void a(final a download, final List<ResTaskInfo$b> retryUrls) {
        if (this.mE.get() != null) {
            ...
            SegmentRequestBuilder builder = com.MCWorld.controller.resource.http.a.dX().getSegmentReqBuilder(download.id, download.oq.url, info.dir, info.filename);
    ...
    private boolean a(ResTaskInfo$b downloadingUrl, final List<ResTaskInfo$b> retryUrls, long start, long end, long length, ProgressListener progressListener) {
        ...
        SegmentRequestBuilder builder = com.MCWorld.controller.resource.http.a.dX().getSegmentReqBuilder(id, downloadingUrl.url, info.dir, info.filename);
    ...
    public boolean pause() {
        ...
        this.oi = true;
        if (this.oe != null) {
            return com.MCWorld.controller.resource.http.a.dX().pauseDownloadRequest(this.oe.oq.url);
        }
        return false;
    }
