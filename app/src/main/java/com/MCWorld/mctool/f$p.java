...
public final class f$p {
    ...
    public static final int[] FlipperView = new int[]{R.attr.inAnimatorRes, R.attr.outAnimatorRes, R.attr.animationInterval};
    public static final int FlipperView_animationInterval = 2;
    public static final int FlipperView_inAnimatorRes = 0;
    public static final int FlipperView_outAnimatorRes = 1;
