...
public class OptionsV010 extends Options implements Serializable {
    ...
    public void setGfx_pixeldensity(Float paramFloat) {
        this.gfx_pixeldensity = paramFloat;
    }

    public void setGfx_renderdistance(Integer paramInteger) {
        this.gfx_renderdistance = paramInteger;
    }
