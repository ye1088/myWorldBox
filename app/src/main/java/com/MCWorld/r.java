...
public class r {
    ...
    public void dt() {
        ...
        if (packName.equals(com.MCWorld.mctool.a.APPLICATION_ID)) {
            strBootType = "boot_mc";
        }
        ...
        if (!g.w(strTypeName)) {
            ...
            if (!UtilsFunction.empty((Collection) appList)) {
                ...
                for (ApplicationInfo appinfo : appList) {
                    if (!((appinfo.flags & 1) > 0 || strSelfPackname.equals(appinfo.processName) || "com.huati".equals(appinfo.processName) || "com.huluxia.gametools".equals(appinfo.processName) || com.MCWorld.mctool.a.APPLICATION_ID.equals(appinfo.processName))) {
