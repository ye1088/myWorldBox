...
import com.MCWorld.mcgame.s;
import com.MCWorld.mcgame.x;
import com.MCWorld.mcinterface.k;
import com.MCWorld.mcjavascript.DTNativeEntityApi;
import com.MCWorld.mcjavascript.DTNativePlayerApi;
...
public class b {
    ...
    public static void eatCallback(int paramInt, float paramFloat) {
        ...
        com.MCWorld.mcinterface.h.zM().e(paramInt, paramFloat);
    }
    ...
    public static void eee(boolean paramBoolean) {
        try {
            g.gm(0);
            h.iJ(200);
            com.MCWorld.mcinterface.h.zM().cg(g.getWorldName());
        } catch (Exception e) {
        }
    }
    ...
    public static void useItemOnCallback(int inputX, int inputY, int inputZ, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8) {
        ...
        if (paramInt4 != 0) {
            ...
            com.MCWorld.mcinterface.h.zM().b(paramInt4, paramInt7, inputX, inputY, inputZ);
            com.MCWorld.mcinterface.h.zM().fA(1);
        }
    }
    ...
    public static void attackCallback(long attacker, long victim) {
        ...
        com.MCWorld.mcinterface.h.zM().S(DTSDKManagerEx.ai(attacker), DTSDKManagerEx.ai(victim));
    }

    public static void bbb(long paramLong1, long paramLong2) {
        x.gT(com.MCWorld.mcinterface.h.zo());
        x.gS(0);
        s.bt(true);
        com.MCWorld.mcinterface.h.zM().se();
        com.MCWorld.mcinterface.h.zM().fy(1);
    }
    ...
    public static void mobDieCallback(long paramLong1, long paramLong2) {
        if (h.CW().CX() == 3 || h.CW().CX() == 5 || h.CW().CX() == 7) {
            try {
                if (paramLong1 == DTSDKManagerEx.Cq() && paramLong2 != DTSDKManagerEx.Cq() && (g.wm() == 1 || g.wm() == 2 || g.wm() == 3 || g.wm() == 4)) {
                    ...
                    com.MCWorld.mcfb.d.qq();
                    com.MCWorld.mcfb.d.cW(nTmpId);
                }
            } catch (Exception e) {
            }
        }
        if (DTSDKManagerEx.Cq() == paramLong2) {
            ...
            com.MCWorld.mcinterface.h.zM().fx(DTSDKManagerEx.ai(paramLong2));
        }
    ...
    public static void destroyBlockCallback(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        com.MCWorld.mcinterface.h.zM().c(blockId, dmg, paramInt1, paramInt2, paramInt3);
        com.MCWorld.mcinterface.h.zM().fz(1);
    }
