...
public class c {
    ...
    public static void init() {
        try {
            ...
            com.MCWorld.mcso.a.load(com.MCWorld.mcgame.h.wo().ws());
            a.ds(false);
        } catch (UnsatisfiedLinkError e) {
            com.MCWorld.mcsdk.log.a.info(com.MCWorld.mcsdk.log.a.aoP, "System.loadLibrary Unsatisfied Link error: " + e.toString(), new Object[0]);
            a.ds(true);
        } catch (Exception e2) {
            com.MCWorld.mcsdk.log.a.verbose(com.MCWorld.mcsdk.log.a.aoP, "DTPrint is " + e2, new Object[0]);
            a.ds(true);
        }
    }
