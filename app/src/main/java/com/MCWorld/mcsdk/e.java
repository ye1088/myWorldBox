...
import com.MCWorld.mcgame.b;
import com.MCWorld.mcgame.d;
    ...
    public static void CH() {
        if (DTGameOptions.isbOpenFloatWindow()) {
            ...
            if (curTimeMillis > CA() + anX) {
                ...
                if (g.wf() > 0 && g.vW() != 0 && g.wc() == 1 && g.wd() == 0) {
                    ...
                    if (h.CW().CX() == 3 || h.CW().CX() == 5) {
                        com.MCWorld.mcfb.a.qf().qj();
                    }
                    if (h.CW().CX() == 5 || h.CW().CX() == 7) {
                        com.MCWorld.mcgame.perspective.a.zd();
                    }
                }
            }
            if (curTimeMillis > rY() + UM) {
            ...
            if (curTimeMillis > CD() + 30000) {
                aB(curTimeMillis);
                com.MCWorld.mcinterface.h.zM().fw(30);
            }
        }
    }
        ...
        if (g.wc() == 0) {
            try {
                if (g.vW() == 1) {
                    ...
                    m.wH();
                    g.gm(1);
                    com.MCWorld.mcinterface.h.zM().cd(g.getWorldName());
                    g.gn(0);
                    g.gr(0);
                } else {
                    g.go(2);
                    ...
                    s.bt(false);
                    d.vi();
                    com.MCWorld.mcinterface.h.zM().sd();
                    g.gn(1);
                }
                g.gm(1);
            } catch (Exception e) {
        ...
        if (g.wc() == 0) {
            try {
                if (g.vW() == 1) {
                    ...
                    ae.gX(0);
                    int nSetBloodVal = 0;
                    if (com.MCWorld.mcinterface.h.zx() == 0) {
                        nSetBloodVal = DTSDKManagerEx.io(DTSDKManagerEx.Cp());
                    } else if (com.MCWorld.mcinterface.h.zx() == 1 || h.CW().CX() == 2) {
                ...
                if (h.CW().CX() == 1) {
                    com.MCWorld.mcinterface.h.bQ(true);
                }
                g.gm(1);
            } catch (Exception e) {
                g.gm(0);
