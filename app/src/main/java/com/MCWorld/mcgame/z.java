...
public class z implements h {
    ...
    public static InputStream cQ(String fileName) {
        try {
            ...
            if (com.MCWorld.mcsdk.dtlib.h.CW().CX() != 1 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 2 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 3 && com.MCWorld.mcsdk.dtlib.h.CW().CX() != 5) {
                return null;
            }
            File file;
    ...
    public InputStream cN(String fileName) {
        try {
            String tmpSkinPath = yr();
            if (com.MCWorld.mcsdk.dtlib.h.CW().CX() != 0 || tmpSkinPath == null || !fileName.equals("images/mob/char.png")) {
                return null;
            }
