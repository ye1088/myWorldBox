...
import com.MCWorld.mctool.PlayerArchieveDetailActivity;
import com.MCWorld.module.n;
import com.MCWorld.module.picture.b;
import com.MCWorld.module.profile.h;
import com.MCWorld.ui.area.news.NewsCommentListActivity;
import com.MCWorld.ui.area.news.NewsDetailActivity;
import com.MCWorld.ui.base.WapActivity;
import com.MCWorld.ui.base.a;
import com.MCWorld.ui.bbs.CategoryDarenActivity;
import com.MCWorld.ui.bbs.CategoryDetailActivity;
import com.MCWorld.ui.bbs.CategoryVoteActivity;
import com.MCWorld.ui.bbs.CommentTopicActivity;
import com.MCWorld.ui.bbs.CreditListActivity;
import com.MCWorld.ui.bbs.DarenRuleActivity;
import com.MCWorld.ui.bbs.JsTopicDetailActivity;
import com.MCWorld.ui.bbs.ModifyTopicActivity;
import com.MCWorld.ui.bbs.MoveTopicActivity;
import com.MCWorld.ui.bbs.PublishTopicActivity;
import com.MCWorld.ui.bbs.PublishTopicWishActivity;
import com.MCWorld.ui.bbs.ResTopicDetailActivity;
import com.MCWorld.ui.bbs.SkinTopicDetailActivity;
import com.MCWorld.ui.bbs.TopicDetailActivity;
import com.MCWorld.ui.bbs.TopicListDrawerActivity;
import com.MCWorld.ui.bbs.TopicSearchActivity;
import com.MCWorld.ui.bbs.WoodTopicDetailActivity;
import com.MCWorld.ui.bbs.addzone.ChooseZoneActivity;
import com.MCWorld.ui.discovery.CardGameActivity;
import com.MCWorld.ui.discovery.MsgSettingsActivity;
import com.MCWorld.ui.discovery.SettingsActivity;
import com.MCWorld.ui.loginAndRegister.ForgetPasswordActivity;
import com.MCWorld.ui.loginAndRegister.LoginActivity;
import com.MCWorld.ui.loginAndRegister.PolicyActivity;
import com.MCWorld.ui.loginAndRegister.RegisterActivity;
import com.MCWorld.ui.loginAndRegister.RegisterByMiActivity;
import com.MCWorld.ui.other.FeedbackActivity;
import com.MCWorld.ui.picture.PhotoViewerActivity;
import com.MCWorld.ui.picture.PictureChooserActivity;
import com.MCWorld.ui.picture.PictureCropActivity;
import com.MCWorld.ui.profile.AchieveActivity;
import com.MCWorld.ui.profile.FollowerListActivity;
import com.MCWorld.ui.profile.FollowingListActivity;
import com.MCWorld.ui.profile.FriendListActivity;
import com.MCWorld.ui.profile.MessageHistoryActivity;
import com.MCWorld.ui.profile.ProfileActivity;
import com.MCWorld.ui.profile.ProfileCommentListActivity;
import com.MCWorld.ui.profile.ProfileEditActivity;
import com.MCWorld.ui.profile.ProfileExchangeCenterActivity;
import com.MCWorld.ui.profile.ProfileExchangeDetailActivity;
import com.MCWorld.ui.profile.ProfileExchangeRecordActivity;
import com.MCWorld.ui.profile.ProfileExchangeSubmitActivity;
import com.MCWorld.ui.profile.ProfileFavorActivity;
import com.MCWorld.ui.profile.ProfileReadTopicListActivity;
import com.MCWorld.ui.profile.ProfileScoreActivity;
import com.MCWorld.ui.profile.ProfileTopicListActivity;
import com.MCWorld.ui.profile.SpaceStyleActivity;
import com.MCWorld.ui.profile.SpaceStyleDetailActivity;
import com.MCWorld.ui.profile.StudioAuditActivity;
import com.MCWorld.ui.profile.StudioEditActivity;
import com.MCWorld.ui.profile.UploadPhotoActivity;
import com.MCWorld.ui.profile.UserAlbumsActivity;
import com.MCWorld.utils.UtilsEnumBiz;
import com.MCWorld.utils.UtilsFile;
import com.MCWorld.widget.Constants;
import com.MCWorld.widget.x5web.BrowserActivity;
...
public class t {
    ...
    public static void a(Context context, com.MCWorld.data.map.f.a obj) {
        Intent in = new Intent();
        in.putExtra(r.gO, obj);
    ...
    public static void b(Context context, com.MCWorld.data.map.f.a obj) {
        Intent in = new Intent();
        in.putExtra(r.gO, obj);
    ...
    public static void c(Context context, com.MCWorld.data.map.f.a obj) {
        Intent in = new Intent();
        in.putExtra(r.gO, obj);
    ...
    public static void d(Context context, com.MCWorld.data.map.f.a obj) {
        Intent in = new Intent();
        in.putExtra(r.gO, obj);
    ...
    public static LoadingStatement dz() {
        ...
        if (d.isDayMode()) {
            ...
            statement.background = com.MCWorld.bbs.b.d.background_normal;
        } else {
            statement.generalImg = f.ic_loading_default;
            statement.background = com.MCWorld.bbs.b.d.color_split_dim_night;
        }
        return statement;
    }
    ...
    public static ReloadStatement dA() {
        ...
        if (d.isDayMode()) {
            ...
            statement.background = com.MCWorld.bbs.b.d.background_normal;
            statement.generalSubtitleColor = com.MCWorld.bbs.b.d.text_color_secondary;
        } else {
            statement.generalImg = f.ic_loading_failed_night;
            statement.background = com.MCWorld.bbs.b.d.color_split_dim_night;
            statement.generalSubtitleColor = com.MCWorld.bbs.b.d.text_color_secondary_night;
        }
        return statement;
    }
    ...
    public static void a(Context context, com.MCWorld.module.news.c item) {
        Intent in = new Intent();
    ...
    public static void b(Context context, com.MCWorld.module.news.c item) {
        Intent in = new Intent();
        in.putExtra("NEWS_ITEM", item);
