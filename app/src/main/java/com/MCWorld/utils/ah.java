...
public class ah {
    ...
    public String getToken() {
        return com.MCWorld.pref.b.Em().getString(blX);
    }

    public String fU(String email) {
        return com.MCWorld.pref.b.Em().getString(email + bma);
    }

    public void ai(String email, String openid) {
        com.MCWorld.pref.b.Em().putString(email + bma, openid);
    }

    public void setToken(String token) {
        com.MCWorld.pref.b.Em().putString(blX, token);
    }

    public void La() {
        com.MCWorld.pref.b.Em().remove(blX);
    }

    public void Lb() {
        com.MCWorld.pref.b.Em().remove(blW);
    }

    public void Lc() {
        com.MCWorld.pref.b.Em().remove(blY);
    }

    public void Ld() {
        com.MCWorld.pref.b.Em().remove(SESSION);
    }

    public void Le() {
        com.MCWorld.pref.b.Em().remove("loginmi");
    }

    public g ew() {
        String session = com.MCWorld.pref.b.Em().getString(blY);
    ...
    public void a(g info) {
        com.MCWorld.pref.b.Em().putString(blY, ag.toJsonString(info));
    }
    ...
    public void o(long uid, int status) {
        com.MCWorld.pref.b.Em().putLong(uid + "-checkstatus", (long) status);
    }

    public void p(long uid, int status) {
        com.MCWorld.pref.b.Em().putLong(uid + "-qinfostatus", (long) status);
    }

    public int g(String email, long uid) {
        return com.MCWorld.pref.b.Em().getInt(uid + "-qinfostatus", 0) | com.MCWorld.pref.b.Em().getInt(email + "-qinfostatus", 0);
    }
    ...
    public void li(int val) {
        com.MCWorld.pref.b.Em().putInt("TopicVideo", val);
    }

    public int Ln() {
        return com.MCWorld.pref.b.Em().getInt("TopicVideo", a.bmd);
    }

    public int Lo() {
        return com.MCWorld.pref.b.Em().getInt("themeMode", 0);
    }

    public void lj(int themeMode) {
        com.MCWorld.pref.b.Em().putInt("themeMode", themeMode);
    }

    public boolean Lp() {
        return com.MCWorld.pref.b.Em().getBoolean("firstBbsForum", true);
    }

    public void cY(boolean first) {
        com.MCWorld.pref.b.Em().putBoolean("firstBbsForum", first);
    }
    ...
    public void a(long uid, e msgRemind) {
        com.MCWorld.pref.b.Em().putString(uid + "MsgRemind", ag.toJsonString(msgRemind));
    }
    ...
    public void a(long uid, com.MCWorld.module.topic.g info) {
        com.MCWorld.pref.b.Em().put(uid + "createPower", ag.toJsonString(info));
    }

    public com.MCWorld.module.topic.g bu(long uid) {
        String str = com.MCWorld.pref.b.Em().getString(uid + "createPower");
        if (UtilsFunction.empty((CharSequence) str)) {
            return null;
        }
        com.MCWorld.module.topic.g info = null;
        try {
            return (com.MCWorld.module.topic.g) Json.parseJsonObject(str, com.MCWorld.module.topic.g.class);
        } catch (Exception e) {
            return info;
        }
    }
    ...
    public void a(int insZoneMode, com.MCWorld.data.inszone.a scoreRecore) {
        if (scoreRecore != null) {
            get_config_sp().edit().putString("insZone" + insZoneMode, ag.toJsonString(scoreRecore)).commit();
        }
    }

    public com.MCWorld.data.inszone.a lr(int insZoneMode) {
        return (com.MCWorld.data.inszone.a) ag.toObjectNoExp(get_config_sp().getString("insZone" + insZoneMode, ""), com.MCWorld.data.inszone.a.class);
    }

    public void bw(long count) {
        if (com.MCWorld.data.j.ep().ey()) {
            long uid = com.MCWorld.data.j.ep().getUserid();
            if (uid != 0) {
                com.MCWorld.pref.b.Em().putLong(uid + "_followingMsgCount", count);
            }
        }
    }
    ...
    public long LX() {
        ...
        long uid = com.MCWorld.data.j.ep().getUserid();
        if (uid != 0) {
            return com.MCWorld.pref.b.Em().getLong(uid + "_followingMsgCount");
        }
        return 0;
    }

    public long LY() {
        return com.MCWorld.pref.b.Em().getLong("version_flag", 0);
    }

    public void bx(long versioncode) {
        com.MCWorld.pref.b.Em().putLong("version_flag", versioncode);
    }

    public void dd(boolean val) {
        com.MCWorld.pref.b.Em().putBoolean("newupdate", val);
    }

    public boolean LZ() {
        return com.MCWorld.pref.b.Em().getBoolean("newupdate", true);
    }

    public c Ma() {
        String str = com.MCWorld.pref.b.Em().getString("cloudidinfo");
        if (UtilsFunction.empty((CharSequence) str)) {
            return null;
        }
        c info = null;
    ...
    public void a(c info) {
        com.MCWorld.pref.b.Em().put("cloudidinfo", ag.toJsonString(info));
    }

    public void Mb() {
        com.MCWorld.pref.b.Em().remove("cloudidinfo");
    }

    public void de(boolean val) {
        com.MCWorld.pref.b.Em().putBoolean("resetcloudid", val);
    }

    public boolean Mc() {
        return com.MCWorld.pref.b.Em().getBoolean("resetcloudid", false);
    }
}
