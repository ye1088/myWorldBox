...
import com.MCWorld.framework.base.http.toolbox.PoolingByteArrayOutputStream;
...
public class BasicNetwork implements Network<Request<?>> {
    ...
    public com.MCWorld.framework.base.http.io.NetworkResponse performRequest(com.MCWorld.framework.base.http.io.Request<?> r23) throws com.MCWorld.framework.base.http.toolbox.error.VolleyError {
        /*
        r22 = this;
    ...
    L_0x0196:
        ...
        throw r5;	 Catch:{ all -> 0x0126 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huluxia.framework.base.http.transport.BasicNetwork.performRequest(com.huluxia.framework.base.http.io.Request):com.huluxia.framework.base.http.io.NetworkResponse");
    }
        ...
        try {
            ...
            try {
                ...
                if (entity.getContentEncoding() == null || !"gzip".equals(entity.getContentEncoding().getValue())) {
                    ...
                    HLog.debug(TAG, "basic network gzip " + request.getUrl(), new Object[0]);
