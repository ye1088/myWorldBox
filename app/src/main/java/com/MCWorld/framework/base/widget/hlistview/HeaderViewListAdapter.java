...
public class HeaderViewListAdapter implements Filterable, WrapperListAdapter {
    ...
    public HeaderViewListAdapter(ArrayList<HListView$FixedViewInfo> headerViewInfos, ArrayList<HListView$FixedViewInfo> footerViewInfos, ListAdapter adapter) {
    ...
    private boolean areAllListInfosSelectable(ArrayList<HListView$FixedViewInfo> infos) {
        if (infos != null) {
            ...
            while (it.hasNext()) {
                if (!((HListView$FixedViewInfo) it.next()).isSelectable) {
                    return false;
                }
            }
        }
    ...
    public boolean removeHeader(View v) {
        ...
        for (int i = 0; i < this.mHeaderViewInfos.size(); i++) {
            if (((HListView$FixedViewInfo) this.mHeaderViewInfos.get(i)).view == v) {
    ...
    public boolean removeFooter(View v) {
        ...
        for (int i = 0; i < this.mFooterViewInfos.size(); i++) {
            if (((HListView$FixedViewInfo) this.mFooterViewInfos.get(i)).view == v) {
    ...
    public boolean isEnabled(int position) {
        ...
        if (position < numHeaders) {
            return ((HListView$FixedViewInfo) this.mHeaderViewInfos.get(position)).isSelectable;
        }
        ...
        return ((HListView$FixedViewInfo) this.mFooterViewInfos.get(adjPosition - adapterCount)).isSelectable;
    }

    public Object getItem(int position) {
        int numHeaders = getHeadersCount();
        if (position < numHeaders) {
            return ((HListView$FixedViewInfo) this.mHeaderViewInfos.get(position)).data;
        }
        int adjPosition = position - numHeaders;
        int adapterCount = 0;
        if (this.mAdapter != null) {
        ...
        return ((HListView$FixedViewInfo) this.mFooterViewInfos.get(adjPosition - adapterCount)).data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        int numHeaders = getHeadersCount();
        if (position < numHeaders) {
            return ((HListView$FixedViewInfo) this.mHeaderViewInfos.get(position)).view;
        }
        int adjPosition = position - numHeaders;
        int adapterCount = 0;
        if (this.mAdapter != null) {
        ...
        return ((HListView$FixedViewInfo) this.mFooterViewInfos.get(adjPosition - adapterCount)).view;
    }
