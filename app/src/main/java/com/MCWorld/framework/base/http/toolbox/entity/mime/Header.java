...
public class Header implements Iterable<MinimalField> {
    ...
    public MinimalField getField(String name) {
        ...
        List<MinimalField> list = (List) this.fieldMap.get(name.toLowerCase());
    ...
    public int removeFields(String name) {
        ...
        List<MinimalField> removed = (List) this.fieldMap.remove(name.toLowerCase());
    ...
    public void setField(MinimalField field) {
        if (field != null) {
            List<MinimalField> list = (List) this.fieldMap.get(field.getName().toLowerCase());
            if (list == null || list.isEmpty()) {
                addField(field);
                return;
            }
