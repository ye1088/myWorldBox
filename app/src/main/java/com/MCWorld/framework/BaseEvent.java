...
public abstract class BaseEvent {
    public static final int EVENT_ADD_DOWNLOAD_HANDLER = 267;
    public static final int EVENT_ADD_TASK_WAITING = 269;
    ...
    public static final int EVENT_DOWNLOAD_PREPARE = 266;
    ...
    public static final int EVENT_RMOVE_DOWNLOAD_HANDLER = 268;
