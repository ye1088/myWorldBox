package com.MCWorld.framework.http;
...
public class HttpMgr extends BaseHttpMgr {
    ...
    public synchronized void init(Context context) {
        ...
        this.mDownloadJsRoot = new File(com.MCWorld.utils.UtilsFile.Kt());
        this.mDownloadWoodRoot = new File(com.MCWorld.utils.UtilsFile.Kv());
        this.mDownloadSkinRoot = new File(com.MCWorld.utils.UtilsFile.Ku());
