...
class a {
    ...
    L_0x0048:
        ...
        com.xiaomi.channel.commonutils.logger.b.d(r2);	 Catch:{ all -> 0x007e }
        if (r1 == 0) goto L_0x0047;
    L_0x006b:
        r1 = r1.getParcelFileDescriptor();
        goto L_0x0044;
                            ...
                            if (h()) {
                                ...
                                if (this.e < this.f) {
                                    if (this.e > this.d) {
                                        ...
                                        dexClassLoader = new DexClassLoader(this.c, this.a.getDir(g.cmC, 0).getAbsolutePath(), n(), ClassLoader.getSystemClassLoader());
                                    ...
                                    dexClassLoader = new DexClassLoader(this.c, this.a.getDir(g.cmC, 0).getAbsolutePath(), m(), ClassLoader.getSystemClassLoader());
                                    b.b("load apk : " + this.c + ", version : " + this.d);
                                    b.b("load apk done.");
                                }
                                b.b("load apk : " + this.c + ", version : " + this.d);
