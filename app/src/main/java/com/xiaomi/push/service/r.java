...
public class r {
    ...
    private static PendingIntent a(Context context, o oVar, i iVar, byte[] bArr) {
        ...
        if (iVar != null && !TextUtils.isEmpty(iVar.g)) {
            ...
            return PendingIntent.getService(context, 0, intent, avutil.AV_CPU_FLAG_AVXSLOW);
        } else {
    ...
    private static RemoteViews b(Context context, o oVar, byte[] bArr) {
        ...
        try {
            ...
            try {
                ...
                if (jSONObject2.has(ContainsSelector.CONTAINS_KEY)) {
                    jSONObject = jSONObject2.getJSONObject(ContainsSelector.CONTAINS_KEY);
