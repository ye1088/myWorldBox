...
public class PacketSync {
    ...
    public void a(d dVar) {
        ...
        if (!l2.equals("0")) {
            ...
            if (bVar2.a("ps") != null) {
                try {
                    ag.a().a(com.xiaomi.push.protobuf.b.a.b(Base64.decode(bVar2.a("ps"), 8)));
                } catch (IllegalArgumentException e2) {
                    com.xiaomi.channel.commonutils.logger.b.a("invalid Base64 exception + " + e2.getMessage());
                } catch (com.google.protobuf.micro.c e3) {
                    com.xiaomi.channel.commonutils.logger.b.a("invalid pb exception + " + e3.getMessage());
                }
            }
        }
    }
