...
public class f {
    ...
    public b a(b bVar, Context context, b bVar2, String str) {
        ...
        bVar.d = "XMPUSH-PASS";
        bVar.e = false;
        bVar.f = String.format("%1$s:%2$s,%3$s:%4$s,%5$s:%6$s", new Object[]{"sdk_ver", Integer.valueOf(19), "cpvn", "3_0_3", "cpvc", Integer.valueOf(30003)});
        String str2 = b(context) ? "1000271" : this.d;
        if (a(context)) {
            bVar.g = String.format("%1$s:%2$s,%3$s:%4$s,%5$s:%6$s", new Object[]{"appid", str2, "locale", Locale.getDefault().toString(), "ab", str});
        } else {
            bVar.g = String.format("%1$s:%2$s,%3$s:%4$s", new Object[]{"appid", str2, "locale", Locale.getDefault().toString()});
        }
        bVar.k = bVar2;
        return bVar;
    }
