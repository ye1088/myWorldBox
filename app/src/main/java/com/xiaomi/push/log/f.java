    ...
    private void b() {
        ...
        try {
            ...
            if ((file.exists() && file.isDirectory()) || file.mkdirs()) {
                ...
                randomAccessFile = new RandomAccessFile(file2, e.cle);
                try {
                    ...
                    try {
                        ...
                        while (!f.isEmpty()) {
                            try {
                                ...
                                if (pair.second != null) {
                                    str = (str + SpecilApiUtil.LINE_SEP) + Log.getStackTraceString((Throwable) pair.second);
                                }
                                bufferedWriter3.write(str + SpecilApiUtil.LINE_SEP);
                            } catch (Exception e2) {
                                e = e2;
