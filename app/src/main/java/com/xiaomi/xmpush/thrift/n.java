...
public class n implements Serializable, Cloneable, b<n, a> {
    ...
    private static final c w = new c("cmdArgs", (byte) 15, (short) 10);
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new org.apache.thrift.meta_data.b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, m.class)));
