...
public class t implements Serializable, Cloneable, b<t, a> {
    ...
    private static final c v = new c("packageName", (byte) 11, (short) 10);
    public String a;
    public j b;
    public String c;
    public String d;
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new org.apache.thrift.meta_data.b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, s.class)));
        ...
        enumMap.put(a.REG_SECRET, new org.apache.thrift.meta_data.b("regSecret", (byte) 2, new org.apache.thrift.meta_data.c((byte) 11)));
