...
public class g implements Serializable, Cloneable, b<g, a> {
    ...
    private static final c c = new c("host", (byte) 11, (short) 1);
    private static final c d = new c("land_node_info", (byte) 15, (short) 2);
    private String e;
    private List<h> f;
    ...
    static {
        ...
        enumMap.put(a.HOST, new org.apache.thrift.meta_data.b("host", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.LAND_NODE_INFO, new org.apache.thrift.meta_data.b("land_node_info", (byte) 1, new d((byte) 15, new org.apache.thrift.meta_data.g((byte) 12, h.class))));
