...
public class f implements Serializable, Cloneable, b<f, a> {
    ...
    private static final c i = new c("host_info", (byte) 14, (short) 7);
    private String j = "";
    private String k;
    private String l;
    private String m;
    ...
    static {
        ...
        enumMap.put(a.CATEGORY, new org.apache.thrift.meta_data.b("category", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.UUID, new org.apache.thrift.meta_data.b("uuid", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.VERSION, new org.apache.thrift.meta_data.b("version", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.NETWORK, new org.apache.thrift.meta_data.b("network", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.RID, new org.apache.thrift.meta_data.b("rid", (byte) 1, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.LOCATION, new org.apache.thrift.meta_data.b("location", (byte) 2, new g((byte) 12, e.class)));
        enumMap.put(a.HOST_INFO, new org.apache.thrift.meta_data.b("host_info", (byte) 2, new org.apache.thrift.meta_data.f((byte) 14, new g((byte) 12, g.class))));
