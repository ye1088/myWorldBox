...
public class b implements Serializable, Cloneable, org.apache.thrift.b<b, a> {
    ...
    private static final c k = new c("app_name", (byte) 11, (short) 9);
    private static final c l = new c(BaseHttpMgr.PARAM_APP_VERSION, (byte) 11, (short) 10);
    private String m = "";
    private String n;
    private String o;
    private String p;
    ...
    static {
        ...
        enumMap.put(a.i, new org.apache.thrift.meta_data.b("app_name", (byte) 2, new org.apache.thrift.meta_data.c((byte) 11)));
        enumMap.put(a.j, new org.apache.thrift.meta_data.b(BaseHttpMgr.PARAM_APP_VERSION, (byte) 2, new org.apache.thrift.meta_data.c((byte) 11)));
