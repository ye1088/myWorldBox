...
public class c {
    ...
    private String b(String str, String str2) {
        ...
        stringBuilder.append(SimpleComparison.LESS_THAN_OPERATION).append(str).append("/>");
        if (str != null) {
            stringBuilder.append(SimpleComparison.LESS_THAN_OPERATION).append(str2).append("/>");
        }
