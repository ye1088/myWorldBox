...
public class c {
    ...
    public static b a(XmlPullParser xmlPullParser, com.xiaomi.smack.a aVar) {
        ...
        while (obj == null) {
            ...
            if (next == 2) {
                ...
                if (name.equals(DownloadRecord.COLUMN_ERROR)) {
    ...
    public static d a(XmlPullParser xmlPullParser) {
        ...
        try {
            attributeValue7 = xmlPullParser.getAttributeValue("", Values.SEQ);
        ...
        while (!z2) {
            ...
            if (next2 == 2) {
                ...
                } else if (attributeValue.equals(DownloadRecord.COLUMN_ERROR)) {
    ...
    public static f b(XmlPullParser xmlPullParser) {
        ...
        while (i == 0) {
            ...
            if (next == 2) {
                ...
                } else if (name.equals(DownloadRecord.COLUMN_ERROR)) {
    ...
    public static k.b c(XmlPullParser xmlPullParser) {
        ...
        while (obj == null) {
            int next = xmlPullParser.next();
            if (next == 2) {
                if (xmlPullParser.getName().equals(DownloadRecord.COLUMN_ERROR)) {
                    hVar = e(xmlPullParser);
                }
    ...
    public static g d(XmlPullParser xmlPullParser) {
        ...
        while (obj == null) {
            ...
            } else if (next == 3 && xmlPullParser.getName().equals(DownloadRecord.COLUMN_ERROR)) {
                obj = 1;
            }
        }
        return gVar;
