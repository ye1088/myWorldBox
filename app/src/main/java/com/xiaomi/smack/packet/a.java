...
public class a implements e {
    ...
    public String d() {
        ...
        stringBuilder.append(SimpleComparison.LESS_THAN_OPERATION).append(this.a);
        ...
        if (!TextUtils.isEmpty(this.e)) {
            stringBuilder.append(SimpleComparison.GREATER_THAN_OPERATION).append(this.e).append("</").append(this.a).append(SimpleComparison.GREATER_THAN_OPERATION);
            ...
            stringBuilder.append("</").append(this.a).append(SimpleComparison.GREATER_THAN_OPERATION);
        }
