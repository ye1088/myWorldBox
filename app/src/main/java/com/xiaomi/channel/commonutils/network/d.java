...
public class d {
    ...
    public static com.xiaomi.channel.commonutils.network.b a(android.content.Context r9, java.lang.String r10, java.lang.String r11, java.util.Map<java.lang.String, java.lang.String> r12, java.lang.String r13) {
        ...
        r6.setConnectTimeout(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r0 = 15000; // 0x3a98 float:2.102E-41 double:7.411E-320;
        r6.setReadTimeout(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        if (r11 != 0) goto L_0x001e;
    L_0x001b:
        r11 = "GET";
    L_0x001e:
        r6.setRequestMethod(r11);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
    ...
    L_0x0031:
        ...
        r0 = (java.lang.String) r0;	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r1 = r12.get(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r1 = (java.lang.String) r1;	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r6.setRequestProperty(r0, r1);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        goto L_0x002b;
    L_0x0041:
        r0 = move-exception;
        r1 = r2;
    ...
    L_0x0052:
        throw r0;
    L_0x0053:
        r0 = android.text.TextUtils.isEmpty(r13);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        if (r0 != 0) goto L_0x0144;
    L_0x0059:
        r0 = 1;
        r6.setDoOutput(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r0 = r13.getBytes();	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r1 = r6.getOutputStream();	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r4 = 0;
    ...
    L_0x0071:
        ...
        r0 = r3;
    L_0x0094:
        r1 = r6.getHeaderFieldKey(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
        r3 = r6.getHeaderField(r0);	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
    ...
    L_0x00b3:
        ...
        r3 = new java.lang.StringBuffer;	 Catch:{ IOException -> 0x0141, Throwable -> 0x0136, all -> 0x012e }
        r3.<init>();	 Catch:{ IOException -> 0x0141, Throwable -> 0x0136, all -> 0x012e }
        r6 = "line.separator";
        r6 = java.lang.System.getProperty(r6);	 Catch:{ IOException -> 0x0141, Throwable -> 0x0136, all -> 0x012e }
    L_0x00c3:
    ...
    public static String a(String str, Map<String, String> map, File file, String str2) {
        ...
        try {
            ...
            try {
                ...
                bufferedReader3 = new BufferedReader(new InputStreamReader(new a(httpURLConnection.getInputStream())));
                while (true) {
                    try {
    ...
    public static boolean b(Context context) {
        if (!"CN".equalsIgnoreCase(((TelephonyManager) context.getSystemService(a.qe)).getSimCountryIso())) {
            return false;
        }
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
