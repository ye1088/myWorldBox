...
public abstract class MiPushClient {
    ...
    private static void checkServices(Context context, PackageInfo packageInfo) {
        ...
        hashMap.put("com.xiaomi.push.service.XMPushService", new Object[]{Boolean.valueOf(true), Boolean.valueOf(false), ""});
        hashMap.put(PushMessageHandler.class.getCanonicalName(), new Object[]{Boolean.valueOf(true), Boolean.valueOf(true), ""});
        hashMap.put(MessageHandleService.class.getCanonicalName(), new Object[]{Boolean.valueOf(true), Boolean.valueOf(false), ""});
            ...
            if (z || shouldSendRegRequest(sContext)) {
                if (z || !a.a(sContext).a(str, str2) || a.a(sContext).n()) {
                    ...
                    if (1 == PushMessageHelper.getPushMode(context)) {
                        checkNotNull(miPushClientCallback, a.bHm);
                    ...
                    if (a.a(sContext).a()) {
                        ...
                        rVar.h = new HashMap();
                        rVar.h.put(BaseHttpMgr.PARAM_APP_VERSION, com.xiaomi.channel.commonutils.android.b.a(sContext, sContext.getPackageName()));
    ...
    private static void scheduleOcVersionCheckJob() {
        com.xiaomi.channel.commonutils.misc.d.a(sContext).a(new g(sContext), v.a(sContext).a(com.xiaomi.xmpush.thrift.b.A.a(), 86400), 5);
    }
    ...
    protected static void setCommand(Context context, String str, ArrayList<String> arrayList, String str2) {
        if (!TextUtils.isEmpty(a.a(context).c())) {
            ...
            j.a(context).a(mVar, com.xiaomi.xmpush.thrift.a.Command, null);
        }
    }
    ...
    public static void subscribe(Context context, String str, String str2) {
        if (!TextUtils.isEmpty(a.a(context).c()) && !TextUtils.isEmpty(str)) {
            if (System.currentTimeMillis() - topicSubscribedTime(context, str) > 86400000) {
                ...
                xVar.e(str2);
                j.a(context).a(xVar, com.xiaomi.xmpush.thrift.a.Subscription, null);
            } else if (1 == PushMessageHelper.getPushMode(context)) {
    ...
    public static void unsubscribe(Context context, String str, String str2) {
        ...
        abVar.e(str2);
        j.a(context).a(abVar, com.xiaomi.xmpush.thrift.a.UnSubscription, null);
    }
