...
public class CoordinateConvert {
    static Bundle a(GeoPoint geoPoint, int i) {
        ...
        bundle.putInt(SocialConstants.PARAM_ACT, 15010250);
        ...
        valueOf = String.valueOf(c.a(String.valueOf(i3).toCharArray()));
        bundle.remove("y");
        bundle.putString("y", valueOf);
        return bundle;
    }
    ...
    public static GeoPoint bundleDecode(Bundle bundle) {
        ...
        string = String.valueOf(c.b(string.toCharArray()));
        string2 = String.valueOf(c.b(string2.toCharArray()));
        int intValue = Integer.decode(string).intValue();
        int intValue2 = Integer.decode(string2).intValue();
