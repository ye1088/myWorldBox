...
import com.huluxia.controller.resource.action.c;
import com.huluxia.controller.resource.bean.ResTaskInfo;
import com.huluxia.controller.resource.bean.ResTaskInfo.State;
import com.huluxia.controller.resource.dispatcher.a;
...
public abstract class d<T extends ResTaskInfo> extends b<T> {
    ...
    private com.huluxia.controller.resource.action.a downloader = new com.huluxia.controller.resource.action.a(this);
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        EventNotifyCenter.notifyEventUiThread(com.huluxia.controller.c.class, 264, ((ResTaskInfo) getInfo()).url, Integer.valueOf(VolleyError.getErrorId(error)));
        destroy();
    }
