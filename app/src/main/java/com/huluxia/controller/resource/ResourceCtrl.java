...
import com.huluxia.controller.e.e;
import com.huluxia.controller.resource.DownloadService.a.a;
...
import com.huluxia.controller.resource.handler.base.b;
...
public class ResourceCtrl implements a {
    ...
    private ResourceCtrl() {
        ...
        AppConfig.getInstance().setResCtrlHttpMgr(com.huluxia.controller.resource.http.a.dX());
        com.huluxia.controller.resource.http.a.dX().init(AppConfig.getInstance().getAppContext());
    ...
    public List<ResTaskInfo> getDownloading() {
        ...
        for (com.huluxia.controller.resource.handler.base.a<? extends ResTaskInfo> handler : this.mResourceHandlers.values()) {
    ...
    private void destroyTask(ResTaskInfo info, boolean delete, boolean deleteFile) {
        if (info == null) {
            ...
            ((com.huluxia.controller.resource.handler.base.a) this.mResourceHandlers.get(info.url)).pause(delete, deleteFile);
    ...
    public ResTaskInfo getTaskInfo(String url, int resourceType) {
        ...
        if (this.mResourceHandlers.containsKey(url)) {
            return (ResTaskInfo) ((com.huluxia.controller.resource.handler.base.a) this.mResourceHandlers.get(url)).getInfo();
        }
        DownloadRecord record = DownloadMemCache.getInstance().getRecord(url);
        if (record != null) {
            return a.a(record, resourceType);
        }
        f table = com.huluxia.controller.resource.handler.segments.a.an(url);
        if (table != null) {
            record = com.huluxia.controller.resource.handler.segments.a.getRecord(url);
            if (record != null) {
    ...
    public <T extends com.huluxia.controller.resource.handler.base.a<? extends ResTaskInfo>> void addRunningHandler(String url, T handler) {
    ...
    public com.huluxia.controller.resource.handler.base.a<? extends ResTaskInfo> removeRunningHandler(String url) {
        HLog.info(TAG, "remove running handle url %s", url);
        com.huluxia.controller.resource.handler.base.a<? extends ResTaskInfo> handler = (com.huluxia.controller.resource.handler.base.a) this.mResourceHandlers.remove(url);
        EventNotifyCenter.notifyEventUiThread(BaseEvent.class, 267, new Object[0]);
    ...
    private static String getHpkUnzipHistoryDir() {
        return UtilsFile.getDiskCacheDir(AppConfig.getInstance().getAppContext(), com.huluxia.controller.resource.http.a.dX().getDownloadCachePath()) + File.separator + "unhpk-history";
    }
}
