...
import com.huluxia.controller.resource.action.e;
...
public class g extends p implements a {
    ...
    public void aj(String path) {
        ...
        com.huluxia.controller.resource.zip.b hpkFileList = com.huluxia.controller.resource.zip.c.ea().aq(((ResTaskInfo) getInfo()).url);
        if (hpkFileList == null) {
            hpkFileList = new com.huluxia.controller.resource.zip.b();
