...
public class a implements b {
    ...
    public boolean run() {
        ...
        headers.putAll(dL());
        ((DownloadRequestBuilder) com.huluxia.controller.resource.http.a.dX().getDownloadReqBuilder(info.url, info.dir, info.filename).setRename(info.mU).setEncodeType(UtilsFunction.empty(info.dataDownUrl) ? -1 : 4).setAdditionalHeaders(headers)).setContext(info).setSuccListener(new Listener<String>(this) {
