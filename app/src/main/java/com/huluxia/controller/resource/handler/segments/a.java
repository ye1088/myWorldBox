...
public class a {
    ...
    public static DownloadRecord t(String tableId, int mode) {
        ...
        for (com.huluxia.controller.resource.handler.segments.f.a segment : table.oo) {
    ...
    public static void delete(String tableId) {
        ...
        if (!(downloadedTable == null || UtilsFunction.empty(downloadedTable.oo))) {
            for (com.huluxia.controller.resource.handler.segments.f.a segment : downloadedTable.oo) {
