...
import com.huluxia.mcfloat.enchant.c;
import com.huluxia.mcfloat.enchant.e;
import com.huluxia.mcfloat.enchant.f;
import com.huluxia.r;
import java.util.List;

/* compiled from: FloatLayoutEnchantView */
public class h implements OnClickListener, com.huluxia.mcfloat.p.a {
    ...
    private class a extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            int levelCount = com.huluxia.mcfloat.enchant.b.fI(this.RO[position]);
        ...
        public void a(c item) {
            if (item != null) {
                ...
                for (int i = 0; i < count; i++) {
                    this.RM[i] = com.huluxia.mcfloat.enchant.b.fG(mTmpSupportAttr[i]);
                    this.RN[i] = 0;
                    this.RQ[i] = false;
                    this.RO[i] = com.huluxia.mcfloat.enchant.b.fH(mTmpSupportAttr[i]);
                }
        ...
        public void rq() {
            ...
            for (int i = 0; i < getCount(); i++) {
                this.RQ[i] = true;
                this.RN[i] = h.Rw * com.huluxia.mcfloat.enchant.b.fI(this.RO[i]);
            }
            notifyDataSetChanged();
        }
        ...
        public void aD(boolean bEnabled) {
            ...
            for (int i2 = 0; i2 < getCount(); i2++) {
                this.RQ[i2] = true;
                this.RN[i2] = h.Rw * com.huluxia.mcfloat.enchant.b.fI(this.RO[i2]);
            }
            notifyDataSetChanged();
        }
        ...
        public void rs() {
            for (int i = 0; i < getCount(); i++) {
                int level = (int) (Math.random() * ((double) com.huluxia.mcfloat.enchant.b.fI(this.RO[i])));
