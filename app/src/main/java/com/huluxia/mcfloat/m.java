...
public class m implements OnClickListener, com.huluxia.mcfloat.p.a {
    ...
    private class a extends BaseAdapter {
        ...
        private int[] RO;
        final /* synthetic */ m Uh;
        private com.huluxia.mcfloat.potion.b Ui;
        private int[] Uj;
        private boolean[] Uk;
        ...
        public void a(com.huluxia.mcfloat.potion.b item) {
            int count;
            List<com.huluxia.mcfloat.potion.b> mTmpPotionItemList;
            if (this.Uh.TW == 0) {
                count = 14;
            ...
            for (int i = 0; i < count; i++) {
                com.huluxia.mcfloat.potion.b mTmpPotionItem = (com.huluxia.mcfloat.potion.b) mTmpPotionItemList.get(i);
        ...
        private void dj(int position) {
            com.huluxia.mcfloat.potion.b mTmpPotionItem = c.fT(this.RO[position]);
            if (mTmpPotionItem != null) {
                new com.huluxia.mcfloat.potion.a(this.Uh.Pu.getContext(), mTmpPotionItem.uL(), mTmpPotionItem.uM()).showDialog();
            }
        }
    ...
    private void rQ() {
        ...
        if (tmpTime > 0) {
            ...
            com.huluxia.k.p(this.Pu.getContext(), this.Pu.getResources().getString(R.string.set_time_tips));
        }
        if (tmpEatPotionFlag) {
            if (this.TX) {
