...
import com.huluxia.mcfloat.InstanceZones.maze.a;
import com.huluxia.mcfloat.e;
import com.huluxia.mcfloat.i;
import com.huluxia.mcfloat.m;
import com.huluxia.mcfloat.n;
...
public class d {
    ...
    public static b a(int insZoneMode, Activity aty) {
        ...
        return new com.huluxia.mcfloat.InstanceZones.config.d().a(_insZonesType, _tmpIs, true);
    }
    ...
    public static boolean a(b missionPara, c curMissonPara, int challengeTime, f displayBoard) {
        ...
        if (missionPara.sn() == 5) {
            ...
            if (challengeTime % 15 == 0) {
                a.tB().e(new com.huluxia.mcfb.b(1, 32, 0, 1, 0));
            }
            return a.tB().tD();
        } else if (missionPara.sn() == 6) {
            if (challengeTime != 0) {
                return com.huluxia.mcfloat.InstanceZones.trap.a.tQ().tP();
            }
            com.huluxia.mcfloat.InstanceZones.trap.a.tQ().tH();
            return false;
        } else if (missionPara.sn() == 7) {
            if (challengeTime != 0) {
                return com.huluxia.mcfloat.InstanceZones.parkour.a.tK().tI();
            }
            com.huluxia.mcfloat.InstanceZones.parkour.a.tK().tH();
            return false;
        } else if (curMissonPara.tA() != null && missionPara.sr() < curMissonPara.tA().size() && ((com.huluxia.mcfloat.InstanceZones.structrue.c) curMissonPara.tA().get(missionPara.sr())).Zr == challengeTime + 8) {
            h.l(((com.huluxia.mcfloat.InstanceZones.structrue.c) curMissonPara.tA().get(missionPara.sr())).Zq);
            missionPara.sq();
            return false;
    ...
    public static boolean a(b missionPara) {
        ...
        switch (missionPara.sn()) {
            ...
            case 5:
                return a.tB().sQ();
            case 6:
                return com.huluxia.mcfloat.InstanceZones.trap.a.tQ().sQ();
            case 7:
                return com.huluxia.mcfloat.InstanceZones.parkour.a.tK().sQ();
            default:
                return true;
        }
    }
    ...
    public static List<c.a> a(c curMissonPara) {
        ...
        if (curMissonPara != null) {
            ...
            while (it.hasNext()) {
                com.huluxia.mcfb.c _MCFBMonsterItem = (com.huluxia.mcfb.c) it.next();
    ...
    public static void b(int insZoneMode, c curMissonPara) {
        ...
        if (insZoneMode == 6) {
            com.huluxia.mcfloat.InstanceZones.trap.a.tQ().tJ();
        }
        if (insZoneMode == 7) {
            com.huluxia.mcfloat.InstanceZones.parkour.a.tK().tJ();
        } else {
            h.sN().sT();
        }
    }
    ...
    private static void d(int insZoneMode, c curMissonPara) {
        if (insZoneMode == 5) {
            ...
            com.huluxia.mcfloat.InstanceZones.trap.a.tQ().tG();
        } else if (insZoneMode == 7) {
            com.huluxia.mcfloat.InstanceZones.parkour.a.tK().b(curMissonPara.mWidth, curMissonPara.mLength, curMissonPara.XM, curMissonPara.tz());
            com.huluxia.mcfloat.InstanceZones.parkour.a.tK().tG();
        } else {
    ...
    private static void dN(int insZoneMode) {
        switch (insZoneMode) {
            ...
            case 5:
                ...
                return;
            case 6:
                com.huluxia.mcfloat.InstanceZones.trap.a.tQ().tC();
                return;
            case 7:
                com.huluxia.mcfloat.InstanceZones.parkour.a.tK().tC();
                return;
            default:
                return;
        }
    ...
    private static void e(int insZoneMode, c curMissonPara) {
        List<com.huluxia.mcinterface.c> mBagCacheList;
        if (insZoneMode == 5) {
            mBagCacheList = new ArrayList();
            mBagCacheList.add(new com.huluxia.mcinterface.c(0, 323, 30, 0, 0));
            h.F(mBagCacheList);
        } else if (insZoneMode == 6) {
            mBagCacheList = new ArrayList();
            mBagCacheList.add(new com.huluxia.mcinterface.c(0, 261, 1, 0, 0));
            mBagCacheList.add(new com.huluxia.mcinterface.c(0, 262, 10, 0, 0));
            h.F(mBagCacheList);
        } else if (insZoneMode != 7) {
            w(curMissonPara.sW());
            ArrayList<com.huluxia.mcfb.b> inFBMonsterList = new ArrayList();
            List<com.huluxia.mcfb.b> tmpWareEquipment = curMissonPara.sX();
            List<com.huluxia.mcfb.b> tmpBagEquipment = curMissonPara.sY();
    ...
    private static void w(List<com.huluxia.mcfb.b> itemList) {
        if (itemList != null) {
            ...
            _GeneralAttrs[6] = 17;
            _EnchantLevel[6] = 5;
            for (com.huluxia.mcfb.b _tmp : itemList) {
