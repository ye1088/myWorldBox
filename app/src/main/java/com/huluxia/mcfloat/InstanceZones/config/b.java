...
public class b {
    ...
    public List<com.huluxia.mcfb.b> eg(int missionIndex) {
    ...
    public List<com.huluxia.mcfb.b> eh(int missionIndex) {
    ...
    public List<com.huluxia.mcfb.b> ei(int missionIndex) {
    ...
    public c g(int curMissionIndex, c missonPara) {
        ...
        if (missonPara == null) {
            missonPara = new c();
            missonPara.XT = new a();
            missonPara.XU = new com.huluxia.mcfloat.InstanceZones.structrue.b(-1);
        }
