...
public class b {
    ...
    private boolean a(ArrayList<com.huluxia.mcfloat.InstanceZones.trap.b> inputList, int inputX, int inputZ) {
        for (int i = 0; i < inputList.size(); i++) {
            com.huluxia.mcfloat.InstanceZones.trap.b _tmpMCMapItemObj = (com.huluxia.mcfloat.InstanceZones.trap.b) inputList.get(i);
    ...
    private void a(ArrayList<com.huluxia.mcfloat.InstanceZones.trap.b> inputList, boolean isTrap, int inputX, int inputZ) {
        if (inputList != null) {
            for (int i = 0; i < inputList.size(); i++) {
                com.huluxia.mcfloat.InstanceZones.trap.b _tmpMCMapItemObj = (com.huluxia.mcfloat.InstanceZones.trap.b) inputList.get(i);
                if (_tmpMCMapItemObj.ZM == inputX && _tmpMCMapItemObj.ZN == inputZ) {
            ...
            inputList.add(new com.huluxia.mcfloat.InstanceZones.trap.b(inputX, inputZ, isTrap));
        }
    }

    private ArrayList<com.huluxia.mcfloat.InstanceZones.trap.b> D(int inputX, int inputZ) {
        ArrayList<com.huluxia.mcfloat.InstanceZones.trap.b> inList = new ArrayList();
        int b = 0;
        while (b < this.Yd) {
            int a = 0;
            while (a < this.Yc) {
                if (a + b <= 1 || a + b >= (this.Yd + this.Yc) - 3) {
                    inList.add(new com.huluxia.mcfloat.InstanceZones.trap.b(inputZ + b, inputX + a, false));
                } else {
                    inList.add(new com.huluxia.mcfloat.InstanceZones.trap.b(inputZ + b, inputX + a, true));
                }
                a++;
            }
            b++;
    ...
    public LinkedList<hlx.utils.a> E(int posX, int posY) {
        ...
        while (it.hasNext()) {
            com.huluxia.mcfloat.InstanceZones.trap.b _tmp = (com.huluxia.mcfloat.InstanceZones.trap.b) it.next();
            if (!_tmp.ZO) {
