...
public class g extends Dialog {
    ...
    public void a(int insZoneMode, c curMissonPara, boolean isSuc, int curMissionIndex) {
        ...
        sL();
        String _tmpNick = com.huluxia.data.j.ep().getNick();
        ...
        dR(_sumScore);
        for (com.huluxia.mcfloat.InstanceZones.c.a _tmpCalculate : d.a(curMissonPara)) {
    ...
    private void A(int insZoneMode, int score) {
        long _userId = com.huluxia.data.j.ep().getUserid();
        this.pM = _userId;
        if (_userId != 0) {
            ...
            com.huluxia.data.inszone.a _tmpRecore = ah.KZ().lr(insZoneMode);
