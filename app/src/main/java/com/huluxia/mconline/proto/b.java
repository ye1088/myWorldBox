...
import com.huluxia.mconline.proto.DTControlProto.DTControlInfo;
import com.huluxia.mconline.proto.DTControlProto.ServerInfo;
import com.huluxia.mconline.proto.DTControlProto.ServerInfo.a;
...
public class b {
    ...
    public void a(int inputRoomId, String inputServerIP, int inputServerPort) {
        try {
            ...
            com.huluxia.mconline.gameloc.tcp.creator.a.AT().ao(_tmpDTControlInfo);
            if (amG.booleanValue()) {
