...
import com.huluxia.http.other.b;
...
import com.huluxia.widget.Constants.PushWay;
...
public class HTApplication extends MultiDexApplication {
    ...
    private IConfig fR = new IConfig(this) {
        ...
        public BaseHttpMgr getHttp() {
            com.huluxia.login.f.pT().init(this.fU, new Config(false));
            return com.huluxia.login.f.pT();
        }
    ...
    public void onCreate() {
        ...
        if (bS()) {
            ...
            i.m(this.fw);
            i.s(this.fx);
            com.huluxia.login.d.pR().aK(this);
            f.init();
            this.fD = g.EA();
            bP();
    ...
    private void bG() {
        ...
        com.huluxia.db.f.eO();
        com.huluxia.controller.resource.handler.a.dO();
    }
    ...
    private void bP() {
        if (ax.ME() == PushWay.HUAWEI) {
            ...
            com.huluxia.hwpush.a.fY().init(this);
            return;
        }
        HLog.info(TAG, "init xiaomi push....", new Object[0]);
        com.huluxia.mipush.a.Dw().init(this, "2882303761517316250", "5531731657250");
    }
