...
public class p extends Dialog {
    ...
    private OnClickListener mClickListener = new OnClickListener(this) {
        ...
        public void onClick(View view) {
            int id = view.getId();
            if (id == g.mod_all) {
                this.bxN.hH(com.huluxia.utils.ah.a.ALL);
                if (this.bxN.mType == b.bme) {
                    ah.KZ().lh(com.huluxia.utils.ah.a.ALL);
                } else {
                    ah.KZ().li(com.huluxia.utils.ah.a.ALL);
                }
                if (this.bxN.bxH != null) {
                    this.bxN.bxH.kE(com.huluxia.utils.ah.a.ALL);
                }
                this.bxN.AQ();
            } else if (id == g.mod_wifi) {
                this.bxN.hH(com.huluxia.utils.ah.a.bmc);
                if (this.bxN.mType == b.bme) {
                    ah.KZ().lh(com.huluxia.utils.ah.a.bmc);
                } else {
                    ah.KZ().li(com.huluxia.utils.ah.a.bmc);
                }
                if (this.bxN.bxH != null) {
                    this.bxN.bxH.kE(com.huluxia.utils.ah.a.bmc);
                }
                this.bxN.AQ();
            } else if (id == g.mod_none) {
                this.bxN.hH(com.huluxia.utils.ah.a.bmd);
                if (this.bxN.mType == b.bme) {
                    ah.KZ().lh(com.huluxia.utils.ah.a.bmd);
                } else {
                    ah.KZ().li(com.huluxia.utils.ah.a.bmd);
                }
                if (this.bxN.bxH != null) {
                    this.bxN.bxH.kE(com.huluxia.utils.ah.a.bmd);
                }
                this.bxN.AQ();
    ...
    private void hH(int mod) {
        if (com.huluxia.utils.ah.a.ALL == mod) {
