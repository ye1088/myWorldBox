...
public class CaseView extends FrameLayout {
    ...
    public CaseView a(View target, @m int imgRes, boolean circle) {
        if (target != null) {
            a caze = new com.huluxia.widget.caseview.a.a().s(target).lP(imgRes).b(circle ? new com.huluxia.widget.caseview.highlight.a() : new com.huluxia.widget.caseview.highlight.b()).Oe();
            if (caze != null) {
                this.bvE.add(caze);
            }
        }
    ...
    public CaseView a(RectF target, @m int imgRes, boolean circle) {
        if (target != null) {
            a caze = new com.huluxia.widget.caseview.a.a().a(target, getContext()).lP(imgRes).b(circle ? new com.huluxia.widget.caseview.highlight.a() : new com.huluxia.widget.caseview.highlight.b()).Oe();
            if (caze != null) {
                this.bvE.add(caze);
            }
        }
    ...
    public CaseView a(RectF target, @m int imgRes, int radiusX, int radiusY) {
        if (target != null) {
            a caze = new com.huluxia.widget.caseview.a.a().a(target, getContext()).lP(imgRes).b(new d(radiusX, radiusY)).Oe();
            if (caze != null) {
                this.bvE.add(caze);
            }
        }
