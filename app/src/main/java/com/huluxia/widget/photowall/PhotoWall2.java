...
public class PhotoWall2 extends LinearLayout {
    ...
    protected d bCy;
    protected ArrayList<com.huluxia.module.picture.b> bCz = new ArrayList();
    ...
    public void d(com.huluxia.module.picture.b unit, int position) {
    ...
    public void e(List<com.huluxia.module.picture.b> photo, boolean clear) {
        if (clear) {
            this.bCz.clear();
        }
    ...
    public void e(com.huluxia.module.picture.b pn) {
    ...
    public List<com.huluxia.module.picture.b> getExistPhotos() {
        List<com.huluxia.module.picture.b> photos = new ArrayList();
        ...
        if (resultCode == -1) {
            if (requestCode == 1) {
                ...
                while (i < this.bCz.size() && i < paths.size()) {
                    com.huluxia.module.picture.b unit = (com.huluxia.module.picture.b) this.bCz.get(i);
    ...
    public void gR(String fid) {
        if (this.bCz != null) {
            for (int i = 0; i < this.bCz.size(); i++) {
                if (fid.equals(((com.huluxia.module.picture.b) this.bCz.get(i)).fid)) {
                    this.bCz.remove(i);
                    this.bCw.notifyDataSetChanged();
                    this.bCy.notifyDataSetChanged();
                    PH();
