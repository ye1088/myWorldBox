...
/* compiled from: ProfileCommentListRequest */
public class f extends a {
    ...
    public String eU() {
        return String.format(Locale.getDefault(), "%s?user_id=%d&start=%s&count=%d", new Object[]{ab.aAt, Long.valueOf(this.sq), this.start, Integer.valueOf(this.count)});
    }
