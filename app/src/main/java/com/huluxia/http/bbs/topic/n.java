...
/* compiled from: TopicDetailFloorRequest */
public class n extends a {
    ...
    public String eU() {
        return String.format(Locale.getDefault(), "%s?post_id=%d&page_no=%d&page_size=%d", new Object[]{ab.azP, Long.valueOf(this.ss), Integer.valueOf(this.su), Integer.valueOf(this.sv)});
    }
