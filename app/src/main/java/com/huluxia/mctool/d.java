...
/* compiled from: McContant */
public class d {
    public static final String a = "每天首次登陆可以获得100点成就点数。";
    public static final String apA = "您已经下载了%d张地图";
    public static final String apB = "您已经下载了%d个插件";
    public static final String apC = "您已经下载了%d个皮肤";
    public static final String apD = "您已经下载了%d个材质";
    public static final String aps = "您已经连续登陆了%d天";
    public static final String apt = "您已经玩了%s我的世界";
    public static final String apu = "您已通关闯关模式%d次";
    public static final String apv = "你已经玩了%s故事模式";
    public static final String apw = "您已经挖掘了%d个方块";
    public static final String apx = "您已经附魔了%d个物品";
    public static final String apy = "您已击杀%d只怪物";
    public static final String apz = "您已死亡了%d次";
