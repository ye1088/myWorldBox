...
class a$31 implements Listener<String> {
    ...
    public void onResponse(String response) {
        try {
            ...
            if (info == null || !info.isSucc()) {
                EventNotifyCenter.notifyEvent(h.class, h.arL, new Object[]{Boolean.valueOf(false), info});
                return;
            }
            EventNotifyCenter.notifyEvent(h.class, h.arL, new Object[]{Boolean.valueOf(true), info});
        } catch (Exception e) {
