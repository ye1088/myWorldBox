...
public class z {
    ...
    public static void V(int tag, int start, int count) {
        ...
        param.put("start", String.valueOf(start));
        param.put("count", String.valueOf(count));
        ((GsonObjRequestBuilder) HttpMgr.getInstance().getGsonObjReqBuilder(ab.azr, com.huluxia.data.studio.a.class).setParams(param)).setSuccListener(new 6(tag)).setErrListener(new 5(tag)).execute();
    }
    ...
    public static void a(int tag, int start, int count, String time) {
        ...
        ((GsonObjRequestBuilder) HttpMgr.getInstance().getGsonObjReqBuilder(ab.azw, com.huluxia.data.studio.e.class).setParams(param)).setSuccListener(new 8(tag)).setErrListener(new 7(tag)).execute();
    }
    ...
    public static void g(int tag, String time) {
        ...
        ((GsonObjRequestBuilder) HttpMgr.getInstance().getGsonObjReqBuilder(ab.azt, com.huluxia.data.studio.f.class).setParams(param)).setSuccListener(new 10(tag)).setErrListener(new 9(tag)).execute();
    }
