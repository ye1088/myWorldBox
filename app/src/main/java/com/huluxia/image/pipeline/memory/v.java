...
public class v implements a {
    ...
    public v(com.huluxia.image.core.common.memory.b memoryTrimmableRegistry, t params) {
        boolean z = false;
    ...
    public com.huluxia.image.core.common.references.a<byte[]> cA(int size) {
        ...
        try {
            return com.huluxia.image.core.common.references.a.a(getByteArray(size), this.xe);
        } catch (Throwable t) {
            this.IH.release();
