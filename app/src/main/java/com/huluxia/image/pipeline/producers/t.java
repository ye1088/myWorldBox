...
*/
    ...
    L_0x002a:
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huluxia.image.pipeline.producers.t.b(com.huluxia.image.pipeline.producers.s, com.huluxia.image.pipeline.producers.ah$a):void");
    }
    ...
    private HttpURLConnection a(Uri uri, int maxRedirects) throws IOException {
        ...
        if (t(responseCode)) {
            ...
            if (maxRedirects == 0) {
                ...
                message = a("URL %s returned %d without a valid redirect", uri.toString(), Integer.valueOf(responseCode));
            }
