...
import com.huluxia.image.base.imageformat.e;
...
public class bb implements am<d> {
    ...
    public bb(Executor executor, com.huluxia.image.base.imagepipeline.memory.d pooledByteBufferFactory, am<d> inputProducer, int enhancedTranscodingType) {
    ...
    private void a(d originalResult, j<d> consumer, ao producerContext) {
        ...
        this.mExecutor.execute(new StatefulProducerRunnable<d>(this, consumer, producerContext.oB(), Ji, producerContext.getId()) {
            ...
            protected d oW() throws Exception {
                ...
                com.huluxia.image.core.common.references.a ref;
                try {
                    bb.a(encodedImageCopy, outputStream, this.Mg.Me);
                    ref = com.huluxia.image.core.common.references.a.b(outputStream.ih());
    ...
    private static TriState l(d encodedImage) {
        ...
        com.huluxia.image.base.imageformat.d imageFormat = e.h(encodedImage.getInputStream());
        if (com.huluxia.image.base.imageformat.b.b(imageFormat)) {
            com.huluxia.image.base.imagepipeline.nativecode.a webpTranscoder = com.huluxia.image.base.imagepipeline.nativecode.b.ii();
            if (webpTranscoder == null) {
                return TriState.NO;
            }
            return TriState.valueOf(!webpTranscoder.e(imageFormat));
        } else if (imageFormat == com.huluxia.image.base.imageformat.d.vz) {
    ...
    private static void a(d encodedImage, f outputStream, int enhancedWebpTranscodingType) throws Exception {
        ...
        com.huluxia.image.base.imageformat.d imageFormat = e.h(imageInputStream);
        if (imageFormat == com.huluxia.image.base.imageformat.b.vp || imageFormat == com.huluxia.image.base.imageformat.b.vr) {
            if (1 == enhancedWebpTranscodingType) {
                com.huluxia.image.base.imagepipeline.nativecode.b.ii().b(imageInputStream, outputStream);
            } else {
                com.huluxia.image.base.imagepipeline.nativecode.b.ii().a(imageInputStream, outputStream, 80);
            }
        } else if (imageFormat == com.huluxia.image.base.imageformat.b.vq || imageFormat == com.huluxia.image.base.imageformat.b.vs) {
            com.huluxia.image.base.imagepipeline.nativecode.b.ii().b(imageInputStream, outputStream);
        } else {
