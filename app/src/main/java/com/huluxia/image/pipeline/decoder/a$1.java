...
class a$1 implements b {
    ...
    public b a(d encodedImage, int length, g qualityInfo, a options) {
        ...
        if (imageFormat == com.huluxia.image.base.imageformat.b.vl) {
            return this.GR.b(encodedImage, length, qualityInfo, options);
        }
        if (imageFormat == com.huluxia.image.base.imageformat.b.vn) {
            return this.GR.a(encodedImage, options);
        }
        if (imageFormat == com.huluxia.image.base.imageformat.b.vt) {
            return this.GR.c(encodedImage, options);
        }
        if (imageFormat != com.huluxia.image.base.imageformat.d.vz) {
