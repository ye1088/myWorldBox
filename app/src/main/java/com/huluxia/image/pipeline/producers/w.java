...
public class w extends y implements az<d> {
    ...
    public w(Executor executor, com.huluxia.image.base.imagepipeline.memory.d pooledByteBufferFactory, ContentResolver contentResolver, boolean decodeFileDescriptorEnabled) {
    ...
    private static int bH(String pathname) {
        ...
        if (pathname != null) {
            try {
                i = com.huluxia.image.base.imageutils.b.bv(new ExifInterface(pathname).getAttributeInt("Orientation", 1));
