...
import com.huluxia.image.base.imagepipeline.memory.a;
...
public class ag implements am<d> {
    ...
    public ag(com.huluxia.image.base.imagepipeline.memory.d pooledByteBufferFactory, a byteArrayPool, ah networkFetcher) {
    ...
    private void a(f pooledOutputStream, boolean isFinal, j<d> consumer) {
        Throwable th;
        com.huluxia.image.core.common.references.a result = com.huluxia.image.core.common.references.a.b(pooledOutputStream.ih());
        d encodedImage = null;
        try {
