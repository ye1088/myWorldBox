...
public class x implements az<d> {
    ...
    public x(Executor executor, com.huluxia.image.base.imagepipeline.memory.d pooledByteBufferFactory, ContentResolver contentResolver) {
    ...
    private d a(PooledByteBuffer imageBytes, ExifInterface exifInterface) {
        ...
        com.huluxia.image.core.common.references.a<PooledByteBuffer> closeableByteBuffer = com.huluxia.image.core.common.references.a.b(imageBytes);
        try {
            ...
            com.huluxia.image.core.common.references.a.c(closeableByteBuffer);
        }
    }

    private int a(ExifInterface exifInterface) {
        return com.huluxia.image.base.imageutils.b.bv(Integer.parseInt(exifInterface.getAttribute("Orientation")));
    }
