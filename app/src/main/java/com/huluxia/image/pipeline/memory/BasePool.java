...
import com.huluxia.image.base.imagepipeline.memory.b;
...
public abstract class BasePool<V> implements b<V> {
    final com.huluxia.image.core.common.memory.b FC;
    final t Hm;
    @VisibleForTesting
    ...
    public BasePool(com.huluxia.image.core.common.memory.b memoryTrimmableRegistry, t poolParams, u poolStatsTracker) {
        this.FC = (com.huluxia.image.core.common.memory.b) Preconditions.checkNotNull(memoryTrimmableRegistry);
