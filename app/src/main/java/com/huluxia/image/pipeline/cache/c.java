...
import com.huluxia.image.base.cache.disk.h;
import com.huluxia.image.base.imagepipeline.memory.PooledByteBuffer;
import com.huluxia.image.base.imagepipeline.memory.d;
import com.huluxia.image.base.imagepipeline.memory.g;
...
public class c {
    ...
    public bolts.h<com.huluxia.image.base.imagepipeline.image.d> a(b key, AtomicBoolean isCancelled) {
        com.huluxia.image.base.imagepipeline.image.d pinnedImage = this.EG.w(key);
        if (pinnedImage != null) {
    ...
    private boolean p(b key) {
        com.huluxia.image.base.imagepipeline.image.d result = this.EG.w(key);
        if (result != null) {
            result.close();
    ...
    private bolts.h<com.huluxia.image.base.imagepipeline.image.d> b(final b key, final AtomicBoolean isCancelled) {
        try {
            return bolts.h.a(new Callable<com.huluxia.image.base.imagepipeline.image.d>(this) {
                final /* synthetic */ c EJ;
                ...
                public com.huluxia.image.base.imagepipeline.image.d lv() throws Exception {
                    Throwable th;
                    if (isCancelled.get()) {
                        throw new CancellationException();
                    }
                    com.huluxia.image.base.imagepipeline.image.d result = this.EJ.EG.w(key);
                    if (result != null) {
                        ...
                        try {
                            ...
                            try {
                                com.huluxia.image.base.imagepipeline.image.d result2 = new com.huluxia.image.base.imagepipeline.image.d(ref);
                                try {
                                    result2.j(key);
                                    try {
                                        a.c(ref);
    ...
    public void a(final b key, com.huluxia.image.base.imagepipeline.image.d encodedImage) {
        Preconditions.checkNotNull(key);
        Preconditions.checkArgument(com.huluxia.image.base.imagepipeline.image.d.e(encodedImage));
        this.EG.a(key, encodedImage);
        encodedImage.j(key);
        final com.huluxia.image.base.imagepipeline.image.d finalEncodedImage = com.huluxia.image.base.imagepipeline.image.d.a(encodedImage);
        try {
            this.EF.execute(new Runnable(this) {
                ...
                public void run() {
                    try {
                        ...
                        com.huluxia.image.base.imagepipeline.image.d.d(finalEncodedImage);
                    }
                }
            });
        } catch (Exception exception) {
    ...
    private bolts.h<com.huluxia.image.base.imagepipeline.image.d> b(b key, com.huluxia.image.base.imagepipeline.image.d pinnedImage) {
        HLog.verbose(tF, String.format("Found image for %s in staging area", new Object[]{key.getUriString()}), new Object[0]);
        this.EH.u(key);
    ...
    private PooledByteBuffer r(b key) throws IOException {
        ...
        try {
            ...
            com.huluxia.image.base.binaryresource.a diskCacheResource = this.EC.d(key);
    ...
    private void c(b key, final com.huluxia.image.base.imagepipeline.image.d encodedImage) {
