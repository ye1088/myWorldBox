...
import com.huluxia.image.core.common.streams.b;
...
public class a implements e {
    ...
    public com.huluxia.image.core.common.references.a<Bitmap> a(com.huluxia.image.base.imagepipeline.image.d encodedImage, Config bitmapConfig) {
    ...
    public com.huluxia.image.core.common.references.a<Bitmap> a(com.huluxia.image.base.imagepipeline.image.d encodedImage, Config bitmapConfig, int length) {
        ...
        if (encodedImage.getSize() > length) {
            jpegDataStream = new com.huluxia.image.core.common.streams.a(jpegDataStream2, length);
        } else {
    ...
    protected com.huluxia.image.core.common.references.a<Bitmap> a(InputStream inputStream, Options options) {
        Preconditions.checkNotNull(inputStream);
        Bitmap bitmapToReuse = (Bitmap) this.El.get(com.huluxia.image.base.imageutils.a.c(options.outWidth, options.outHeight, options.inPreferredConfig));
        ...
        try {
            ...
            if (bitmapToReuse == decodedBitmap) {
                return com.huluxia.image.core.common.references.a.a(decodedBitmap, this.El);
            }
    ...
    private static Options b(com.huluxia.image.base.imagepipeline.image.d encodedImage, Config bitmapConfig) {
