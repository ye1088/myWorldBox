...
public class h implements am<a<b>> {
    ...
    public h(e<com.huluxia.image.base.cache.common.b, b> memoryCache, d cacheKeyFactory, am<a<b>> inputProducer) {
        this.Ee = memoryCache;
    ...
    public void b(j<a<b>> consumer, ao producerContext) {
        ...
        com.huluxia.image.base.cache.common.b cacheKey = this.EY.a(producerContext.oA(), producerContext.gk());
    ...
    protected j<a<b>> a(j<a<b>> consumer, final com.huluxia.image.base.cache.common.b cacheKey) {
