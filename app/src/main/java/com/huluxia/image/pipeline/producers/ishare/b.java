...
public class b extends y {
    ...
    private static final Rect Kh = new Rect(0, 0, 512, com.huluxia.image.pipeline.memory.b.HD);
            ...
            if ("authority_thumbnails".equals(authority)) {
                ...
                try {
                    ...
                    if (cursor.moveToNext()) {
                        com.huluxia.image.base.imagepipeline.image.d encodedImage = a(imageRequest.pz(), cursor.getInt(cursor.getColumnIndex(FieldType.FOREIGN_ID_FIELD_SUFFIX)));
                        cursor.close();
                        return encodedImage;
                    }
                    cursor.close();
    ...
    private com.huluxia.image.base.imagepipeline.image.d a(c resizeOptions, int imageId) throws IOException {
