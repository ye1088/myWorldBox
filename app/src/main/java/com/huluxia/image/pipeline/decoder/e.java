...
import com.huluxia.image.base.imagepipeline.memory.c;
...
public class e {
    ...
    public boolean f(d encodedImage) {
        ...
        try {
            com.huluxia.image.core.common.util.d.a(bufferedDataStream, (long) this.He);
            ...
            if (nextByte != -1) {
                ...
                switch (this.Hc) {
                    ...
                    case 5:
                        ...
                        com.huluxia.image.core.common.util.d.a(inputStream, (long) bytesToSkip);
                        this.He += bytesToSkip;
                        this.Hc = 2;
                        break;
                    default:
