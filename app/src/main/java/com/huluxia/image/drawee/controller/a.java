...
import com.huluxia.image.drawee.components.DraweeEventTracker.Event;
import com.huluxia.image.drawee.components.a$a;
...
public abstract class a<T, INFO> implements a$a, com.huluxia.image.drawee.gestures.a$a, com.huluxia.image.drawee.interfaces.a {
    ...
    private final com.huluxia.image.drawee.components.a zU;
    private final Executor zV;
    @Nullable
    private b zW;
    @Nullable
    private com.huluxia.image.drawee.gestures.a zX;
    @Nullable
    private d zY;
    @Nullable
    private com.huluxia.image.drawee.interfaces.c zZ;
    ...
    public a(com.huluxia.image.drawee.components.a deferredReleaser, Executor uiThreadImmediateExecutor, String id, Object callerContext) {
    ...
    @Nullable
    protected com.huluxia.image.drawee.gestures.a jh() {
        return this.zX;
    }

    protected void a(@Nullable com.huluxia.image.drawee.gestures.a gestureDetector) {
    ...
    public void setHierarchy(@Nullable com.huluxia.image.drawee.interfaces.b hierarchy) {
        if (HLog.isImageLoggable(1)) {
        ...
        if (hierarchy != null) {
            Preconditions.checkArgument(hierarchy instanceof com.huluxia.image.drawee.interfaces.c);
            this.zZ = (com.huluxia.image.drawee.interfaces.c) hierarchy;
            this.zZ.b(this.Aa);
        }
    }
