...
public class d<K, V> implements e<K, V>, a {
    ...
    static class b<K, V> {
        ...
        public final K key;
        public final com.huluxia.image.core.common.references.a<V> vY;
        public boolean vZ = false;
        @Nullable
        public final c<K> wa;

        private b(K key, com.huluxia.image.core.common.references.a<V> valueRef, @Nullable c<K> observer) {
            this.key = Preconditions.checkNotNull(key);
            this.vY = (com.huluxia.image.core.common.references.a) Preconditions.checkNotNull(com.huluxia.image.core.common.references.a.b((com.huluxia.image.core.common.references.a) valueRef));
            this.wa = observer;
        }

        @VisibleForTesting
        static <K, V> b<K, V> b(K key, com.huluxia.image.core.common.references.a<V> valueRef, @Nullable c<K> observer) {
            return new b(key, valueRef, observer);
        }
    }

    public d(g<V> valueDescriptor, a cacheTrimStrategy, Supplier<f> memoryCacheParamsSupplier, com.huluxia.image.base.imagepipeline.bitmaps.a platformBitmapFactory, boolean isExternalCreatedBitmapLogEnabled) {
    ...
    public com.huluxia.image.core.common.references.a<V> a(K key, com.huluxia.image.core.common.references.a<V> valueRef) {
        return a(key, valueRef, null);
    }

    public com.huluxia.image.core.common.references.a<V> a(K key, com.huluxia.image.core.common.references.a<V> valueRef, c<K> observer) {
        b oldExclusive;
        Preconditions.checkNotNull(key);
        Preconditions.checkNotNull(valueRef);
        hl();
        com.huluxia.image.core.common.references.a<V> oldRefToClose = null;
        com.huluxia.image.core.common.references.a<V> clientRef = null;
        synchronized (this) {
        ...
        com.huluxia.image.core.common.references.a.c(oldRefToClose);
        d(oldExclusive);
        hm();
        return clientRef;
    }
    ...
    @Nullable
    public com.huluxia.image.core.common.references.a<V> m(K key) {
        b oldExclusive;
        Preconditions.checkNotNull(key);
        com.huluxia.image.core.common.references.a<V> clientRef = null;
        synchronized (this) {
    ...
    private synchronized com.huluxia.image.core.common.references.a<V> a(b<K, V> entry) {
        g(entry);
        return com.huluxia.image.core.common.references.a.a(entry.vY.get(), new 3(this, entry));
    }

    private void b(b<K, V> entry) {
        com.huluxia.image.core.common.references.a<V> oldRefToClose;
        b entry2;
    ...
    @Nullable
    public com.huluxia.image.core.common.references.a<V> n(K key) {
        Preconditions.checkNotNull(key);
        com.huluxia.image.core.common.references.a<V> clientRef = null;
    ...
    private void d(@Nullable ArrayList<b<K, V>> oldEntries) {
        if (oldEntries != null) {
            ...
            while (it.hasNext()) {
                com.huluxia.image.core.common.references.a.c(i((b) it.next()));
            }
        }
    }
    ...
    @Nullable
    private synchronized com.huluxia.image.core.common.references.a<V> i(b<K, V> entry) {
