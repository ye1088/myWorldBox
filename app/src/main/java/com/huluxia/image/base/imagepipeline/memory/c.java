...
public class c extends InputStream {
    ...
    private final com.huluxia.image.core.common.references.c<byte[]> xe;
    private int xf = 0;
    private int xg = 0;

    public c(InputStream inputStream, byte[] byteArray, com.huluxia.image.core.common.references.c<byte[]> resourceReleaser) {
        this.mInputStream = (InputStream) Preconditions.checkNotNull(inputStream);
        this.xd = (byte[]) Preconditions.checkNotNull(byteArray);
        this.xe = (com.huluxia.image.core.common.references.c) Preconditions.checkNotNull(resourceReleaser);
    }
