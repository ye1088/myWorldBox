...
public class d implements Closeable {
    ...
    private com.huluxia.image.base.imageformat.d wV;
    private int wW;
    private int wX;
    @Nullable
    private b wY;
    ...
    public d(a<PooledByteBuffer> pooledByteBufferRef) {
        this.wV = com.huluxia.image.base.imageformat.d.vz;
        this.wN = -1;
        this.mWidth = -1;
        this.mHeight = -1;
        this.wW = 1;
    ...
    public void d(com.huluxia.image.base.imageformat.d imageFormat) {
        this.wV = imageFormat;
    }
    ...
    public com.huluxia.image.base.imageformat.d hT() {
        return this.wV;
    }
    ...
    public boolean br(int length) {
        if (this.wV != com.huluxia.image.base.imageformat.b.vl || this.wU != null) {
            return true;
        }
    ...
    public void hW() {
        ...
        com.huluxia.image.base.imageformat.d imageFormat = com.huluxia.image.base.imageformat.e.h(getInputStream());
        this.wV = imageFormat;
        if (com.huluxia.image.base.imageformat.b.a(imageFormat)) {
            dimensions = hX();
        } else {
            dimensions = hY();
        }
        if (imageFormat != com.huluxia.image.base.imageformat.b.vl || this.wN != -1) {
            this.wN = 0;
        } else if (dimensions != null) {
            this.wN = com.huluxia.image.base.imageutils.b.bv(com.huluxia.image.base.imageutils.b.k(getInputStream()));
        }
    }

    private Pair<Integer, Integer> hX() {
        Pair<Integer, Integer> dimensions = com.huluxia.image.base.imageutils.e.m(getInputStream());
        if (dimensions != null) {
    ...
    private Pair<Integer, Integer> hY() {
        ...
        try {
            ...
            Pair<Integer, Integer> dimensions = com.huluxia.image.base.imageutils.a.j(inputStream);
            if (dimensions != null) {
                this.mWidth = ((Integer) dimensions.first).intValue();
                this.mHeight = ((Integer) dimensions.second).intValue();
            }
