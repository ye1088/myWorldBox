...
public class PastRankAdapter extends BaseAdapter implements b {
    ...
    private void a(a holder, a item) {
        ...
        holder.aFG.setImageResource(com.huluxia.studio.utils.a.j(this.mContext, item.month));
        holder.aFG.setBackgroundColor(com.huluxia.studio.utils.a.i(this.mContext, item.month));
