...
public class AllStudioAdapter extends BaseAdapter implements b {
    private List<com.huluxia.data.studio.a.a> aab = new ArrayList();
    ...
    public Object getItem(int position) {
        return UtilsFunction.empty(this.aab) ? null : (com.huluxia.data.studio.a.a) this.aab.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.huluxia.data.studio.a.a item = (com.huluxia.data.studio.a.a) getItem(position);
        a(holder, item);
    ...
    private void a(a holder, com.huluxia.data.studio.a.a item) {
    ...
    public void c(List<com.huluxia.data.studio.a.a> data, boolean clear) {
        if (clear) {
            this.aab.clear();
        }
