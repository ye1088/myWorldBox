...
public class RecommendAdapter extends BaseAdapter implements b {
    private List<com.huluxia.data.studio.g.a> aab = new ArrayList();
    ...
    public Object getItem(int position) {
        return UtilsFunction.empty(this.aab) ? null : (com.huluxia.data.studio.g.a) this.aab.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.huluxia.data.studio.g.a item = (com.huluxia.data.studio.g.a) getItem(position);
        a(holer, item);
    ...
    private void a(a holder, com.huluxia.data.studio.g.a item) {
    ...
    public void c(List<com.huluxia.data.studio.g.a> data, boolean clear) {
        if (clear) {
            this.aab.clear();
        }
