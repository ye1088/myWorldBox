...
public class DTSDKManagerEx {
    ...
    public static void f(int mode, float level) {
        try {
            ...
            com.huluxia.mcsdk.log.a.verbose(com.huluxia.mcsdk.log.a.aoP, "DTPrint is " + localException, new Object[0]);
        }
    }
    ...
    public static void dA(String paramString) {
        ...
        com.huluxia.mcsdk.log.a.verbose("TAG", "DTPrint dtNativeClientMessage is " + paramString, new Object[0]);
    ...
    public static void h(Object paramObject, String paramString) {
        try {
            if (h.CW().Da() != 1) {
                if (h.CW().CX() == 0) {
                    ScriptManager.nativeSetMobSkin(com.huluxia.mcsdk.dtlib.a.ar(paramObject), paramString);
