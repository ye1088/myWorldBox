...
import com.huluxia.ui.picture.PictureChooserFragment.b;
import java.io.File;
...
public class PictureChooserActivity extends HTBaseThemeActivity implements b {
    ...
    private class a extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            com.huluxia.module.picture.b unit = (com.huluxia.module.picture.b) getItem(position);
    ...
    public void b(com.huluxia.module.picture.b unit) {
        this.bdI.notifyDataSetChanged();
        this.bdK = true;
        IV();
    }

    public void c(com.huluxia.module.picture.b unit) {
        this.bdI.notifyDataSetChanged();
        this.bdK = true;
        IV();
    }

    public void d(com.huluxia.module.picture.b unit) {
