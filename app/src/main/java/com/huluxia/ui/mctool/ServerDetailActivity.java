...
public class ServerDetailActivity extends HTBaseLoadingActivity {
    ...
    private com.huluxia.data.server.a.a bbY;
    private CallbackHandler bbZ = new CallbackHandler(this) {
        ...
        public void onRecvDetailData(boolean succ, com.huluxia.data.server.a.a info) {
            if (info == null || !succ) {
                this.bca.FB();
                return;
            }
    ...
    private static class a extends com.huluxia.widget.banner.a {
        public List<com.huluxia.widget.banner.a> bcd;
        ...
        public a(List<String> urlStringList) {
            ...
            if (!UtilsFunction.empty((Collection) urlStringList)) {
                for (int i = 0; i < urlStringList.size(); i++) {
                    com.huluxia.widget.banner.a info = new a();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            this.bbY = (com.huluxia.data.server.a.a) getIntent().getExtras().getParcelable(bbM);
        } else {
            this.bbY = (com.huluxia.data.server.a.a) savedInstanceState.getParcelable(bbM);
        }
        if (this.bbY != null) {
            int i2;
            this.mContext = this;
    ...
    private void J(final List<com.huluxia.widget.banner.a> bannerInfos) {
        if (!UtilsFunction.empty((Collection) bannerInfos)) {
            this.aGX.setVisibility(0);
            this.aGX.setIndicatorVisible(false);
            this.aGX.getGallery().setLoader(new com.huluxia.widget.banner.SimpleImageAdapter.a(this) {
                final /* synthetic */ ServerDetailActivity bca;
    ...
    private void b(int index, List<com.huluxia.widget.banner.a> bannerInfos) {
        ArrayList urls = new ArrayList();
        for (com.huluxia.widget.banner.a info : bannerInfos) {
            urls.add(info.url);
        }
