...
import com.huluxia.ui.itemadapter.profile.ProfileSpaceAdapter$a;
...
public class ProfileMeFragment extends BaseThemeFragment implements ProfileSpaceAdapter$a {
    ...
    public View onCreateView(LayoutInflater inflater, @android.support.annotation.z ViewGroup container, @android.support.annotation.z Bundle savedInstanceState) {
        ...
        this.aIy = (BaseLoadingLayout) this.mView.findViewById(com.huluxia.bbs.b.g.loading_layout);
        this.aIy.setRetryClickListener(new 1(this));
        this.aJc = this.mView.findViewById(com.huluxia.bbs.b.g.loading);
        this.aID = (TextView) this.mView.findViewById(com.huluxia.bbs.b.g.progressTxt);
        this.aSn = (PipelineView) this.mView.findViewById(com.huluxia.bbs.b.g.iv_space_background);
        this.aSp = (HtImageView) this.mView.findViewById(com.huluxia.bbs.b.g.iv_back);
        if (!this.aSf) {
            this.aSp.setVisibility(0);
            this.aSp.setOnClickListener(this.mClickListener);
        }
        this.aSo = (HtImageView) this.mView.findViewById(com.huluxia.bbs.b.g.iv_msg);
        this.aSo.setOnClickListener(this.mClickListener);
        this.aIg = (TextView) this.mView.findViewById(com.huluxia.bbs.b.g.tv_msg);
        if (!this.aSf && this.aSg > 0) {
            RelativeLayout rly_title = (RelativeLayout) this.mView.findViewById(com.huluxia.bbs.b.g.rly_title);
    ...
    private void j(View view) {
        this.mListView = (ListView) view.findViewById(com.huluxia.bbs.b.g.list);
