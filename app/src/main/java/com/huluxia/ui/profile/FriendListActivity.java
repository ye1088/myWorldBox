...
public class FriendListActivity extends HTBaseLoadingActivity implements com.huluxia.ui.itemadapter.profile.FriendItemAdapter.a {
    ...
    private void Fo() {
        ...
        this.aHb.a(new com.huluxia.utils.aa.a(this) {
            final /* synthetic */ FriendListActivity bfj;
    ...
    protected void EX() {
        super.EX();
        com.huluxia.module.profile.g.Eb().a(0, 20, this.aMn);
    }
