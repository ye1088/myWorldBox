...
public class ProfileOtherFragment extends BaseThemeFragment implements f {
    ...
    private int bgJ = 3;
    private b bgK = new b();
    private com.huluxia.http.profile.c bgL = new com.huluxia.http.profile.c();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mView = inflater.inflate(com.huluxia.bbs.b.i.fragment_me, container, false);
    ...
    private void reload() {
        z.DO();
        z.b(this.pM, null);
        ProfileInfo profileInfo = com.huluxia.module.profile.g.Eb().aU(this.pM);
        if (profileInfo != null) {
            setProfileInfo(profileInfo);
        }
        com.huluxia.module.profile.g.Eb().aR(this.pM);
    }

    private void Ht() {
        if (this.aKG == null || this.aKG.model != 2 || this.aKG.space == null) {
            this.aSn.setVisibility(8);
            this.aSn.setImageResource(com.huluxia.bbs.b.f.bg_profile);
            return;
        }
        Hu();
    }
    ...
    private void Hu() {
        ...
        config.placeHolder = com.huluxia.bbs.b.f.bg_profile;
    ...
    private void Jy() {
        if (1 == this.bgJ) {
            ...
            this.bgM.setTextColor(com.simple.colorful.d.getColor(this.mContext, com.huluxia.bbs.b.c.attention_text_color_type_1));
            this.bgM.setBackgroundResource(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.bg_attention_fans_type_1));
            this.bgM.setCompoundDrawablesWithIntrinsicBounds(this.mContext.getResources().getDrawable(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.space_ic_followed)), null, null, null);
        } else if (2 == this.bgJ) {
            this.bgM.setText(m.mutual_follow);
            this.bgM.setTextColor(com.simple.colorful.d.getColor(this.mContext, com.huluxia.bbs.b.c.attention_text_color_type_1));
            this.bgM.setBackgroundResource(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.bg_attention_fans_type_1));
            this.bgM.setCompoundDrawablesWithIntrinsicBounds(this.mContext.getResources().getDrawable(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.space_ic_mutual_follow)), null, null, null);
        } else {
            this.bgM.setText(m.by_followed);
            this.bgM.setTextColor(com.simple.colorful.d.getColor(this.mContext, com.huluxia.bbs.b.c.attention_text_color_type_2));
            this.bgM.setBackgroundResource(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.bg_attention_fans_type_2));
            this.bgM.setCompoundDrawablesWithIntrinsicBounds(this.mContext.getResources().getDrawable(com.simple.colorful.d.r(this.mContext, com.huluxia.bbs.b.c.space_ic_follow)), null, null, null);
        }
    }
    ...
    private void bp(long userId) {
        ...
        View layout = LayoutInflater.from(getActivity()).inflate(com.huluxia.bbs.b.i.include_dialog_two, null);
    ...
    protected void a(com.simple.colorful.a.a builder) {
        ...
        setter.a(this.aSh);
        builder.a(setter).a(this.aSi).d(this.aSn, com.huluxia.bbs.b.c.valBrightness).c(this.aSo, com.huluxia.bbs.b.c.drawableProfileTitleMsg).d(this.aSo, com.huluxia.bbs.b.c.valBrightness).c(this.aSp, com.huluxia.bbs.b.c.drawableProfileTitleBack).d(this.aSp, com.huluxia.bbs.b.c.valBrightness);
    }
