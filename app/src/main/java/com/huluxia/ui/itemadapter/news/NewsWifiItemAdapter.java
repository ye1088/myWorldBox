...
public class NewsWifiItemAdapter extends NewsListAdapter {
    ...
    public NewsWifiItemAdapter(Context context, ArrayList<com.huluxia.module.news.c> data) {
        this.aab = data;
        this.mInflater = LayoutInflater.from(context);
    }

    public int getItemViewType(int position) {
        com.huluxia.module.news.c item = kK(position);
    ...
    public com.huluxia.module.news.c kK(int position) {
        return (com.huluxia.module.news.c) this.aab.get(position);
    }
    ...
    private void a(a holder, com.huluxia.module.news.c item) {
        if (item != null) {
            if (f.aCc.equals(item.coverType)) {
    ...
    private void a(b holder, com.huluxia.module.news.c item) {
        if (item != null) {
            if (f.aCd.equals(item.coverType)) {
                holder.aUO.setVisibility(0);
                holder.aUE.setVisibility(8);
    ...
    private void a(d holder, com.huluxia.module.news.c item) {
        if (item != null) {
            if (!UtilsFunction.empty(item.covers)) {
    ...
    private void a(c holder, com.huluxia.module.news.c item) {
        if (item != null) {
            a(holder.aRh, holder.aUP, holder.aUG, holder.aFF, item);
        }
    }

    private void a(TextView title, TextView time, TextView commentCounts, View root, final com.huluxia.module.news.c item) {
    ...
    private void a(PaintView imageView, String url) {
        imageView.setUri(UtilUri.getUriOrNull(url)).scaleType(ScaleType.CENTER_CROP).placeHolder(com.simple.colorful.d.isDayMode() ? com.huluxia.bbs.b.f.place_holder_normal : com.huluxia.bbs.b.f.place_holder_night_normal).errorHolder(com.simple.colorful.d.isDayMode() ? com.huluxia.bbs.b.f.err_holder_normal : com.huluxia.bbs.b.f.err_holder_night_normal).fadeDuration(150).setImageLoader(l.cb().getImageLoader());
    }

    public void a(j setter) {
        setter.bg(g.root_container, com.huluxia.bbs.b.c.listSelector).bh(g.img_counts, 16842809).bh(g.title, 16842808).bh(g.comment_counts, 16843282).bh(g.timing, 16843282).bh(g.news_type, 16843282).bf(g.split_item, com.huluxia.bbs.b.c.splitColor);
    }
}
