...
public class NewsSimpleItemAdapter extends NewsListAdapter {
    ...
    public void a(j setter) {
        setter.bg(g.root_container, com.huluxia.bbs.b.c.listSelector).bh(g.img_counts, 16842809).bh(g.title, 16842808).bh(g.comment_counts, 16843282).bh(g.timing, 16843282).bf(g.split_item, com.huluxia.bbs.b.c.splitColor);
    }
}
