...
public class ResTopicDetailItemAdapter extends BaseAdapter implements b {
    ...
    private void l(View v) {
        com.huluxia.data.topic.a studioInfo = this.aWG.getStudioInfo();
    ...
    private void a(ScoreItem scoreItem, TextView tv) {
        ...
        if (scoreItem.isIsadmin()) {
            tv.setTextColor(com.simple.colorful.d.getColor(this.aTg, com.huluxia.bbs.b.c.textColorTopicHuluRed));
        } else {
            tv.setTextColor(com.simple.colorful.d.getColor(this.aTg, com.huluxia.bbs.b.c.textColorGreenTopic));
        }
    }
    ...
    public void a(j setter) {
        setter.bg(g.topic_other, com.huluxia.bbs.b.c.listSelector).bg(g.topic_cuz_one, com.huluxia.bbs.b.c.listSelector).bg(g.topic_one, com.huluxia.bbs.b.c.listSelector).bh(g.map_introduce, 16843282).bh(g.content, 16842808).bh(g.floor, 16842808).bh(g.publish_time, 16842808).bh(g.content_short, 16842808).bh(g.content_long, 16842808).bg(g.delcontent, com.huluxia.bbs.b.c.backgroundTopicReply).bg(g.retcontent, com.huluxia.bbs.b.c.backgroundTopicReply).bh(g.delcontent, 16843282).bh(g.retcontent, 16843282).bh(g.more, com.huluxia.bbs.b.c.textColorGreen).bf(g.split_item_alt, com.huluxia.bbs.b.c.splitColor).bf(g.split_item, com.huluxia.bbs.b.c.splitColor).bi(g.avatar, com.huluxia.bbs.b.c.valBrightness).bj(g.iv_moderator_symbol, com.huluxia.bbs.b.c.drawableModeratorAuth).bh(g.tv_more_resource, com.huluxia.bbs.b.c.textColorQuaternary).ac(g.tv_more_resource, com.huluxia.bbs.b.c.ic_more_resource_arrow, 2);
    }
}
