...
public class ClassListAdapter extends BaseAdapter implements b {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == 0) {
            if (convertView == null) {
                convertView = this.mInflater.inflate(com.huluxia.bbs.b.i.item_class_tag, parent, false);
            }
            ((TextView) convertView.findViewById(g.tv_tag)).setText(data.getTitle());
        } else {
            a holder;
            if (convertView == null) {
                convertView = this.mInflater.inflate(com.huluxia.bbs.b.i.item_class_line, parent, false);
                holder = new a();
                a item1 = new a();
