...
class AuditAdapter$3 implements OnClickListener {
    final /* synthetic */ d$a aVh;
    final /* synthetic */ AuditAdapter aVi;
    final /* synthetic */ AuditAdapter$a aVj;
    final /* synthetic */ int val$position;

    AuditAdapter$3(AuditAdapter this$0, AuditAdapter$a auditAdapter$a, d$a com_huluxia_data_profile_d_a, int i) {
        this.aVi = this$0;
    ...
    public void onClick(View v) {
        ...
        z.DO();
        z.b((long) this.aVh.getId(), AuditReslut.DISAGREE.getResult(), this.val$position, this.aVh.getSid());
    }
}
