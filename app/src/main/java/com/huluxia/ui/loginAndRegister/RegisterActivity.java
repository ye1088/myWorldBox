...
public class RegisterActivity extends HTBaseActivity {
        ...
        public void onVoiceVerify(boolean succ, c info) {
            ...
            if (succ) {
                if (this.aYN.aYK == null && info != null) {
                    int hintColor = com.huluxia.bbs.b.d.white;
    ...
    private boolean Ic() {
        ...
        if (aw.validEmail(email.trim())) {
            ...
            cs(true);
            com.huluxia.module.account.a.DU().eb(email.trim());
            return true;
        }
        t.n(this, "邮箱不合法");
        return false;
    ...
    private void HY() {
        ...
        dialogMenu.a(new com.huluxia.widget.dialog.n.a(this) {
            final /* synthetic */ RegisterActivity aYN;
        ...
        ((RelativeLayout) findViewById(g.profile_birthday_layout)).setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View v) {
                ...
                com.huluxia.widget.dialog.d wjDialog = new com.huluxia.widget.dialog.d(birthCal.get(1), birthCal.get(2) + 1, birthCal.get(5));
                wjDialog.lT(1920);
                wjDialog.lU(2010);
    ...
    private void V(String openId, String accessToken) {
        com.huluxia.module.account.a.DU().P(openId, accessToken);
    }
