...
public class BaseLoadingLayout extends FrameLayout implements c {
            ...
            if (i == this.aIE) {
                ...
                if (i == 1) {
                    if (UtilsNetwork.isNetworkConnected(this.mContext)) {
                        this.aIG.setImageResource(d.r(this.mContext, com.huluxia.bbs.b.c.drawableLoadingFailed));
                        this.aIH.setText(this.mContext.getString(m.loading_failed));
                        this.aII.setVisibility(8);
                    } else {
                        this.aIG.setImageResource(d.r(this.mContext, com.huluxia.bbs.b.c.drawableLoadingNetworkError));
    ...
    public com.simple.colorful.a.a b(com.simple.colorful.a.a builder) {
        ...
        builder.a(progress, com.huluxia.bbs.b.c.drawableLoading, size, size).a(this.aIH, 16843282).a(this.aII, 16843282).c(this.aIG, com.huluxia.bbs.b.c.drawableLoadingFailed).c(this.aIG, com.huluxia.bbs.b.c.drawableLoadingNetworkError);
        return builder;
    }
