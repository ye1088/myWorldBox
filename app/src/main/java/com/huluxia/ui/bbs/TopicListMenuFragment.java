...
public class TopicListMenuFragment extends BaseLoadingFragment implements OnClickListener {
    ...
    private void Hh() {
        if (j.ep().ey() && this.aJO != null) {
            ...
            if (this.subscribeType == ESubscribeType.Invalid.ordinal() || this.subscribeType == ESubscribeType.ALWAYS.ordinal()) {
                ...
                this.aQt.setTextColor(getResources().getColor(com.huluxia.bbs.b.d.topic_menu_filter_title));
                this.aQt.setBackgroundDrawable(d.o(this.mContext, com.huluxia.bbs.b.c.backgroundCreditCount));
            } else if (this.aQi) {
                this.aQt.setText("取消关注");
                this.aQt.setTextColor(getResources().getColor(com.huluxia.bbs.b.d.topic_menu_filter_title));
                this.aQt.setBackgroundDrawable(d.o(this.mContext, com.huluxia.bbs.b.c.backgroundCreditCount));
                ...
                this.aQt.setText("关注");
                this.aQt.setTextColor(getResources().getColor(com.huluxia.bbs.b.d.white));
                this.aQt.setBackgroundDrawable(d.o(this.mContext, com.huluxia.bbs.b.c.drawableTopicFollow));
            }
        }
    }
    ...
    protected void a(a builder) {
        super.a(builder);
        builder.bb(g.cb_night_mode, com.huluxia.bbs.b.c.drawableCompoundButtonSetting);
    }
}
