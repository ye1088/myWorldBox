...
import com.huluxia.ui.itemadapter.topic.ResTopicDetailItemAdapter.d;
...
public class ResTopicDetailActivity extends HTBaseThemeActivity implements OnClickListener, c, d {
    ...
    private CallbackHandler aky = new CallbackHandler(this) {
        ...
        public void onRecvTopicinfo(boolean succ, com.huluxia.module.topic.j info, int position, long postId, Context context) {
    ...
    private CallbackHandler mCallback = new CallbackHandler(this) {
        ...
        public void onRecvMapDetailData(boolean succ, com.huluxia.data.map.e info) {
            if (!this.aNS.aNo) {
                return;
            }
        ...
        public void onRecvSkinDetailData(boolean succ, com.huluxia.data.map.e info) {
            if (!this.aNS.aNo) {
                return;
            }
            if (succ && info != null && info.isSucc() && info.mapDetailInfo != null && ((long) info.mapDetailInfo.id) == this.aNS.aMU) {
        ...
        public void onRecvWoodDetailData(boolean succ, com.huluxia.data.map.e info) {
            if (!this.aNS.aNo) {
                return;
            }
            if (succ && info != null && info.isSucc() && info.mapDetailInfo != null && ((long) info.mapDetailInfo.id) == this.aNS.aMU) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.huluxia.bbs.b.i.activity_res_topic_cuz);
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        int i = (com.huluxia.data.j.ep().ey() && GO()) ? 0 : 2;
        iArr[2] = i;
        this.aNa = iArr;
    ...
    private void EP() {
        ...
        this.aIw.setLeftLayout(com.huluxia.bbs.b.i.layout_title_left_icon_and_text, new LayoutParams(-2, -1));
        ...
        this.aMs.setImageDrawable(com.simple.colorful.d.o(this.aMn, com.huluxia.bbs.b.c.back));
        View backView = findViewById(g.rl_header_back);
        backView.setBackgroundDrawable(com.simple.colorful.d.o(this.aMn, com.huluxia.bbs.b.c.backgroundTitleBarButton));
        ...
        this.aIw.setRightLayout(com.huluxia.bbs.b.i.include_topiclist_titlebar_right);
        this.mRightView = this.aIw.getRightView();
        this.aMz = (ImageButton) this.aIw.findViewById(g.sys_header_flright_img);
        this.aMz.setBackgroundResource(com.huluxia.bbs.b.f.sl_title_bar_button);
        this.aMz.setVisibility(0);
        this.aMz.setOnClickListener(this);
        Gv();
        Gt();
        this.aMA = (ImageButton) this.aIw.findViewById(g.header_flright_second_img);
        this.aMA.setBackgroundResource(com.huluxia.bbs.b.f.sl_title_bar_button);
        ...
        this.aNn.setBackgroundResource(com.huluxia.bbs.b.f.sl_title_bar_button);
    ...
    private void Fa() {
        ...
        this.aEq.setOnRefreshListener(new OnRefreshListener<ListView>(this) {
            ...
            public void onRefresh(PullToRefreshBase<ListView> pullToRefreshBase) {
                this.aNS.Gz();
                if (this.aNS.GO() && !this.aNS.aMZ && com.huluxia.data.j.ep().ey()) {
                    TopicModule.Ef().Eh();
                }
            }
        });
    ...
    private void Gv() {
        if (this.st) {
            this.aMz.setImageResource(com.simple.colorful.d.r(this, com.huluxia.bbs.b.c.drawableTitleFavorChecked));
        } else {
            this.aMz.setImageResource(com.simple.colorful.d.r(this, com.huluxia.bbs.b.c.drawableTitleFavor));
        }
    }

    private void Gw() {
        this.aMA.setImageDrawable(com.simple.colorful.d.o(this, com.huluxia.bbs.b.c.drawableTitleShare));
    }
    ...
    private void cy(final boolean reviewOk) {
        ...
        View view = LayoutInflater.from(this).inflate(com.huluxia.bbs.b.i.dialog_review_submit, null);
    ...
    private void GD() {
        ...
        GC();
        View pageTurnView = getLayoutInflater().inflate(com.huluxia.bbs.b.i.topic_detail_popupwindow_page_turn, null);
        this.aNy = new PopupWindow(this);
        this.aNy.setWidth(-1);
        this.aNy.setHeight(-2);
        this.aNy.setBackgroundDrawable(new ColorDrawable(getResources().getColor(com.huluxia.bbs.b.d.transparent)));
        this.aNy.setContentView(pageTurnView);
        this.aNy.setFocusable(true);
        this.aNy.setAnimationStyle(com.huluxia.bbs.b.n.topic_detail_pageturn_popwindow_anim_style);
        ...
        mLocalResMgrTabs.setTextColorResource(com.huluxia.bbs.b.d.TabStripTextColor);
        mLocalResMgrTabs.setTextSize(at.dipToPx(this, 15));
        if (com.simple.colorful.d.isDayMode()) {
            mLocalResMgrTabs.setIndicatorColor(getResources().getColor(com.huluxia.bbs.b.d.TabStripIndicatorColor));
        } else {
            mLocalResMgrTabs.setIndicatorColor(getResources().getColor(com.huluxia.bbs.b.d.TabStripIndicatorNightColor));
        }
    ...
    private void GF() {
        ...
        if (this.aNK.isSelected()) {
            o = com.simple.colorful.d.o(this.aMn, com.huluxia.bbs.b.c.drawableTopicSendhuluSelected);
        } else {
            o = com.simple.colorful.d.o(this.aMn, com.huluxia.bbs.b.c.drawableTopicSendhulu);
        }
    ...
    private void a(boolean isFloor, CommentItem item, long postId) {
        ...
        View layout = LayoutInflater.from(this).inflate(com.huluxia.bbs.b.i.include_credit_send, null);
    ...
    private void GH() {
        if (com.simple.colorful.d.RB()) {
            ...
            this.aMs.setImageDrawable(getResources().getDrawable(com.huluxia.bbs.b.f.spectial_back_selector));
            this.aMA.setImageDrawable(getResources().getDrawable(com.huluxia.bbs.b.f.spectial_share_selector));
            this.aNn.setImageDrawable(getResources().getDrawable(com.huluxia.bbs.b.f.spectial_message_selector));
            this.aMz.setImageDrawable(getResources().getDrawable(com.huluxia.bbs.b.f.spectial_fav_selector));
        }
    }
    ...
    private void GI() {
        ...
        this.aNn.setImageResource(com.simple.colorful.d.r(this.aMn, com.huluxia.bbs.b.c.drawableTitleMsg));
        Gv();
        Gw();
    }
    ...
    private void GJ() {
        final Dialog dialog = new Dialog(this, com.simple.colorful.d.RD());
        View layout = LayoutInflater.from(this).inflate(com.huluxia.bbs.b.i.include_topic_lock_dialog, null);
        ...
        reasonLayout.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View v) {
                if (this.aNS.aNO == null || !this.aNS.aNO.isShowing()) {
                    View popupView = this.aNS.getLayoutInflater().inflate(com.huluxia.bbs.b.i.include_topic_lock_reason, null);
                    ...
                    arrowImg.setImageDrawable(com.simple.colorful.d.o(this.aNS.aMn, com.huluxia.bbs.b.c.drawableComplaintUp));
    ...
    private void ky(final int opt) {
        if (opt == MENU_VALUE.LOCK_TOPIC.ordinal() || opt == MENU_VALUE.REMOVE_TOPIC.ordinal() || opt == MENU_VALUE.REMOVE_COMMENT.ordinal()) {
            final Dialog dialog = new Dialog(this.aMn, com.simple.colorful.d.RD());
            View layout = LayoutInflater.from(this.aMn).inflate(com.huluxia.bbs.b.i.include_dialog_two, null);
    ...
    private void ep(String progress) {
        ...
        this.aMI.setTextColor(com.simple.colorful.d.getColor(this.aMn, com.huluxia.bbs.b.c.progress_loading_text_color));
        this.aMI.setBackgroundResource(com.huluxia.bbs.b.f.list_selector_transition);
    }
    ...
    private void a(Button downButton, String status, boolean clickable) {
        ...
        downButton.setTextColor(com.simple.colorful.d.getColor(this.aMn, com.huluxia.bbs.b.c.progress_loading_text_color));
        downButton.setBackgroundResource(com.huluxia.bbs.b.f.list_selector_transition);
    }
    ...
    private void b(Button downButton, String status, boolean clickable) {
        ...
        downButton.setBackgroundDrawable(com.simple.colorful.d.o(this.aMn, com.huluxia.bbs.b.c.drawableResTopicGreen));
    }
    ...
    protected void a(com.simple.colorful.a.a builder) {
        ...
        builder.aY(g.restopic, com.huluxia.bbs.b.c.backgroundDefault).i(this.aIw, com.huluxia.bbs.b.c.backgroundTitleBar).c(this.aMs, com.huluxia.bbs.b.c.drawableTitleBack).aY(g.footer_container, com.huluxia.bbs.b.c.backgroundDim).aY(g.topic_bottom_split, com.huluxia.bbs.b.c.splitColorDim).j(this.aMB, com.huluxia.bbs.b.c.backgroundPagePre).j(this.aMC, com.huluxia.bbs.b.c.backgroundPageNext).j(this.aMD, com.huluxia.bbs.b.c.backgroundTopicButton).j(this.aME, com.huluxia.bbs.b.c.backgroundTopicButton).a(this.aMD, com.huluxia.bbs.b.c.textColorTopicButton).a(this.aME, com.huluxia.bbs.b.c.textColorTopicButton).ba(g.tv_download, 16842809).ba(g.tv_download, com.huluxia.bbs.b.c.progress_loading_text_color).aZ(g.tv_download, com.huluxia.bbs.b.c.backgroundButtonLogin).aY(g.rly_float_header, com.huluxia.bbs.b.c.backgroundDim6).ba(g.tv_map_name, 16842808).ba(g.tv_map_size, 16842808).aZ(g.btn_float_download, com.huluxia.bbs.b.c.drawableResTopicGreen).ba(g.btn_float_download, 16842809).aY(g.split_vertical, 16842808).aY(g.split_item, com.huluxia.bbs.b.c.pageturn_split_line_color).a(this.aMq);
    }
