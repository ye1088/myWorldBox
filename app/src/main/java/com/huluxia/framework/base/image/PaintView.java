...
public class PaintView extends SimpleDraweeView {
    ...
    private b getHierarchyBuilder(Context context, @Nullable AttributeSet attrs) {
        b builder = com.huluxia.image.drawee.generic.c.b(context, attrs);
    ...
    public PaintView controllerListener(com.huluxia.image.drawee.controller.b controllerListener) {
    ...
    public void setImageLoader(ImageLoader imageLoader) {
        ...
        if (shouldResize()) {
            imageRequestBuilder.c(new com.huluxia.image.base.imagepipeline.common.c(getResizeWidth(), getResizeHeight()));
        }
        imageRequestBuilder.au(true);
        imageRequestBuilder.b(com.huluxia.image.base.imagepipeline.common.a.hs().O(this.mConfig.highQualityAnimated).hz());
