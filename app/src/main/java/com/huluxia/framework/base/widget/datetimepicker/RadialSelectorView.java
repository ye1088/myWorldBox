...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle, boolean disappearsOut, int selectionDegrees, boolean isInnerCircle) {
        ...
        this.mPaint.setColor(res.getColor(R.color.blue));
    ...
    public void setSelection(int selectionDegrees, boolean isInnerCircle, boolean forceDrawDot) {
        ...
        this.mSelectionRadians = (((double) selectionDegrees) * avutil.M_PI) / 180.0d;
    ...
    public int getDegreesFromCoords(float pointX, float pointY, boolean forceLegal, Boolean[] isInnerCircle) {
        ...
        int degrees = (int) ((180.0d * Math.asin(((double) Math.abs(pointY - ((float) this.mYCenter))) / hypotenuse)) / avutil.M_PI);
    ...
    public ObjectAnimator getDisappearAnimator() {
        if (this.mIsInitialized && this.mDrawValuesReady) {
            ...
            ObjectAnimator disappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this, radiusDisappear, fadeOut).setDuration((long) 500);
    ...
    public ObjectAnimator getReappearAnimator() {
        if (this.mIsInitialized && this.mDrawValuesReady) {
            ...
            ObjectAnimator reappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this, radiusReappear, fadeIn).setDuration((long) totalDuration);
