...
public class SegmentNetwork implements Network<SegmentRequest> {
    ...
    public com.huluxia.framework.base.http.io.NetworkResponse performRequest(com.huluxia.framework.base.http.io.impl.request.SegmentRequest r29) throws com.huluxia.framework.base.http.toolbox.error.VolleyError {
        /*
        r28 = this;
        r5 = 10;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private byte[] downloadResume(org.apache.http.HttpEntity r26, com.huluxia.framework.base.http.io.impl.request.SegmentRequest r27, java.io.File r28, java.util.Map<java.lang.String, java.lang.String> r29) throws java.io.IOException, com.huluxia.framework.base.http.toolbox.error.VolleyError {
        /*
        r25 = this;
