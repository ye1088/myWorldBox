...
import com.huluxia.framework.base.widget.hlistview.AdapterView.AdapterContextMenuInfo;
import com.huluxia.framework.base.widget.hlistview.util.ViewHelperFactory;
import com.huluxia.framework.base.widget.hlistview.util.ViewHelperFactory.ViewHelper;
import com.huluxia.framework.base.widget.hlistview.util.v11.MultiChoiceModeListener;
import com.huluxia.framework.base.widget.hlistview.util.v11.MultiChoiceModeWrapper;
        ...
        if (this.mPendingSync != null) {
            ...
            if (this.mCheckStates != null) {
                try {
                    ...
                    for (i = 0; i < this.mCheckStates.size(); i++) {
                        ss.checkState.put(this.mCheckStates.keyAt(i), this.mCheckStates.valueAt(i));
                    }
