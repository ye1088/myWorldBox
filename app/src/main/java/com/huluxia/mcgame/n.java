...
import com.huluxia.mcgame.biont.a;
...
public class n {
    ...
    private static void wU() {
        ...
        if (h.CW().CX() == 3 || h.CW().CX() == 5 || h.CW().CX() == 7) {
            try {
                ...
                com.huluxia.mcgame.netuser.a.yQ().a(_tmpNetPlayerArray);
                com.huluxia.mcgame.netuser.a.yQ().hg(_tmpNetPlayerArrayCnt);
                for (i = 0; i < 5; i++) {
                    if (_tmpNetPlayerArray[i] != 0) {
                        long _tmpEntityId = _tmpNetPlayerArray[i];
                        com.huluxia.mcgame.netuser.a.yQ().a(_tmpEntityId, DTSDKManagerEx.e(_tmpEntityId, 0), DTSDKManagerEx.e(_tmpEntityId, 1), DTSDKManagerEx.e(_tmpEntityId, 2), DTSDKManagerEx.at(_tmpEntityId));
                    }
                }
                com.huluxia.mcgame.netuser.a.yQ().yS();
            } catch (Exception e) {
            }
        }
    }
    ...
    private static void gz(int inputBiontId) {
        int _mapBiontIndexMax = com.huluxia.mcinterface.h.zr();
