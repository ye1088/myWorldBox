...
import com.huluxia.controller.resource.handler.impl.b.a;
...
public class VersionDialog extends DialogFragment {
    ...
    private void a(e info, int resType) {
        ...
        com.huluxia.controller.b.dI();
        long freeSpace = UtilsFile.availableSpace(com.huluxia.controller.b.dE().dH());
            ...
            if (!(taskInfo == null || taskInfo.state != State.SUCC.ordinal() || taskInfo.mN == null)) {
                ...
                if (taskInfo.mN.state == DownloadRecord.State.COMPLETION.state && existFile.exists()) {
                    ...
                    if (resType == 0) {
                        ...
                        return true;
                    } else if (UtilsFile.isExist(com.huluxia.controller.resource.handler.impl.b.nN) && UtilsFile.getFileMD5(com.huluxia.controller.resource.handler.impl.b.nN).equals(dbInfo.md5)) {
                        UtilsApkPackage.runInstallApp(getActivity(), com.huluxia.controller.resource.handler.impl.b.nN);
                        return true;
                    }
                }
            }
    ...
    private void i(e info) {
        if (info != null) {
            ...
            if (g.MS().gE(info.url) != null) {
                resTaskInfo = com.huluxia.controller.resource.bean.a.dM();
    ...
    private void b(e info, int resType) {
        ...
        if (dbInfo == null) {
            ...
            a patchTaskInfo;
            if (taskInfo != null) {
                long available = UtilsFile.availableSpace(com.huluxia.controller.b.dE().getDownloadPath());
            ...
            } else if (UtilsFile.availableSpace(com.huluxia.controller.b.dE().getDownloadPath()) < ((long) (((float) info.size) * 1.3f))) {
                t.n(getActivity(), "下载空间不足，请清理空间后重试");
                return;
            } else if (resType == 22) {
