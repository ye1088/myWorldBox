...
import com.huawei.android.pushagent.c.f.a;
...
public class d implements b {
    ...
    public synchronized void a() {
        ...
        try {
            ...
            e.c("PushLogAC2705", "close socket error: " + e22.toString(), e22);
            this.b = null;
        } catch (Throwable th3) {
            this.b = null;
        }
    ...
    public boolean a(Socket socket) throws Exception {
        ...
        try {
            open.reset();
            instance3.load(open, f.b(null, com.huawei.android.pushagent.c.a.d.b()).toCharArray());
            if (open != null) {
                open.close();
            }
            ...
            this.b.setEnabledCipherSuites(a.a());
