    ...
    private void a(String str, Class[] clsArr, Object[] objArr) {
        if (this.b != null && this.c != null && !TextUtils.isEmpty(str) && clsArr != null && objArr != null) {
            try {
                ...
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has " + str + " method,err info " + e.toString());
            } catch (IllegalAccessException e2) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has " + str + " method,err info " + e2.toString());
            } catch (IllegalArgumentException e3) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has " + str + " method,err info " + e3.toString());
            } catch (InvocationTargetException e4) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has " + str + " method,err info " + e4.toString());
            }
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.d.containsKey(this.a)) {
            ...
            try {
                ...
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has onCreate method,err info " + e2.toString());
                return;
            } catch (InstantiationException e3) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has onCreate method,err info " + e3.toString());
                return;
            } catch (IllegalAccessException e4) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has onCreate method,err info " + e4.toString());
                return;
            } catch (IllegalArgumentException e5) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has onCreate method,err info " + e5.toString());
                return;
            } catch (InvocationTargetException e6) {
                e.a("PushSelfShowLog", this.b.getName() + " doesn't has onCreate method,err info " + e6.toString());
                return;
            }
        }
