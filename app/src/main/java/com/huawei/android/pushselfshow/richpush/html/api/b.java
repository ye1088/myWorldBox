...
public class b {
    public static String a(String str, String str2) {
        ...
        if (str != null) {
            ...
            if (str3.startsWith(XSLTLiaison.FILE_PROTOCOL_PREFIX)) {
        ...
        if (!(queryIntentActivities == null || queryIntentActivities.size() == 0)) {
            ...
            for (int i = 0; i < size; i++) {
                if (((ResolveInfo) queryIntentActivities.get(i)).activityInfo != null) {
                    e.a("PushSelfShowLog", "getSupportPackage:" + ((ResolveInfo) queryIntentActivities.get(i)).activityInfo.applicationInfo.packageName);
