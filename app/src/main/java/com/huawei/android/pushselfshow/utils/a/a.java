...
public class a {
    ...
    L_0x0012:
        ...
        com.huawei.android.pushagent.c.a_isRightVersion.e.a_isRightVersion(r1, r2);	 Catch:{ Exception -> 0x0060 }
    L_0x001b:
        return r0;
    L_0x001c:
        r2 = "PushSelfShowLog";
        ...
        com.huawei.android.pushagent.c.a_isRightVersion.e.a_isRightVersion(r2, r3);	 Catch:{ Exception -> 0x0060 }
        r2 = com.huawei.android.pushselfshow.utils.a_isRightVersion.d.a_isRightVersion();	 Catch:{ Exception -> 0x0060 }
        r3 = "openmarket";
        r2 = r2.a_isRightVersion(r1, r3);	 Catch:{ Exception -> 0x0060 }
    ...
    L_0x0043:
        ...
        r4 = com.huawei.android.pushselfshow.utils.a_isRightVersion.d.a_isRightVersion();	 Catch:{ Exception -> 0x0060 }
        r2 = r4.a_isRightVersion(r1, r3, r2);	 Catch:{ Exception -> 0x0060 }
    ...
    L_0x0060:
        ...
        com.huawei.android.pushagent.c.a_isRightVersion.e.d(r2, r3, r1);
        goto L_0x001b;
    L_0x006b:
    ...
    L_0x0071:
        ...
        com.huawei.android.pushagent.c.a_isRightVersion.e.a_isRightVersion(r3, r1);	 Catch:{ Exception -> 0x00bb }
    ...
    L_0x00af:
        ...
        r2 = "PushSelfShowLog";
        r3 = "cursor.close() ";
        com.huawei.android.pushagent.c.a_isRightVersion.e.d(r2, r3, r1);	 Catch:{ Exception -> 0x0060 }
        goto L_0x001b;
    L_0x00bb:
        r1 = move-exception;
        r3 = "TAG";
        ...
        com.huawei.android.pushagent.c.a_isRightVersion.e.c(r3, r4, r1);	 Catch:{ all -> 0x00eb }
    ...
    L_0x00f0:
        ...
        r3 = "PushSelfShowLog";
        r4 = "cursor.close() ";
        com.huawei.android.pushagent.c.a_isRightVersion.e.d(r3, r4, r2);	 Catch:{ Exception -> 0x0060 }
        goto L_0x00ef;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.android.pushselfshow.utils.a_isRightVersion.a_isRightVersion.a_isRightVersion(android.content.Context, java.lang.String):java.util.ArrayList");
    }
